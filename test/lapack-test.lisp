...
(addtest (lapack-test) dgeev 
         (let* ((n 4)
           ...
           (multiple-value-bind (a wr wi vl vr work info)
             ...
             (ensure-same info 0)
             (ensure-same (aref wr 0) 0.7994821225862091d0)
             (ensure-same (aref wi 0) 0d0)
             (ensure-same (subseq vr 0 4)
...
(addtest (lapack-test) dgesv
         (let* ((n 5)
           ...
           (multiple-value-bind (a ipiv b info)
             ...
             (ensure-same info 0)
             (ensure-same (round-array b 0.01d0)
             ...
             (ensure-same (round-array a 0.01d0)
...
(addtest (lapack-test) dstevd
         (let* ((nmax 4)
           ...
           (multiple-value-bind (d e z work iwork info)
             ...
             (ensure-same info 0)
             (ensure-same (round-array d 0.0001)
                          #(0.6476  3.5470  8.6578 17.1477))
             (ensure-same (round-array z 0.0001)
