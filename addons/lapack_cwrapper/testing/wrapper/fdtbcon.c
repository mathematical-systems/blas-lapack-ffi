...
void fdtbcon_(char* norm, char* uplo, char* diag, int* n, int* kd, double* ab, int* ldab, double* rcond, double* work, int* iwork, int* info)
{
	...
	lapack_dtbcon(normC, uploC, diagC, *n, *kd, ab, *ldab, rcond, work, iwork, info);
}
