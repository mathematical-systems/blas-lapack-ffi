...
void fcgtcon_(char* norm, int* n, void* dl, void* d, void* du, void* du2, int* ipiv, float* anorm, float* rcond, void* work, int* info)
{
	...
	lapack_cgtcon(normC, *n, dl, d, du, du2, ipiv, *anorm, rcond, work, info);
}
