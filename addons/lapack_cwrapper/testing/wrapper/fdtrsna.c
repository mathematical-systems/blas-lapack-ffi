...
void fdtrsna_(char* job, char* howmny, long int* select, int* n, double* t, int* ldt, double* vl, int* ldvl, double* vr, int* ldvr, double* s, double* sep, int* mm, int* m, double* work, int* ldwork, int* iwork, int* info)
{
	...
	lapack_dtrsna(jobC, howmnyC, select, *n, t, *ldt, vl, *ldvl, vr, *ldvr, s, sep, *mm, m, work, *ldwork, iwork, info);
}
