...
void fcgesvd_(char* jobu, char* jobvt, int* m, int* n, void* a, int* lda, float* s, void* u, int* ldu, void* vt, int* ldvt, void* work, int* lwork, float* rwork, int* info)
{
	...
	lapack_cgesvd(jobuC, jobvtC, *m, *n, a, *lda, s, u, *ldu, vt, *ldvt, work, *lwork, rwork, info);
}
