...
void fzlarzb_(char* side, char* trans, char* direct, char* storev, int* m, int* n, int* k, int* l, void* v, int* ldv, void* t, int* ldt, void* c, int* ldc, void* work, int* ldwork)
{
	...
	lapack_zlarzb(sideC, transC, directC, storevC, *m, *n, *k, *l, v, *ldv, t, *ldt, c, *ldc, work, *ldwork);
}
