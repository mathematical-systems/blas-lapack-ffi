...
void fzggevx_(char* balanc, char* jobvl, char* jobvr, char* sense, int* n, void* a, int* lda, void* b, int* ldb, void* alpha, void* beta, void* vl, int* ldvl, void* vr, int* ldvr, int* ilo, int* ihi, double* lscale, double* rscale, double* abnrm, double* bbnrm, double* rconde, double* rcondv, void* work, int* lwork, float* rwork, int* iwork, long int* bwork, int* info)
{
	...
	lapack_zggevx(balancC, jobvlC, jobvrC, senseC, *n, a, *lda, b, *ldb, alpha, beta, vl, *ldvl, vr, *ldvr, ilo, ihi, lscale, rscale, abnrm, bbnrm, rconde, rcondv, work, *lwork, rwork, iwork, bwork, info);
}
