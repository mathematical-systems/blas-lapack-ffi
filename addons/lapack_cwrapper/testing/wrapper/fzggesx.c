...
void fzggesx_(char* jobvsl, char* jobvsr, char* sort, const long int (*selctg) (void*,void*), char* sense, int* n, void* a, int* lda, void* b, int* ldb, int* sdim, void* alpha, void* beta, void* vsl, int* ldvsl, void* vsr, int* ldvsr, double* rconde, double* rcondv, void* work, int* lwork, double* rwork, int* iwork, int* liwork, long int* bwork, int* info)
{
	...
	lapack_zggesx(jobvslC, jobvsrC, sortC, selctg, senseC, *n, a, *lda, b, *ldb, sdim, alpha, beta, vsl, *ldvsl, vsr, *ldvsr, rconde, rcondv, work, *lwork, rwork, iwork, *liwork, bwork, info);
}
