...
void fzlatbs_(char* uplo, char* trans, char* diag, char* normin, int* n, int* kd, void* ab, int* ldab, void* x, double* scale, double* cnorm, int* info)
{
	...
	lapack_zlatbs(uploC, transC, diagC, norminC, *n, *kd, ab, *ldab, x, scale, cnorm, info);
}
