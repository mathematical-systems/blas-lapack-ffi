...
void fztrcon_(char* norm, char* uplo, char* diag, int* n, void* a, int* lda, double* rcond, void* work, double* rwork, int* info)
{
	...
	lapack_ztrcon(normC, uploC, diagC, *n, a, *lda, rcond, work, rwork, info);
}
