...
void fclatbs_(char* uplo, char* trans, char* diag, char* normin, int* n, int* kd, void* ab, int* ldab, void* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_clatbs(uploC, transC, diagC, norminC, *n, *kd, ab, *ldab, x, scale, cnorm, info);
}
