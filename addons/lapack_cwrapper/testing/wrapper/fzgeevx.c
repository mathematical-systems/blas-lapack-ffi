...
void fzgeevx_(char* balanc, char* jobvl, char* jobvr, char* sense, int* n, void* a, int* lda, void* w, void* vl, int* ldvl, void* vr, int* ldvr, int* ilo, int* ihi, double* scale, double* abnrm, double* rconde, double* rcondv, void* work, int* lwork, double* rwork, int* info)
{
	...
	lapack_zgeevx(balancC, jobvlC, jobvrC, senseC, *n, a, *lda, w, vl, *ldvl, vr, *ldvr, ilo, ihi, scale, abnrm, rconde, rcondv, work, *lwork, rwork, info);
}
