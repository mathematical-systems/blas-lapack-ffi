...
void fzgeesx_(char* jobvs, char* sort, const long int (*select) (void*), char* sense, int* n, void* a, int* lda, int* sdim, void* w, void* vs, int* ldvs, double* rconde, double* rcondv, void* work, int* lwork, double* rwork, long int* bwork, int* info)
{
	...
	lapack_zgeesx(jobvsC, sortC, select, senseC, *n, a, *lda, sdim, w, vs, *ldvs, rconde, rcondv, work, *lwork, rwork, bwork, info);
}
