...
void fsormbr_(char* vect, char* side, char* trans, int* m, int* n, int* k, float* a, int* lda, float* tau, float* c, int* ldc, float* work, int* lwork, int* info)
{
	...
	lapack_sormbr(vectC, sideC, transC, *m, *n, *k, a, *lda, tau, c, *ldc, work, *lwork, info);
}
