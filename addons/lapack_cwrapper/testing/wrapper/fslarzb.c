...
void fslarzb_(char* side, char* trans, char* direct, char* storev, int* m, int* n, int* k, int* l, float* v, int* ldv, float* t, int* ldt, float* c, int* ldc, float* work, int* ldwork)
{
	...
	lapack_slarzb(sideC, transC, directC, storevC, *m, *n, *k, *l, v, *ldv, t, *ldt, c, *ldc, work, *ldwork);
}
