...
void fctrevc_(char* side, char* howmny, long int* select, int* n, void* t, int* ldt, void* vl, int* ldvl, void* vr, int* ldvr, int* mm, int* m, void* work, float* rwork, int* info)
{
	...
	lapack_ctrevc(sideC, howmnyC, select, *n, t, *ldt, vl, *ldvl, vr, *ldvr, *mm, m, work, rwork, info);
}
