...
*  =======
*
*  DGET36 tests cdtrexc, a routine for moving blocks (either 1 by 1 or
*  2 by 2) on the diagonal of a matrix in real Schur form.  Thus, cdlaexc
...
*     .. External Subroutines ..
      EXTERNAL           DHST01, cdlacpy, cdlaset, cdtrexc
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, SIGN
*     ..
...
*
   ...
   20 CONTINUE
      CALL cdlacpy( 'F', N, N, TMP, LDT, T1, LDT )
      CALL cdlacpy( 'F', N, N, TMP, LDT, T2, LDT )
      IFSTSV = IFST
      ILSTSV = ILST
      IFST1 = IFST
      ILST1 = ILST
...
*
      CALL cdlaset( 'Full', N, N, ZERO, ONE, Q, LDT )
      CALL cdtrexc( 'N', N, T1, LDT, Q, LDT, IFST1, ILST1, WORK, INFO1 )
      DO 40 I = 1, N
         DO 30 J = 1, N
...
*
      CALL cdlaset( 'Full', N, N, ZERO, ONE, Q, LDT )
      CALL cdtrexc( 'V', N, T2, LDT, Q, LDT, IFST2, ILST2, WORK, INFO2 )
*
*     Compare T1 with T2
*
      DO 60 I = 1, N
