...
*  =======
*
*  DCHKBK tests cdgebak, a routine for backward transformation of
*  the computed right or left eigenvectors if the orginal matrix
*  was preprocessed by balance subroutine cdgebal.
*
*  Arguments
*  =========
*
...
*
      KNT = KNT + 1
      CALL cdgebak( 'B', 'R', N, ILO, IHI, SCALE, N, E, LDE, INFO )
*
      IF( INFO.NE.0 ) THEN
         NINFO = NINFO + 1
         LMAX( 1 ) = KNT
...
*
      WRITE( NOUT, FMT = 9999 )
 9999 FORMAT( 1X, '.. test output of cdgebak .. ' )
*
