...
*  =======
*
*  CGET36 tests cctrexc, a routine for reordering diagonal entries of a
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CHST01, cclacpy, cclaset, cctrexc
*     ..
...
*
   ...
   20 CONTINUE
      CALL cclacpy( 'F', N, N, TMP, LDT, T1, LDT )
      CALL cclacpy( 'F', N, N, TMP, LDT, T2, LDT )
      RES = ZERO
*
*     Test without accumulating Q
*
      CALL cclaset( 'Full', N, N, CZERO, CONE, Q, LDT )
      CALL cctrexc( 'N', N, T1, LDT, Q, LDT, IFST, ILST, INFO1 )
      DO 40 I = 1, N
         DO 30 J = 1, N
...
*
      CALL cclaset( 'Full', N, N, CZERO, CONE, Q, LDT )
      CALL cctrexc( 'V', N, T2, LDT, Q, LDT, IFST, ILST, INFO2 )
*
*     Compare T1 with T2
*
      DO 60 I = 1, N
