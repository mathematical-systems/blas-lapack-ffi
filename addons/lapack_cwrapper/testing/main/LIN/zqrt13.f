...
*     .. External Subroutines ..
      EXTERNAL           cdlabad, czlarnv, czlascl
*     ..
*     .. Intrinsic Functions ..
...
*           matrix scaled up
*
            CALL czlascl( 'General', 0, 0, NORMA, BIGNUM, M, N, A, LDA,
     $                   INFO )
         ELSE IF( SCALE.EQ.3 ) THEN
*
*           matrix scaled down
*
            CALL czlascl( 'General', 0, 0, NORMA, SMLNUM, M, N, A, LDA,
     $                   INFO )
         END IF
      END IF
*
