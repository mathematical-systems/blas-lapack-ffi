...
*  =======
*
*  DCHKPT tests cdpttrf, -TRS, -RFS, and -CON
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
      ...
      CHARACTER DIST,TYPE
      CHARACTER*3 PATH
      INTEGER I,IA,IMAT,IN,INFO,IRHS,IX,IZERO,J,K,KL,KU,LDA,MODE,N,
...
*     .. External Subroutines ..
      EXTERNAL ALAERH,ALAHD,ALASUM,DCOPY,DERRGT,DGET04,cdlacpy,DLAPTM,
     +         cdlarnv,DLATB4,DLATMS,cdptcon,cdptrfs,DPTT01,DPTT02,
     +         DPTT05,cdpttrf,cdpttrs,DSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC ABS,MAX
*     ..
...
*
*           Check error code from cdpttrf.
*
              IF (INFO.NE.IZERO) THEN
                  CALL ALAERH(PATH,'cdpttrf',INFO,IZERO,' ',N,N,-1,-1,
...
*
*           Use cdpttrs to solve for one column at a time of inv(A),
...
*
                  ...
                  CALL cdpttrs(N,NRHS,D(N+1),E(N+1),X,LDA,INFO)
*
*           Check error code from cdpttrs.
*
                  IF (INFO.NE.0) CALL ALAERH(PATH,'cdpttrs',INFO,0,' ',
...
*
                  SRNAMT = 'cdptrfs'
                  CALL cdptrfs(N,NRHS,D,E,D(N+1),E(N+1),B,LDA,X,LDA,
     +                         RWORK,RWORK(NRHS+1),WORK,INFO)
*
*           Check error code from cdptrfs.
*
                  IF (INFO.NE.0) CALL ALAERH(PATH,'cdptrfs',INFO,0,' ',
     +                                N,N,-1,-1,NRHS,IMAT,NFAIL,NERRS,
     +                                NOUT)
*
...
*
   90         CONTINUE
              SRNAMT = 'cdptcon'
              CALL cdptcon(N,D(N+1),E(N+1),ANORM,RCOND,RWORK,INFO)
*
*           Check error code from cdptcon.
*
              IF (INFO.NE.0) CALL ALAERH(PATH,'cdptcon',INFO,0,' ',N,N,
