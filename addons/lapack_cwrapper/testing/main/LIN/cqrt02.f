...
*  =======
*
*  CQRT02 tests ccungqr, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, cclacpy, cclaset, ccungqr
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'ccungqr'
      CALL ccungqr( M, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy R(1:n,1:k)
*
      CALL cclaset( 'Full', N, K, CMPLX( ZERO ), CMPLX( ZERO ), R, LDA )
      CALL cclacpy( 'Upper', N, K, AF, LDA, R, LDA )
*
