...
*  =======
*
*  CCHKSP tests ccsptrf, -TRI, -TRS, -RFS, and -CON
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  cclacpy, CLARHS, CLATB4, CLATMS, CLATSP, CPPT05,
     $                ccspcon, ccsprFS, CSPT01, CSPT02, CSPT03, ccsptrf,
     $                   ccsptri, ccsptrs
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
  ...
  100             CONTINUE
               ...
               END IF
*
*              Check error code from ccsptrf.
*
               IF( INFO.NE.K )
     $            CALL ALAERH( PATH, 'ccsptrf', INFO, K, UPLO, N, N, -1,
...
*
*              Check error code from ccsptri.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ccsptri', INFO, 0, UPLO, N, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
                  SRNAMT = 'ccsptrs'
                  CALL ccsptrs( UPLO, N, NRHS, AFAC, IWORK, X, LDA,
     $                         INFO )
*
*              Check error code from ccsptrs.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ccsptrs', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'ccsprFS'
                 CALL ccsprFS( UPLO, N, NRHS, A, AFAC, IWORK, B, LDA, X,
     $                         LDA, RWORK, RWORK( NRHS+1 ), WORK,
     $                         RWORK( 2*NRHS+1 ), INFO )
*
*              Check error code from ccsprFS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ccsprFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140          CONTINUE
               ...
               SRNAMT = 'ccspcon'
               CALL ccspcon( UPLO, N, AFAC, IWORK, ANORM, RCOND, WORK,
     $                      INFO )
*
*              Check error code from ccspcon.
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ccspcon', INFO, 0, UPLO, N, N, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
