...
*  =======
*
*  ZCHKQL tests czgeqlf, czungql and ccunmql.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  ZGET02, czlacpy, ZLARHS, ZLATB4, ZLATMS, ZQLT01,
     $                   ZQLT02, ZQLT03
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.GE.N ) THEN
*
*                       Test czungql, using factorization
*                       returned by ZQLT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test czunmql, using factorization returned
*                       by ZQLT01
*
