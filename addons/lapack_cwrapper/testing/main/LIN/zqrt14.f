...
*     .. External Subroutines ..
      EXTERNAL           xerbla, czgelq2, czgeqr2, czlacpy, czlascl
*     ..
*     .. Intrinsic Functions ..
...
*     Copy and scale A
*
      CALL czlacpy( 'All', M, N, A, LDA, WORK, LDWORK )
      ANRM = ZLANGE( 'M', M, N, WORK, LDWORK, RWORK )
      IF( ANRM.NE.ZERO )
     $   CALL czlascl( 'G', 0, 0, ANRM, ONE, M, N, WORK, LDWORK, INFO )
*
...
*
         ...
         IF( XNRM.NE.ZERO )
     $      CALL czlascl( 'G', 0, 0, XNRM, ONE, NRHS, N, WORK( M+1 ),
     $                   LDWORK, INFO )
*
*        Compute LQ factorization of work
*
         CALL czgelq2( LDWORK, N, WORK, LDWORK, WORK( LDWORK*N+1 ),
