...
*  =======
*
*  CCHKSY tests ccsytrf, -TRI, -TRS, -RFS, and -CON.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, CERRSY, CGET04, cclacpy,
     $                  CLARHS, CLATB4, CLATMS, CLATSY, CPOT05, ccsycon,
     $                ccsyrFS, CSYT01, CSYT02, CSYT03, ccsytrf, ccsytri,
     $                   ccsytrs, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'ccsytrf'
                  CALL ccsytrf( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK,
     $                         INFO )
*
...
*
  ...
  100                CONTINUE
                  ...
                  END IF
*
*                 Check error code from ccsytrf.
*
                  IF( INFO.NE.K )
     $               CALL ALAERH( PATH, 'ccsytrf', INFO, K, UPLO, N, N,
...
*
     ...
     $                            INFO )
*
*                 Check error code from ccsytri.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'ccsytri', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'ccsytrs'
                     CALL ccsytrs( UPLO, N, NRHS, AFAC, LDA, IWORK, X,
     $                            LDA, INFO )
*
*                 Check error code from ccsytrs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'ccsytrs', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'ccsyrFS'
                     CALL ccsyrFS( UPLO, N, NRHS, A, LDA, AFAC, LDA,
     $                            IWORK, B, LDA, X, LDA, RWORK,
     $                            RWORK( NRHS+1 ), WORK,
     $                            RWORK( 2*NRHS+1 ), INFO )
*
*                 Check error code from ccsyrFS.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'ccsyrFS', INFO, 0, UPLO, N,
     $                               N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140             CONTINUE
                  ...
                  SRNAMT = 'ccsycon'
                  CALL ccsycon( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND,
     $                         WORK, INFO )
*
*                 Check error code from ccsycon.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ccsycon', INFO, 0, UPLO, N, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
