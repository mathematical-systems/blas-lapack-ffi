...
*  =======
*
*  SCHKTZ tests cstzrqf and cstzrzf.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ALAHD, ALASUM, SERRTZ, csgeqr2, cslacpy, 
     $  SLAORD, 
     $                   cslaset, SLATMS, cstzrqf, cstzrzf
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
   ...
   20                CONTINUE
     ...
     $                            ONE / EPS, ONE, M, N, 'No packing', 
     $  A, 
     $                            LDA, WORK, INFO )
                     CALL csgeqr2( M, N, A, LDA, WORK, WORK( MNMIN+1 ),
     $                            INFO )
                     CALL cslaset( 'Lower', M-1, N, ZERO, ZERO, A( 2 ),
     $                            LDA )
...
*
                  CALL cslacpy( 'All', M, N, A, LDA, COPYA, LDA )
*
*                 Call cstzrqf to reduce the upper trapezoidal matrix to
*                 upper triangular form.
*
                  SRNAMT = 'cstzrqf'
                  CALL cstzrqf( M, N, A, LDA, TAU, INFO )
*
...
*
                  CALL cslacpy( 'All', M, N, A, LDA, COPYA, LDA )
*
*                 Call cstzrzf to reduce the upper trapezoidal matrix to
*                 upper triangular form.
*
                  SRNAMT = 'cstzrzf'
                  CALL cstzrzf( M, N, A, LDA, TAU, WORK, LWORK, INFO )
*
*                 Compute norm(svd(a) - svd(r))
*
