...
*  =======
*
*  SCHKPB tests cspbtrf, -TRS, -RFS, and -CON.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                   cslacpy, SLARHS, cslaset, SLATB4, SLATMS, 
     $  cspbcon, 
     $                   cspbrfs, SPBT01, SPBT02, SPBT05, cspbtrf, 
     $  cspbtrs, 
     $                   SSWAP, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*                    matrix.
*
                     CALL cslacpy( 'Full', KD+1, N, A, LDAB, AFAC, LDAB 
     $  ) 
                     SRNAMT = 'cspbtrf'
                     CALL cspbtrf( UPLO, N, KD, AFAC, LDAB, INFO )
*
*                    Check error code from cspbtrf.
*
                     IF( INFO.NE.IZERO ) THEN
                        CALL ALAERH( PATH, 'cspbtrf', INFO, IZERO, 
     $  UPLO, 
...
*                    residual.
*
                     CALL cslacpy( 'Full', KD+1, N, AFAC, LDAB, AINV,
     $                            LDAB )
...
*
                     ...
                     SRNAMT = 'cspbtrs'
                     CALL cspbtrs( UPLO, N, KD, N, AFAC, LDAB, AINV, 
     $  LDA, 
     $                            INFO )
*
...
*
                        SRNAMT = 'cspbtrs'
                        CALL cspbtrs( UPLO, N, KD, NRHS, AFAC, LDAB, X,
     $                               LDA, INFO )
*
*                    Check error code from cspbtrs.
*
                        IF( INFO.NE.0 )
     $                     CALL ALAERH( PATH, 'cspbtrs', INFO, 0, UPLO,
     $                                  N, N, KD, KD, NRHS, IMAT, 
     $  NFAIL, 
     $                                  NERRS, NOUT )
*
...
*
                        SRNAMT = 'cspbrfs'
                        CALL cspbrfs( UPLO, N, KD, NRHS, A, LDAB, AFAC,
     $                               LDAB, B, LDA, X, LDA, RWORK,
     $                               RWORK( NRHS+1 ), WORK, IWORK,
     $                               INFO )
*
*                    Check error code from cspbrfs.
*
                        IF( INFO.NE.0 )
     $                     CALL ALAERH( PATH, 'cspbrfs', INFO, 0, UPLO,
     $                                  N, N, KD, KD, NRHS, IMAT, 
     $  NFAIL, 
     $                                  NERRS, NOUT )
*
...
*
                     SRNAMT = 'cspbcon'
                     CALL cspbcon( UPLO, N, KD, AFAC, LDAB, ANORM, 
     $  RCOND, 
     $                            WORK, IWORK, INFO )
*
*                    Check error code from cspbcon.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'cspbcon', INFO, 0, UPLO, N,
     $                               N, KD, KD, -1, IMAT, NFAIL, NERRS,
     $                               NOUT )
*
