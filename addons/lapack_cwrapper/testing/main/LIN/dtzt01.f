...
*  DTZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cdtzrqf.
*
*  Arguments
*  =========
*
...
*          The output of cdtzrqf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL DAXPY,cdlaset,cdlatzm,xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*
      CALL cdlaset('Full',M,N,ZERO,ZERO,WORK,M)
      DO 20 J = 1,M
          DO 10 I = 1,J
              WORK((J-1)*M+I) = AF(I,J)
   10     CONTINUE
...
*
      DO 30 I = 1,M
          CALL cdlatzm('Right',I,N-M+1,AF(I,M+1),LDA,TAU(I),
     +                 WORK((I-1)*M+1),WORK(M*M+1),M,WORK(M*N+1))
   30 CONTINUE
*
*     R = R - A
*
...
*
      ...
      IF (NORMA.NE.ZERO) DTZT01 = DTZT01/NORMA
*
      RETURN
*
*     End of DTZT01
