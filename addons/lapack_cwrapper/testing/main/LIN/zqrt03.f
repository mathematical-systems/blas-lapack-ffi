...
*  =======
*
*  ZQRT03 tests czunmqr, which computes Q*C, Q'*C, C*Q or C*Q'.
*
*  ZQRT03 compares the results of a call to czunmqr with the results of
*  forming Q explicitly by a call to czungqr and then performing matrix
...
*          returnedby czgeqrf. See ccgeqrf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL        ZGEMM, czlacpy, czlarnv, czlaset, czungqr, czunmqr
*     ..
*     .. Local Arrays ..
      INTEGER            ISEED( 4 )
*     ..
...
*
      ...
      CALL czlacpy( 'Lower', M-1, K, AF( 2, 1 ), LDA, Q( 2, 1 ), LDA )
*
*     Generate the m-by-m matrix Q
*
      SRNAMT = 'czungqr'
      CALL czungqr( M, M, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
      DO 30 ISIDE = 1, 2
         IF( ISIDE.EQ.1 ) THEN
            SIDE = 'L'
...
*
            SRNAMT = 'czunmqr'
            CALL czunmqr( SIDE, TRANS, MC, NC, K, AF, LDA, TAU, CC, LDA,
     $                   WORK, LWORK, INFO )
*
