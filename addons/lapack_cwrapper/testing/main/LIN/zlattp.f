...
*     .. External Subroutines ..
      EXTERNAL        cdlabad, cdlarnv, ZDSCAL, czlarnv, ZLATB4, ZLATMS,
     $                   ZROT, ZROTG
*     ..
*     .. Intrinsic Functions ..
...
*
         IF( UPPER ) THEN
            JC = 1
            DO 180 J = 1, N
               CALL czlarnv( 4, ISEED, J-1, AP( JC ) )
  ...
  180       CONTINUE
         ELSE
            ...
            DO 190 J = 1, N
               IF( J.LT.N )
     $            CALL czlarnv( 4, ISEED, N-J, AP( JC+1 ) )
...
*
  ...
  200       CONTINUE
         ...
         ELSE
            JC = 1
            DO 210 J = 1, N
               CALL czlarnv( 2, ISEED, N-J, AP( JC+1 ) )
...
*
  ...
  340       CONTINUE
         ELSE
            JC = 1
            DO 350 J = 1, N
               CALL czlarnv( 4, ISEED, N-J+1, AP( JC ) )
               IF( J.NE.IY ) THEN
                  AP( JC ) = ZLARND( 5, ISEED )*TWO
               ELSE
                  AP( JC ) = ZERO
...
*        1/3/91:  czlatps no longer can handle this case
*
         ...
         IF( UPPER ) THEN
            JC = 1
            DO 420 J = 1, N
               CALL czlarnv( 5, ISEED, J, AP( JC ) )
               CALL cdlarnv( 1, ISEED, J, RWORK )
               DO 410 I = 1, J
  ...
  420       CONTINUE
         ELSE
            JC = 1
            DO 440 J = 1, N
               CALL czlarnv( 5, ISEED, N-J+1, AP( JC ) )
               CALL cdlarnv( 1, ISEED, N-J+1, RWORK )
               DO 430 I = J, N
                  AP( JC+I-J ) = AP( JC+I-J )*
