...
*  =======
*
*  ZCHKSY tests czsytrf, -TRI, -TRS, -RFS, and -CON.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  czlacpy, ZLARHS, ZLATB4, ZLATMS, ZLATSY, ZPOT05,
     $                czsycon, czsyrFS, ZSYT01, ZSYT02, ZSYT03, czsytrf,
     $                   czsytri, czsytrs
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'czsytrf'
                  CALL czsytrf( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK,
     $                         INFO )
*
...
*
  ...
  100                CONTINUE
                  ...
                  END IF
*
*                 Check error code from czsytrf.
*
                  IF( INFO.NE.K )
     $               CALL ALAERH( PATH, 'czsytrf', INFO, K, UPLO, N, N,
...
*
     ...
     $                            INFO )
*
*                 Check error code from czsytri.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czsytri', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'czsytrs'
                     CALL czsytrs( UPLO, N, NRHS, AFAC, LDA, IWORK, X,
     $                            LDA, INFO )
*
*                 Check error code from czsytrs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czsytrs', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'czsyrFS'
                     CALL czsyrFS( UPLO, N, NRHS, A, LDA, AFAC, LDA,
     $                            IWORK, B, LDA, X, LDA, RWORK,
     $                            RWORK( NRHS+1 ), WORK,
     $                            RWORK( 2*NRHS+1 ), INFO )
*
*                 Check error code from czsyrFS.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czsyrFS', INFO, 0, UPLO, N,
     $                               N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140             CONTINUE
                  ...
                  SRNAMT = 'czsycon'
                  CALL czsycon( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND,
     $                         WORK, INFO )
*
*                 Check error code from czsycon.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'czsycon', INFO, 0, UPLO, N, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
