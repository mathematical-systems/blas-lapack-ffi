...
*  =======
*
*  ZLQT02 tests czunglq, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMM, ZHERK, czlacpy, czlaset, czunglq
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'czunglq'
      CALL czunglq( M, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy L(1:k,1:m)
*
      CALL czlaset( 'Full', K, M, DCMPLX( ZERO ), DCMPLX( ZERO ), L,
     $             LDA )
      CALL czlacpy( 'Lower', K, M, AF, LDA, L, LDA )
*
