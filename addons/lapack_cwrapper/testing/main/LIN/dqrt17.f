...
*     .. Local Scalars ..
      ...
      DOUBLE PRECISION BIGNUM,ERR,NORMA,NORMB,NORMRS,NORMX,SMLNUM
*     ..
*     .. Local Arrays ..
...
*     .. External Subroutines ..
      EXTERNAL DGEMM,cdlacpy,cdlascl,xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*
      CALL cdlacpy('All',NROWS,NRHS,B,LDB,C,LDB)
     ...
     +           ONE,C,LDB)
      ...
      IF (NORMRS.GT.SMLNUM) THEN
          ISCL = 1
          CALL cdlascl('General',0,0,NORMRS,ONE,NROWS,NRHS,C,LDB,INFO)
      END IF
*
*     compute R'*A
*
...
*
      ...
      ELSE
          ...
          IF (NORMX.NE.ZERO) ERR = ERR/NORMX
      END IF
*
