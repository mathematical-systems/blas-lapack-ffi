...
*     from the symmetric factorization computed by czhptrf.
*     czhptrf produces a factorization of the form
*          U * D * U^H     or     L * D * L^H,
...
*           determined by czsptrf or czhptrf.
...
*     .. External Subroutines ..
      EXTERNAL           xerbla, ZGEMV, ZGERU, czlacgv, ZSCAL, ZSWAP
*     ..
*     .. Intrinsic Functions ..
