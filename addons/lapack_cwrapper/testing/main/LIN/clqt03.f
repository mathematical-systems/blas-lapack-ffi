...
*  =======
*
*  CLQT03 tests ccunmlq, which computes Q*C, Q'*C, C*Q or C*Q'.
*
*  CLQT03 compares the results of a call to ccunmlq with the results of
*  forming Q explicitly by a call to ccunglq and then performing matrix
...
*          returned by ccgelqf. See ccgelqf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL        CGEMM, cclacpy, cclarnv, cclaset, ccunglq, ccunmlq
*     ..
*     .. Local Arrays ..
      INTEGER            ISEED( 4 )
*     ..
...
*
      ...
      CALL cclacpy( 'Upper', K, N-1, AF( 1, 2 ), LDA, Q( 1, 2 ), LDA )
*
*     Generate the n-by-n matrix Q
*
      SRNAMT = 'ccunglq'
      CALL ccunglq( N, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
      DO 30 ISIDE = 1, 2
         IF( ISIDE.EQ.1 ) THEN
            SIDE = 'L'
...
*
            SRNAMT = 'ccunmlq'
            CALL ccunmlq( SIDE, TRANS, MC, NC, K, AF, LDA, TAU, CC, LDA,
     $                   WORK, LWORK, INFO )
*
