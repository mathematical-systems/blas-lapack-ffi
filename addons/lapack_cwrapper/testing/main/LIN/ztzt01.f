...
*  ZTZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cztzrqf.
*
*  Arguments
*  =========
*
...
*          The output of cztzrqf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL           xerbla, ZAXPY, czlaset, czlatzm
*     ..
*     .. Intrinsic Functions ..
...
*
      DO 30 I = 1, M
         CALL czlatzm( 'Right', I, N-M+1, AF( I, M+1 ), LDA, TAU( I ),
