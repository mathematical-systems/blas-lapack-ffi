...
*  =======
*
*  SRQT02 tests csorgrq, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, cslacpy, cslaset, csorgrq, SSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, REAL
*     ..
...
*
      SRNAMT = 'csorgrq'
      CALL csorgrq( M, N, K, Q, LDA, TAU( M-K+1 ), WORK, LWORK, INFO )
*
*     Copy R(m-k+1:m,n-m+1:n)
*
      CALL cslaset( 'Full', K, M, ZERO, ZERO, R( M-K+1, N-M+1 ), LDA )
      CALL cslacpy( 'Upper', K, K, AF( M-K+1, N-K+1 ), LDA,
     $             R( M-K+1, N-K+1 ), LDA )
*
