      SUBROUTINE SLAZQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, 
     $  NFAIL, 
...
*  =======
*
*  CSLAZQ3 checks for deflation, computes a shift (TAU) and calls dqds.
...
*
*  IEEE   (input) LOGICAL
*         Flag for IEEE or non IEEE arithmetic (passed to CSLASQ5).
*
*  TTYPE  (input/output) INTEGER
*         Shift type.  TTYPE is passed as an argument in order to save
*         its value between calls to CSLAZQ3
*
...
*         between calls to CSLAZQ3
*
*  This is a thread safe version of CSLASQ3, which passes TTYPE, DMIN1,
...
*     .. External Subroutines ..
      EXTERNAL           CSLASQ5, CSLASQ6, CSLAZQ4
*     ..
*     .. External Function ..
      REAL               SLAMCH
      EXTERNAL           SLAMCH
...
*        Choose a shift.
*
         CALL CSLAZQ4( I0, N0, Z, PP, N0IN, DMIN, DMIN1, DMIN2, DN, 
     $  DN1, 
     $                DN2, TAU, TTYPE, G )
*
...
*
   80    CONTINUE
*
         CALL CSLASQ5( I0, N0, Z, PP, TAU, DMIN, DMIN1, DMIN2, DN,
     $                DN1, DN2, IEEE )
*
         NDIV = NDIV + ( N0-I0+2 )
         ITER = ITER + 1
...
*
   90 CONTINUE
      CALL CSLASQ6( I0, N0, Z, PP, DMIN, DMIN1, DMIN2, DN, DN1, DN2 )
      NDIV = NDIV + ( N0-I0+2 )
      ITER = ITER + 1
      TAU = ZERO
*
