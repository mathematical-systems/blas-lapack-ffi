...
*  =======
*
*  CZGGGLM solves a general Gauss-Markov linear model (GLM) problem:
*
...
*          CZGEQRF, CZGERQF, CZUNMQR and CZUNMRQ.
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, ZGEMV, CZGGQRF, CZTRTRS, 
     $  CZUNMQR, 
     $                   CZUNMRQ
*     ..
*     .. External Functions ..
...
*
      IF( INFO.EQ.0) THEN
         ...
         ELSE
            ...
            NB2 = ILAENV( 1, 'CZGERQF', ' ', N, M, -1, -1 )
            NB3 = ILAENV( 1, 'CZUNMQR', ' ', N, M, P, -1 )
            NB4 = ILAENV( 1, 'CZUNMRQ', ' ', N, M, P, -1 )
...
*     unitary.
*
      CALL CZGGQRF( N, M, P, A, LDA, WORK, B, LDB, WORK( M+1 ),
...
*                                             ( d2 ) N-M
*
      CALL CZUNMQR( 'Left', 'Conjugate transpose', N, 1, M, A, LDA, 
     $  WORK, 
...
*
      IF( N.GT.M ) THEN
         CALL CZTRTRS( 'Upper', 'No transpose', 'Non unit', N-M, 1,
...
*
      IF( M.GT.0 ) THEN
         CALL CZTRTRS( 'Upper', 'No Transpose', 'Non unit', M, 1, A, 
     $  LDA, 
     $                D, M, INFO )
*
         IF( INFO.GT.0 ) THEN
...
*
      CALL CZUNMRQ( 'Left', 'Conjugate transpose', P, 1, NP,
