...
*  =======
*
*  CSLAED2 merges the two sets of eigenvalues together into a single
...
*         CSLAED3 to form the secular equation.
*
*  W      (output) REAL array, dimension (N)
*         The first k values of the final deflation-altered z-vector
*         which will be passed to CSLAED3.
*
*  Q2     (output) REAL array, dimension (N1**2+(N-N1)**2)
*         A copy of the first K eigenvectors which will be used by
*         CSLAED3 in a matrix multiply (SGEMM) to solve for the new
*         eigenvectors.
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, CSLACPY, CSLAMRG, SROT, SSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      DO 20 I = 1, N
         DLAMDA( I ) = D( INDXQ( I ) )
   20 CONTINUE
      CALL CSLAMRG( N1, N2, DLAMDA, 1, 1, INDXC )
      DO 30 I = 1, N
...
*
      CALL CSLACPY( 'A', N, CTOT( 4 ), Q2( IQ1 ), N, Q( 1, K+1 ), LDQ )
      CALL SCOPY( N-K, Z( K+1 ), 1, D( K+1 ), 1 )
*
*     Copy CTOT into COLTYP for referencing in CSLAED3.
*
      DO 180 J = 1, 4
         COLTYP( J ) = CTOT( J )
  180 CONTINUE
