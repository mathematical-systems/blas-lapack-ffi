...
*  =======
*
*  CCDSTEVD computes all eigenvalues and, optionally, eigenvectors of a
...
*     .. External Subroutines ..
      EXTERNAL           DSCAL, CDSTEDC, CDSTERF, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          SQRT
*     ..
...
*
      ...
      END IF
*
*     For eigenvalues only, call CDSTERF.  For eigenvalues and
*     eigenvectors, call CDSTEDC.
*
      IF( .NOT.WANTZ ) THEN
         CALL CDSTERF( N, D, E, INFO )
      ELSE
         CALL CDSTEDC( 'I', N, D, E, Z, LDZ, WORK, LWORK, IWORK, 
     $  LIWORK, 
     $                INFO )
      END IF
*
