...
*  =======
*
*  CZLABRD reduces the first NB rows and columns of a complex general
...
*  bidiagonal form.
*
*  This is an auxiliary routine called by CZGEBRD
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMV, CZLACGV, CZLARFG, ZSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
               ...
               CALL CZLACGV( I, A( I, 1 ), LDA )
               CALL ZGEMV( 'No transpose', N-I, I, -ONE, Y( I+1, 1 ),
     $                     LDY, A( I, 1 ), LDA, ONE, A( I, I+1 ), LDA )
               CALL CZLACGV( I, A( I, 1 ), LDA )
               CALL CZLACGV( I-1, X( I, 1 ), LDX )
               CALL ZGEMV( 'Conjugate transpose', I-1, N-I, -ONE,
