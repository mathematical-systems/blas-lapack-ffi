...
*  =======
*
*  CSLASD8 finds the square roots of the roots of the secular equation,
*  as defined by the values in DSIGMA and Z. It makes the appropriate
*  calls to CSLASD4, and stores, for each  element in D, the distance
*  to its two nearest poles (elements in DSIGMA). It also updates
*  the arrays VF and VL, the first and last components of all the
*  right singular vectors of the original bidiagonal matrix.
*
*  CSLASD8 is called from CSLASD6.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, CSLASCL, CSLASD4, CSLASET, XERBLA
*     ..
*     .. External Functions ..
...
*
      CALL CSLASET( 'A', K, 1, ONE, ONE, WORK( IWK3 ), K )
*
*     Compute the updated singular values, the arrays DIFL, DIFR,
*     and the updated Z.
*
      DO 40 J = 1, K
         CALL CSLASD4( K, J, DSIGMA, Z, WORK( IWK1 ), RHO, D( J ),
     $                WORK( IWK2 ), INFO )
*
