...
*  =======
*
*  CDSPGST reduces a real symmetric-definite generalized eigenproblem
...
*
*  B must have been previously factorized as U**T*U or L*L**T by CDPPTRF.
*
*  Arguments
*  =========
*
...
*          stored in the same format as A, as returned by CDPPTRF.
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
