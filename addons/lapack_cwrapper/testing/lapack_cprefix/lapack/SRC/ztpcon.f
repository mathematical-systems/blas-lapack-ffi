...
*  =======
*
*  CZTPCON estimates the reciprocal of the condition number of a packed
...
*              Multiply by inv(A).
*
               CALL CZLATPS( UPLO, 'No transpose', DIAG, NORMIN, N, AP,
     $                      WORK, SCALE, RWORK, INFO )
            ELSE
*
*              Multiply by inv(A').
*
               CALL CZLATPS( UPLO, 'Conjugate transpose', DIAG, NORMIN,
