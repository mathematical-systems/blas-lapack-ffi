...
*  =======
*
*  CZPPRFS improves the computed solution to a system of linear
...
*          A = U**H*U or A = L*L**H, as computed by CDPPTRF/CZPPTRF,
...
*          On entry, the solution matrix X, as computed by CZPPTRS.
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, ZHPMV, CZLACN2, CZPPTRS
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CZPPTRS( UPLO, N, 1, AFP, WORK, N, INFO )
