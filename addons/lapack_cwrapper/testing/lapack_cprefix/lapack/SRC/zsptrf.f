...
*  =======
*
*  CZSPTRF computes the factorization of a complex symmetric matrix A
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZSCAL, CZSPR, ZSWAP
*     ..
*     .. Intrinsic Functions ..
...
*
                  KP = K
               ELSE IF( CABS1( AP( KPC+IMAX-1 ) ).GE.ALPHA*ROWMAX ) 
     $  THEN 
*
...
*
               R1 = CONE / AP( KC+K-1 )
               CALL CZSPR( UPLO, K-1, -R1, AP( KC ), 1, AP )
*
...
*
                  R1 = CONE / AP( KC )
                  CALL CZSPR( UPLO, N-K, -R1, AP( KC+1 ), 1,
     $                       AP( KC+N-K+1 ) )
*
