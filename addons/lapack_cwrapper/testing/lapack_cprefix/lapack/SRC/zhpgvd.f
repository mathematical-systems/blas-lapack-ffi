...
*  =======
*
*  CZHPGVD computes all the eigenvalues and, optionally, the eigenvectors
...
*          > 0:  CZPPTRF or CZHPEVD returned an error code:
*             <= N:  if INFO = i, CZHPEVD failed to converge;
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, CZHPEVD, CZHPGST, CZPPTRF, ZTPMV, 
     $  ZTPSV 
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, MAX
...
*
      CALL CZHPGST( ITYPE, UPLO, N, AP, BP, INFO )
      CALL CZHPEVD( JOBZ, UPLO, N, AP, W, Z, LDZ, WORK, LWORK, RWORK,
