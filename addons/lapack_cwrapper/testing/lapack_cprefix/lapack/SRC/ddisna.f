...
*  =======
*
*  CDDISNA computes the reciprocal condition numbers for the eigenvectors
...
*  the error bound.
*
*  CDDISNA may also be used to compute error bounds for eigenvectors of
