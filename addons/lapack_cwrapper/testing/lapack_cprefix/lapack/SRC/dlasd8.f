...
*  =======
*
*  CDLASD8 finds the square roots of the roots of the secular equation,
*  as defined by the values in DSIGMA and Z. It makes the appropriate
*  calls to CDLASD4, and stores, for each  element in D, the distance
*  to its two nearest poles (elements in DSIGMA). It also updates
*  the arrays VF and VL, the first and last components of all the
*  right singular vectors of the original bidiagonal matrix.
*
*  CDLASD8 is called from CDLASD6.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDLASCL, CDLASD4, CDLASET, XERBLA
*     ..
*     .. External Functions ..
...
*
      CALL CDLASET( 'A', K, 1, ONE, ONE, WORK( IWK3 ), K )
*
*     Compute the updated singular values, the arrays DIFL, DIFR,
*     and the updated Z.
*
      DO 40 J = 1, K
         CALL CDLASD4( K, J, DSIGMA, Z, WORK( IWK1 ), RHO, D( J ),
     $                WORK( IWK2 ), INFO )
*
