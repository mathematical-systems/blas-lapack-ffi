...
*  =======
*
*  CSSPTRD reduces a real symmetric matrix A stored in packed form to
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, CSLARFG, SSPMV, SSPR2, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               SDOT
...
*
            CALL CSLARFG( I, AP( I1+I-1 ), AP( I1 ), 1, TAUI )
            E( I ) = AP( I1+I-1 )
*
...
*
            CALL CSLARFG( N-I, AP( II+1 ), AP( II+2 ), 1, TAUI )
            E( I ) = AP( II+1 )
*
            IF( TAUI.NE.ZERO ) THEN
*
