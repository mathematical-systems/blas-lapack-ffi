...
*  =======
*
*  CSLARRV computes the eigenvectors of the tridiagonal matrix
...
*                if INFO = 2, internal error in CSSTEIN
*
*  Further Details
*  ===============
*
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, CSLAR1V, CSLARRB, CSLARRF, 
     $  CSLASET, 
     $                   SSCAL, CSSTEIN
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                               INFO )
                        ...
                        ELSE
                           ...
                           ELSE
*                           
*                             Call CSSTEIN to process this tight cluster.
...
*
   ...
   90                   CONTINUE
                        LAMBDA = WORK( K )
                        CALL CSLAR1V( IN, 1, IN, LAMBDA, D( IBEGIN ),
