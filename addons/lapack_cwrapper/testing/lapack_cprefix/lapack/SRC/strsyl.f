...
*  =======
*
*  CSTRSYL solves the real Sylvester matrix equation:
*
...
*
*  A and B must be in Schur canonical form (as returned by CSHSEQR), that
...
*     .. External Subroutines ..
      EXTERNAL           CSLABAD, CSLALN2, CSLASY2, SSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                  CALL CSLALN2( .FALSE., 2, 1, SMIN, ONE, A( K1, K1 ),
...
*
                  CALL CSLALN2( .TRUE., 2, 1, SMIN, ONE, B( L1, L1 ),
...
*
                  CALL CSLASY2( .FALSE., .FALSE., ISGN, 2, 2,
...
*
                  ...
                  VEC( 2, 1 ) = C( K2, L1 ) - ( SUML+SGN*SUMR )
*
                  CALL CSLALN2( .TRUE., 2, 1, SMIN, ONE, A( K1, K1 ),
     $                         LDA, ONE, ONE, VEC, 2, -SGN*B( L1, L1 ),
     $                         ZERO, X, 2, SCALOC, XNORM, IERR )
                  IF( IERR.NE.0 )
     $               INFO = 1
...
*
                  ...
                  VEC( 2, 2 ) = C( K2, L2 ) - ( SUML+SGN*SUMR )
*
                  CALL CSLASY2( .TRUE., .FALSE., ISGN, 2, 2, A( K1, K1 
     $  ), 
     $                         LDA, B( L1, L1 ), LDB, VEC, 2, SCALOC, 
     $  X, 
     $                         2, XNORM, IERR )
                  IF( IERR.NE.0 )
     $               INFO = 1
...
*
     ...
     $                         B( L2, MIN( L2+1, N ) ), LDB )
                  VEC( 2, 1 ) = SGN*( C( K1, L2 )-( SUML+SGN*SUMR ) )
*
                  CALL CSLALN2( .FALSE., 2, 1, SMIN, ONE, B( L1, L1 ),
     $                         LDB, ONE, ONE, VEC, 2, -SGN*A( K1, K1 ),
     $                         ZERO, X, 2, SCALOC, XNORM, IERR )
                  IF( IERR.NE.0 )
     $               INFO = 1
...
*
     ...
     $                         B( L2, MIN(L2+1, N ) ), LDB )
                  VEC( 2, 2 ) = C( K2, L2 ) - ( SUML+SGN*SUMR )
*
                  CALL CSLASY2( .TRUE., .TRUE., ISGN, 2, 2, A( K1, K1 
     $  ), 
     $                         LDA, B( L1, L1 ), LDB, VEC, 2, SCALOC, 
     $  X, 
     $                         2, XNORM, IERR )
...
*
     ...
     $                         B( L2, MIN( L2+1, N ) ), LDB )
                  VEC( 2, 2 ) = C( K2, L2 ) - ( SUML+SGN*SUMR )
*
                  CALL CSLASY2( .FALSE., .TRUE., ISGN, 2, 2, A( K1, K1 
     $  ), 
     $                         LDA, B( L1, L1 ), LDB, VEC, 2, SCALOC, 
     $  X, 
     $                         2, XNORM, IERR )
