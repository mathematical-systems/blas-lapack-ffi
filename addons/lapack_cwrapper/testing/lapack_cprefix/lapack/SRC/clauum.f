...
*  =======
*
*  CCLAUUM computes the product U * U' or L' * L, where the triangular
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, CCLAUU2, CTRMM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CCLAUUM', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CCLAUU2( UPLO, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code
*
...
*
     ...
     $                     A( 1, I ), LDA )
               CALL CCLAUU2( 'Upper', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
...
*
     ...
     $                     A( I, 1 ), LDA )
               CALL CCLAUU2( 'Lower', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
