...
*  =======
*
*  CZLAUUM computes the product U * U' or L' * L, where the triangular
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZGEMM, ZHERK, CZLAUU2, ZTRMM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CZLAUUM', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CZLAUU2( UPLO, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code
*
...
*
     ...
     $                     A( 1, I ), LDA )
               CALL CZLAUU2( 'Upper', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
...
*
     ...
     $                     A( I, 1 ), LDA )
               CALL CZLAUU2( 'Lower', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
