...
*  =======
*
*  CDGGSVD computes the generalized singular value decomposition (GSVD)
...
*                converge.  For further details, see subroutine CDTGSJA.
*
*  Internal Parameters
*  ===================
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDGGSVP, CDTGSJA, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*     Preprocessing
*
      CALL CDGGSVP( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB, TOLA,
     $             TOLB, K, L, U, LDU, V, LDV, Q, LDQ, IWORK, WORK,
     $             WORK( N+1 ), INFO )
*
*     Compute the GSVD of two upper "triangular" matrices
*
      CALL CDTGSJA( JOBU, JOBV, JOBQ, M, P, N, K, L, A, LDA, B, LDB,
