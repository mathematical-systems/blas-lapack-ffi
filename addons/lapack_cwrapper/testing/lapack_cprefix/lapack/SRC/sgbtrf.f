...
*  =======
*
*  CSGBTRF computes an LU factorization of a real m-by-n band matrix A
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, CSGBTF2, SGEMM, SGER, CSLASWP, SSCAL,
     $                   SSWAP, STRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*        Use unblocked code
*
         CALL CSGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use CSLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL CSLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
