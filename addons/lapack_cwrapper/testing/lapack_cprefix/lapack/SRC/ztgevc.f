...
*  =======
*
*  CZTGEVC computes some or all of the right and/or left eigenvectors of
...
*     A = Q*S*Z**H,  B = Q*P*Z**H
*  
*  as computed by CZGGHRD + CZHGEQZ.
*  
...
*          factorization, as computed by CZHGEQZ.
*
*  LDS     (input) INTEGER
...
*          factorization, as computed by CZHGEQZ.  P must have real
*          diagonal elements.
*
*  LDP     (input) INTEGER
...
*          of left Schur vectors returned by CZHGEQZ).
...
*          of right Schur vectors returned by CZHGEQZ).
...
*
               LSA = ABS( SBETA ).GE.SAFMIN .AND. ABS( ACOEFF 
     $  ).LT.SMALL 
