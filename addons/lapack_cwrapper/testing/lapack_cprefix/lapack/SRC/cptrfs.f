...
*  =======
*
*  CCPTRFS improves the computed solution to a system of linear
...
*          the factorization computed by CCPTTRF.
*
*  EF      (input) COMPLEX array, dimension (N-1)
*          The (n-1) off-diagonal elements of the unit bidiagonal
*          factor U or L from the factorization computed by CCPTTRF
*          (see UPLO).
*
...
*          On entry, the solution matrix X, as computed by CCPTTRS.
...
*
            CALL CCPTTRS( UPLO, N, 1, DF, EF, WORK, N, INFO )
