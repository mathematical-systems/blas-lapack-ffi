...
*  =======
*
*  CDLAHQR is an auxiliary routine called by CDHSEQR to update the
*  eigenvalues and Schur decomposition already computed by CDHSEQR, by
...
*          ILO = 1). CDLAHQR works primarily with the Hessenberg
...
*          matrix Z of transformations accumulated by CDHSEQR, and on
...
*  INFO    (output) INTEGER
*          = 0: successful exit
*          > 0: CDLAHQR failed to compute all the eigenvalues ILO to IHI
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDLABAD, CDLANV2, CDLARFG, DROT
*     ..
*     .. Intrinsic Functions ..
...
*
         CALL CDLANV2( H( I-1, I-1 ), H( I-1, I ), H( I, I-1 ),
