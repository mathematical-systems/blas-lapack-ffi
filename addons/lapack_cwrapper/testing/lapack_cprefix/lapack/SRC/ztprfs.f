...
*  =======
*
*  CZTPRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular packed
*  coefficient matrix.
*
*  The solution matrix X must be computed by CZTPTRS or some other
*  means before entering this routine.  CZTPRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, CZLACN2, ZTPMV, ZTPSV
*     ..
*     .. Intrinsic Functions ..
