...
*  =======
*
*  CSGGSVD computes the generalized singular value decomposition (GSVD)
...
*                converge.  For further details, see subroutine CSTGSJA.
*
*  Internal Parameters
*  ===================
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, CSGGSVP, CSTGSJA, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      CALL CSTGSJA( JOBU, JOBV, JOBQ, M, P, N, K, L, A, LDA, B, LDB,
