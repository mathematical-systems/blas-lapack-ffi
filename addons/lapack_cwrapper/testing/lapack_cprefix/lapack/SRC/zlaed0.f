...
*  =======
*
*  Using the divide and conquer method, CZLAED0 computes all eigenvalues
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDSTEQR, XERBLA, ZCOPY, CZLACRM, 
     $  CZLAED7 
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
*
     ...
     $   RETURN
*
      SMLSIZ = ILAENV( 9, 'CZLAED0', ' ', 0, 0, 0, 0 )
*
...
*
     ...
     $                RWORK( LL ), MATSIZ, RWORK, INFO )
         CALL CZLACRM( QSIZ, MATSIZ, Q( 1, SUBMAT ), LDQ, RWORK( LL ),
...
*     into an eigensystem of size MATSIZ.  CZLAED7 handles the case
*     when the eigenvectors of a full or band Hermitian matrix (which
*     was reduced to tridiagonal form) are desired.
*
*     I am free to use Q as a valuable working space until Loop 150.
*
            CALL CZLAED7( MATSIZ, MSD2, QSIZ, TLVLS, CURLVL, CURPRB,
