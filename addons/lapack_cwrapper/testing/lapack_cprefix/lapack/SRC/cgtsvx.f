...
*  =======
*
*  CCCGTSVX uses the LU factorization to compute the solution to a complex
...
*          the LU factorization of A as computed by CCGTTRF.
*
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CCGTCON, CCGTRFS, CCGTTRF, CCGTTRS, 
     $  CCLACPY, 
     $                   XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         END IF
         CALL CCGTTRF( N, DLF, DF, DUF, DU2, IPIV, INFO )
*
...
*
      CALL CCGTCON( NORM, N, DLF, DF, DUF, DU2, IPIV, ANORM, RCOND, 
     $  WORK, 
     $             INFO )
*
...
*
      ...
      CALL CCGTTRS( TRANS, N, NRHS, DLF, DF, DUF, DU2, IPIV, X, LDX,
     $             INFO )
*
*     Use iterative refinement to improve the computed solutions and
*     compute error bounds and backward error estimates for them.
*
      CALL CCGTRFS( TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2, IPIV,
