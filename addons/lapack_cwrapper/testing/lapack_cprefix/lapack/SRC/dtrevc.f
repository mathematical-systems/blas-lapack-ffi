...
*  =======
*
*  CDTREVC computes some or all of the right and/or left eigenvectors of
*  a real upper quasi-triangular matrix T.
*  Matrices of this type are produced by the Schur factorization of
*  a real general matrix:  A = Q*T*Q**T, as computed by CDHSEQR.
*  
...
*          of Schur vectors returned by CDHSEQR).
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, DGEMV, CDLALN2, DSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                     CALL CDLALN2( .FALSE., 1, 1, SMIN, ONE, T( J, J ),
...
*
                     CALL CDLALN2( .FALSE., 2, 1, SMIN, ONE,
...
*                    1-by-1 diagonal block
*
                     CALL CDLALN2( .FALSE., 1, 2, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR, 
     $  WI, 
...
*                    2-by-2 diagonal block
*
                     CALL CDLALN2( .FALSE., 2, 2, SMIN, ONE,
     $                            T( J-1, J-1 ), LDT, ONE, ONE,
...
*
                     CALL CDLALN2( .TRUE., 2, 1, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            ZERO, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
...
*                      ([T(j+1,j) T(j+1,j+1)]             )
*
                     CALL CDLALN2( .TRUE., 2, 2, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            -WI, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
