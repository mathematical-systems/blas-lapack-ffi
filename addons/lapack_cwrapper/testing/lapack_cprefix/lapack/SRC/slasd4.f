...
*
      ...
      END IF
      IF( N.EQ.2 ) THEN
         CALL CSLASD5( I, D, Z, DELTA, RHO, SIGMA, WORK )
         RETURN
      END IF
*
...
*
     ...
     $  )*TEMP1 
            ...
            DD( 3 ) = DTIIP
            CALL CSLAED6( NITER, ORGATI, C, DD, ZZ, W, ETA, INFO )
            IF( INFO.NE.0 )
     $         GO TO 240
         END IF
*
