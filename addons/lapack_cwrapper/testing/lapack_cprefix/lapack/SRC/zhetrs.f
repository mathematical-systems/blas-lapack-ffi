...
*  =======
*
*  CZHETRS solves a system of linear equations A*X = B with a complex
*  Hermitian matrix A using the factorization A = U*D*U**H or
*  A = L*D*L**H computed by CZHETRF.
*
*  Arguments
*  =========
*
...
*          obtain the factor U or L as computed by CZHETRF.
*
*  LDA     (input) INTEGER
