...
*  =======
*
*  CSLASQ1 computes the singular values of a real N-by-N bidiagonal
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SLAS2, SLASCL, CSLASQ2, SLASRT, 
     $  XERBLA 
*     ..
*     .. External Functions ..
      REAL               SLAMCH
