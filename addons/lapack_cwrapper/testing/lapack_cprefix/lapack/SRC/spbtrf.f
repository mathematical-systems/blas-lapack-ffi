...
*  =======
*
*  CSPBTRF computes the Cholesky factorization of a real symmetric
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, CSPBTF2, CSPOTF2, SSYRK, STRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
      NB = ILAENV( 1, 'CSPBTRF', UPLO, N, KD, -1, -1 )
*
...
*        Use unblocked code
*
         CALL CSPBTF2( UPLO, N, KD, AB, LDAB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               CALL CSPOTF2( UPLO, IB, AB( KD+1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
...
*              Factorize the diagonal block
*
               CALL CSPOTF2( UPLO, IB, AB( 1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
