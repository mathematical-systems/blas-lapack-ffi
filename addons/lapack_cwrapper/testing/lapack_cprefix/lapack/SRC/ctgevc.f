...
*  =======
*
*  CCTGEVC computes some or all of the right and/or left eigenvectors of
...
*     A = Q*S*Z**H,  B = Q*P*Z**H
*  
*  as computed by CCGGHRD + CCHGEQZ.
*  
...
*          factorization, as computed by CCHGEQZ.
*
*  LDS     (input) INTEGER
...
*          factorization, as computed by CCHGEQZ.  P must have real
*          diagonal elements.
*
*  LDP     (input) INTEGER
...
*          of left Schur vectors returned by CCHGEQZ).
...
*          of right Schur vectors returned by CCHGEQZ).
