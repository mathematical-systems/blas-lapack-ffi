...
*  =======
*
*  CDTPRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular packed
*  coefficient matrix.
*
*  The solution matrix X must be computed by CDTPTRS or some other
*  means before entering this routine.  CDTPRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, CDLACN2, DTPMV, DTPSV, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
