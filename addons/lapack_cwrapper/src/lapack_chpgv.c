 ...
 * lapack_chpgv.c
 *
 *This program is a C interface to chpgv.
 *
...
{
#ifdef F77_INT
	F77_INT F77_itype=itype, F77_n=n, F77_ldz=ldz;
	int i_local;
	F77_INT F77_info[1];
#else
	...
	f77_chpgv(&F77_itype, &F77_jobz, &F77_uplo, &F77_n, ap, bp, w, z, &F77_ldz, work, rwork, F77_info);
