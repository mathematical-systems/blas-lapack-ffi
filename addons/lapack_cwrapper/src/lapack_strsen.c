 ...
 * lapack_strsen.c
 *
 *This program is a C interface to strsen.
 *
...
;
	...
	f77_strsen(&F77_job, &F77_compq, F77_select, &F77_n, t, &F77_ldt, q, &F77_ldq, wr, wi, F77_m, s, sep, work, &F77_lwork, F77_iwork, &F77_liwork, F77_info);
