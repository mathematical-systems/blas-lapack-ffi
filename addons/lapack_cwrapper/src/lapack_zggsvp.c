 ...
 * lapack_zggsvp.c
 *
 *This program is a C interface to zggsvp.
 *
...
{
#ifdef F77_INT
	F77_INT F77_m=m, F77_p=p, F77_n=n, F77_lda=lda, F77_ldb=ldb, F77_ldu=ldu, F77_ldv=ldv, F77_ldq=ldq;
	int i_local;
	F77_INT F77_k[1];
	F77_INT F77_l[1];
	F77_l[0]=(F77_INT) l[0];
	...
	f77_zggsvp(&F77_jobu, &F77_jobv, &F77_jobq, &F77_m, &F77_p, &F77_n, a, &F77_lda, b, &F77_ldb, &tola, &tolb, F77_k, F77_l, u, &F77_ldu, v, &F77_ldv, q, &F77_ldq, F77_iwork, rwork, tau, work, F77_info);
