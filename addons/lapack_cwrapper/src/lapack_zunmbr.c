 ...
 * lapack_zunmbr.c
 *
 *This program is a C interface to zunmbr.
 *
...
{
#ifdef F77_INT
	F77_INT F77_m=m, F77_n=n, F77_k=k, F77_lda=lda, F77_ldc=ldc, F77_lwork=lwork;
	int i_local;
	F77_INT F77_info[1];
#else
	#define F77_m m
...
#ifdef F77_CHAR
	F77_CHAR F77_vect, F77_side, F77_trans;
#else
	...
	f77_zunmbr(&F77_vect, &F77_side, &F77_trans, &F77_m, &F77_n, &F77_k, a, &F77_lda, tau, c, &F77_ldc, work, &F77_lwork, F77_info);
