 ...
 * lapack_zhbevx.c
 *
 *This program is a C interface to zhbevx.
 *
...
{
#ifdef F77_INT
	F77_INT F77_n=n, F77_kd=kd, F77_ldab=ldab, F77_ldq=ldq, F77_il=il, F77_iu=iu, F77_ldz=ldz;
	int i_local;
	F77_INT F77_m[1];
	...
	f77_zhbevx(&F77_jobz, &F77_range, &F77_uplo, &F77_n, &F77_kd, ab, &F77_ldab, q, &F77_ldq, &vl, &vu, &F77_il, &F77_iu, &abstol, F77_m, w, z, &F77_ldz, work, rwork, F77_iwork, F77_ifail, F77_info);
