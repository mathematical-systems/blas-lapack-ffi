 ...
 * lapack_chsein.c
 *
 *This program is a C interface to chsein.
 *
...
;
	...
	f77_chsein(&F77_side, &F77_eigsrc, &F77_initv, F77_select, &F77_n, h, &F77_ldh, w, vl, &F77_ldvl, vr, &F77_ldvr, &F77_mm, F77_m, work, rwork, F77_ifaill, F77_ifailr, F77_info);
