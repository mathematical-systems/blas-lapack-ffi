 ...
 * lapack_dgees.c
 *
 *This program is a C interface to dgees.
 *
...
;
	...
	f77_dgees(&F77_jobvs, &F77_sort, select, &F77_n, a, &F77_lda, F77_sdim, wr, wi, vs, &F77_ldvs, work, &F77_lwork, F77_bwork, F77_info);
