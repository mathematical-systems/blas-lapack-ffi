 ...
 * lapack_cgeesx.c
 *
 *This program is a C interface to cgeesx.
 *
...
;
	...
	f77_cgeesx(&F77_jobvs, &F77_sort, select, &F77_sense, &F77_n, a, &F77_lda, F77_sdim, w, vs, &F77_ldvs, rconde, rcondv, work, &F77_lwork, rwork, F77_bwork, F77_info);
