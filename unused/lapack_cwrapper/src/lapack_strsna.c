 ...
 * lapack_strsna.c
 *
 *This program is a C interface to strsna.
 *
...
;
	...
	f77_strsna(&F77_job, &F77_howmny, F77_select, &F77_n, t, &F77_ldt, vl, &F77_ldvl, vr, &F77_ldvr, s, sep, &F77_mm, F77_m, work, &F77_ldwork, F77_iwork, F77_info);
