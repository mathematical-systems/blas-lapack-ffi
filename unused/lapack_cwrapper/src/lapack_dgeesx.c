 ...
 * lapack_dgeesx.c
 *
 *This program is a C interface to dgeesx.
 *
...
;
	...
	f77_dgeesx(&F77_jobvs, &F77_sort, select, &F77_sense, &F77_n, a, &F77_lda, F77_sdim, wr, wi, vs, &F77_ldvs, rconde, rcondv, work, &F77_lwork, F77_iwork, &F77_liwork, F77_bwork, F77_info);
