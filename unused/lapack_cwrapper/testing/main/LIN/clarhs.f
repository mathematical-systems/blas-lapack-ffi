...
*     .. External Subroutines ..
      EXTERNAL           CGBMV, CGEMM, CHBMV, CHEMM, CHPMV, cclacpy,
     $                   cclarnv, CSBMV, ccspmv, CSYMM, CTBMV, CTPMV,
     $                   CTRMM, xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
         DO 60 J = 1, NRHS
            CALL ccspmv( UPLO, N, ONE, A, X( 1, J ), 1, ZERO, B( 1, J ),
     $                  1 )
   60    CONTINUE
*
...
*
         CALL cclacpy( 'Full', N, NRHS, X, LDX, B, LDB )
         IF( KU.EQ.2 ) THEN
            DIAG = 'U'
         ELSE
            DIAG = 'N'
