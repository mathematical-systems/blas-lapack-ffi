...
*  =======
*
*  CCHKQL tests ccgeqlf, ccungql and ccunmql.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  cclacpy, CLARHS, CLATB4, CLATMS, CQLT01, CQLT02,
     $                   CQLT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.GE.N ) THEN
*
*                       Test ccungql, using factorization
*                       returned by CQLT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test ccunmql, using factorization returned
*                       by CQLT01
*
