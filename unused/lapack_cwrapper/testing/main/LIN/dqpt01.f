...
*          The (possibly partial) output of cdgeqpf.  The upper triangle
...
*          Pivot information as returned by cdgeqpf.
*
...
*     .. External Subroutines ..
      EXTERNAL DAXPY,DCOPY,cdormqr,xerbla
*     ..
*     .. Intrinsic Functions ..
...
*
   ...
   40 CONTINUE
*
      CALL cdormqr('Left','No transpose',M,N,K,AF,LDA,TAU,WORK,M,
...
*
     ...
     +         (DBLE(MAX(M,N))*DLAMCH('Epsilon'))
      IF (NORMA.NE.ZERO) DQPT01 = DQPT01/NORMA
*
      RETURN
*
*     End of DQPT01
