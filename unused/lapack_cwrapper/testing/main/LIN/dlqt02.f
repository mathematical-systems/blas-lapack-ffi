...
*  =======
*
*  DLQT02 tests cdorglq, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL DGEMM,cdlacpy,cdlaset,cdorglq,DSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*
      SRNAMT = 'cdorglq'
      CALL cdorglq(M,N,K,Q,LDA,TAU,WORK,LWORK,INFO)
*
*     Copy L(1:k,1:m)
*
      CALL cdlaset('Full',K,M,ZERO,ZERO,L,LDA)
      CALL cdlacpy('Lower',K,M,AF,LDA,L,LDA)
*
