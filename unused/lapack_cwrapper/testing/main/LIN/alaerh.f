...
*
          IF (LSAMEN(3,C3,'TRF')) THEN
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9988) SUBNAM,INFO,INFOE,M,N,N5,IMAT
              ELSE
...
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9984) SUBNAM,INFO,INFOE,N,N5,IMAT
              ELSE
...
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9992) SUBNAM,INFO,INFOE,OPTS(1:1),
     +              OPTS(2:2),N,N5,IMAT
              ELSE
                  WRITE (NOUT,FMT=9997) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +              N,N5,IMAT
              END IF
*
...
*
              WRITE (NOUT,FMT=9969) SUBNAM,INFO,OPTS(1:1),M,IMAT
*
          ELSE IF (LSAMEN(3,C3,'LS ')) THEN
*
              WRITE (NOUT,FMT=9965) SUBNAM,INFO,OPTS(1:1),M,N,KL,N5,IMAT
*
          ELSE IF (LSAMEN(3,C3,'LSX') .OR. LSAMEN(3,C3,'LSS')) THEN
*
              WRITE (NOUT,FMT=9974) SUBNAM,INFO,M,N,KL,N5,IMAT
*
          ELSE
*
              WRITE (NOUT,FMT=9963) SUBNAM,INFO,OPTS(1:1),M,N5,IMAT
          END IF
*
...
*
          IF (LSAMEN(3,C3,'TRF')) THEN
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9989) SUBNAM,INFO,INFOE,M,N,KL,KU,N5,
     +              IMAT
              ELSE
                  WRITE (NOUT,FMT=9976) SUBNAM,INFO,M,N,KL,KU,N5,IMAT
              END IF
              IF (INFO.NE.0) WRITE (NOUT,FMT=9949)
*
          ELSE IF (LSAMEN(3,C3,'SV ')) THEN
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9986) SUBNAM,INFO,INFOE,N,KL,KU,N5,
     +              IMAT
              ELSE
                  WRITE (NOUT,FMT=9972) SUBNAM,INFO,N,KL,KU,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(3,C3,'SVX')) THEN
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9993) SUBNAM,INFO,INFOE,OPTS(1:1),
     +              OPTS(2:2),N,KL,KU,N5,IMAT
              ELSE
                  WRITE (NOUT,FMT=9998) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +              N,KL,KU,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(5,SUBNAM(2:6),'LATMS')) THEN
...
*
          ELSE IF (LSAMEN(3,C3,'CON')) THEN
*
              WRITE (NOUT,FMT=9968) SUBNAM,INFO,OPTS(1:1),M,KL,KU,IMAT
*
          ELSE
*
              WRITE (NOUT,FMT=9964) SUBNAM,INFO,OPTS(1:1),M,KL,KU,N5,
     +          IMAT
          END IF
*
...
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9990) SUBNAM,INFO,INFOE,OPTS(1:1),
     +              OPTS(2:2),N,N5,IMAT
              ELSE
                  WRITE (NOUT,FMT=9995) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +              N,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(3,C3,'TRI')) THEN
...
*
          ELSE IF (LSAMEN(5,SUBNAM(2:6),'LATMS') .OR.
     +             LSAMEN(3,C3,'TRI') .OR. LSAMEN(3,C3,'CON')) THEN
*
              WRITE (NOUT,FMT=9960) SUBNAM,INFO,UPLO,M,IMAT
*
          ELSE
...
*
          ...
          IF (LSAMEN(3,C3,'TRF')) THEN
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9983) SUBNAM,INFO,INFOE,UPLO,M,IMAT
              ELSE
                  WRITE (NOUT,FMT=9960) SUBNAM,INFO,UPLO,M,IMAT
              END IF
              IF (INFO.NE.0) WRITE (NOUT,FMT=9949)
...
*
          ...
          IF (LSAMEN(3,C3,'TRF')) THEN
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9982) SUBNAM,INFO,INFOE,UPLO,M,KL,N5,
     +              IMAT
              ELSE
                  WRITE (NOUT,FMT=9958) SUBNAM,INFO,UPLO,M,KL,N5,IMAT
              END IF
              IF (INFO.NE.0) WRITE (NOUT,FMT=9949)
*
          ELSE IF (LSAMEN(3,C3,'SV ')) THEN
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9981) SUBNAM,INFO,INFOE,UPLO,N,KL,N5,
     +              IMAT
              ELSE
                  WRITE (NOUT,FMT=9957) SUBNAM,INFO,UPLO,N,KL,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(3,C3,'SVX')) THEN
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9991) SUBNAM,INFO,INFOE,OPTS(1:1),
     +              OPTS(2:2),N,KL,N5,IMAT
              ELSE
                  WRITE (NOUT,FMT=9996) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +              N,KL,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(5,SUBNAM(2:6),'LATMS') .OR.
...
*
          ELSE
*
              WRITE (NOUT,FMT=9957) SUBNAM,INFO,UPLO,M,KL,N5,IMAT
          END IF
*
...
*
              IF (INFO.NE.INFOE .AND. INFOE.NE.0) THEN
                  WRITE (NOUT,FMT=9994) SUBNAM,INFO,INFOE,OPTS(1:1),N,
     +              N5,IMAT
              ELSE
                  WRITE (NOUT,FMT=9999) SUBNAM,INFO,OPTS(1:1),N,N5,IMAT
              END IF
*
          ELSE IF (LSAMEN(3,C3,'CON')) THEN
*
...
*
          IF (LSAMEN(3,C3,'TRI')) THEN
              WRITE (NOUT,FMT=9961) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),M,
     +          N5,IMAT
          ELSE IF (LSAMEN(3,C3,'CON')) THEN
              WRITE (NOUT,FMT=9967) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),M,IMAT
          ELSE IF (LSAMEN(5,SUBNAM(2:6),'LATRS')) THEN
              WRITE (NOUT,FMT=9952) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),OPTS(4:4),M,IMAT
          ELSE
              WRITE (NOUT,FMT=9953) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),M,N5,IMAT
          END IF
*
...
*
          IF (LSAMEN(3,C3,'TRI')) THEN
              WRITE (NOUT,FMT=9962) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),M,
     +          IMAT
          ELSE IF (LSAMEN(3,C3,'CON')) THEN
              WRITE (NOUT,FMT=9967) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),M,IMAT
...
*
          IF (LSAMEN(3,C3,'CON')) THEN
              WRITE (NOUT,FMT=9966) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),M,KL,IMAT
          ELSE IF (LSAMEN(5,SUBNAM(2:6),'LATBS')) THEN
              WRITE (NOUT,FMT=9951) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),OPTS(4:4),M,KL,IMAT
          ELSE
              WRITE (NOUT,FMT=9954) SUBNAM,INFO,OPTS(1:1),OPTS(2:2),
     +          OPTS(3:3),M,KL,N5,IMAT
          END IF
*
...
*
 9999 FORMAT (' *** Error code from ',A7,'=',I5,', FACT=''',A1,''', N=',
     +       I5,', NRHS=',I4,', type ',I2)
*
*     SUBNAM, INFO, FACT, TRANS, N, KL, KU, NRHS, IMAT
*
 9998 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> FACT=''',A1,
     +       ''', TRANS=''',A1,''', N=',I5,', KL=',I5,', KU=',I5,
     +       ', NRHS=',I4,', type ',I1)
*
*     SUBNAM, INFO, FACT, TRANS, N, NRHS, IMAT
*
 9997 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> FACT=''',A1,
     +       ''', TRANS=''',A1,''', N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, FACT, UPLO, N, KD, NRHS, IMAT
*
 9996 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> FACT=''',A1,
     +       ''', UPLO=''',A1,''', N=',I5,', KD=',I5,', NRHS=',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, FACT, UPLO, N, NRHS, IMAT
*
 9995 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> FACT=''',A1,
     +       ''', UPLO=''',A1,''', N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, FACT, N, NRHS, IMAT
*
 9994 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> FACT=''',A1,''', N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, FACT, TRANS, N, KL, KU, NRHS, IMAT
*
 9993 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> FACT=''',A1,''', TRANS=''',A1,''', N=',I5,', KL=',
     +       I5,', KU=',I5,', NRHS=',I4,', type ',I1)
*
*     SUBNAM, INFO, INFOE, FACT, TRANS, N, NRHS, IMAT
*
 9992 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> FACT=''',A1,''', TRANS=''',A1,''', N =',I5,
     +       ', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, FACT, UPLO, N, KD, NRHS, IMAT
*
 9991 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> FACT=''',A1,''', UPLO=''',A1,''', N=',I5,', KD=',I5,
     +       ', NRHS=',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, FACT, UPLO, N, NRHS, IMAT
*
 9990 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> FACT=''',A1,''', UPLO=''',A1,''', N =',I5,
     +       ', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, M, N, KL, KU, NB, IMAT
*
 9989 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> M = ',I5,', N =',I5,', KL =',I5,', KU =',I5,
     +       ', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, M, N, NB, IMAT
*
 9988 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> M =',I5,', N =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, N, IMAT
*
 9987 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       ' for N=',I5,', type ',I2)
*
*     SUBNAM, INFO, INFOE, N, KL, KU, NRHS, IMAT
*
 9986 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> N =',I5,', KL =',I5,', KU =',I5,', NRHS =',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, INFOE, N, NB, IMAT
*
 9985 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> N =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, N, NRHS, IMAT
*
 9984 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, UPLO, N, IMAT
*
 9983 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> UPLO = ''',A1,''', N =',I5,', type ',I2)
*
*     SUBNAM, INFO, INFOE, UPLO, N, KD, NB, IMAT
*
 9982 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> UPLO = ''',A1,''', N =',I5,', KD =',I5,', NB =',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, INFOE, UPLO, N, KD, NRHS, IMAT
*
 9981 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> UPLO=''',A1,''', N =',I5,', KD =',I5,', NRHS =',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, INFOE, UPLO, N, NB, IMAT
*
 9980 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> UPLO = ''',A1,''', N =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, INFOE, UPLO, N, NRHS, IMAT
*
 9979 FORMAT (' *** ',A7,' returned with INFO =',I5,' instead of ',I2,
     +       /' ==> UPLO = ''',A1,''', N =',I5,', NRHS =',I4,', type ',
     +       I2)
*
*     SUBNAM, INFO, M, N, IMAT
*
 9978 FORMAT (' *** Error code from ',A7,' =',I5,' for M =',I5,', N =',
     +       I5,', type ',I2)
*
*     SUBNAM, INFO, M, N, KL, KU, IMAT
*
 9977 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> M = ',I5,
     +       ', N =',I5,', KL =',I5,', KU =',I5,', type ',I2)
*
*     SUBNAM, INFO, M, N, KL, KU, NB, IMAT
*
 9976 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> M = ',I5,
     +       ', N =',I5,', KL =',I5,', KU =',I5,', NB =',I4,', type ',
     +       I2)
*
*     SUBNAM, INFO, M, N, NB, IMAT
*
 9975 FORMAT (' *** Error code from ',A7,'=',I5,' for M=',I5,', N=',I5,
     +       ', NB=',I4,', type ',I2)
*
*     SUBNAM, INFO, M, N, NRHS, NB, IMAT
*
 9974 FORMAT (' *** Error code from ',A7,'=',I5,/' ==> M =',I5,', N =',
     +       I5,', NRHS =',I4,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, N, IMAT
*
 9973 FORMAT (' *** Error code from ',A7,' =',I5,' for N =',I5,
     +       ', type ',I2)
*
*     SUBNAM, INFO, N, KL, KU, NRHS, IMAT
*
 9972 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> N =',I5,
     +       ', KL =',I5,', KU =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, N, NB, IMAT
*
 9971 FORMAT (' *** Error code from ',A7,'=',I5,' for N=',I5,', NB=',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, N, NRHS, IMAT
*
 9970 FORMAT (' *** Error code from ',A7,' =',I5,' for N =',I5,
     +       ', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, NORM, N, IMAT
*
 9969 FORMAT (' *** Error code from ',A7,' =',I5,' for NORM = ''',A1,
     +       ''', N =',I5,', type ',I2)
*
*     SUBNAM, INFO, NORM, N, KL, KU, IMAT
*
 9968 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> NORM =''',A1,
     +       ''', N =',I5,', KL =',I5,', KU =',I5,', type ',I2)
*
*     SUBNAM, INFO, NORM, UPLO, DIAG, N, IMAT
*
 9967 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> NORM=''',A1,
     +       ''', UPLO =''',A1,''', DIAG=''',A1,''', N =',I5,', type ',
     +       I2)
*
*     SUBNAM, INFO, NORM, UPLO, DIAG, N, KD, IMAT
*
 9966 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> NORM=''',A1,
     +       ''', UPLO =''',A1,''', DIAG=''',A1,''', N=',I5,', KD=',I5,
     +       ', type ',I2)
*
*     SUBNAM, INFO, TRANS, M, N, NRHS, NB, IMAT
*
 9965 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> TRANS = ''',A1,
     +       ''', M =',I5,', N =',I5,', NRHS =',I4,', NB =',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, TRANS, N, KL, KU, NRHS, IMAT
*
 9964 FORMAT (' *** Error code from ',A7,'=',I5,/' ==> TRANS=''',A1,
     +       ''', N =',I5,', KL =',I5,', KU =',I5,', NRHS =',I4,
     +       ', type ',I2)
*
*     SUBNAM, INFO, TRANS, N, NRHS, IMAT
*
 9963 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> TRANS = ''',A1,
     +       ''', N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, DIAG, N, IMAT
*
 9962 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO=''',A1,
     +       ''', DIAG =''',A1,''', N =',I5,', type ',I2)
*
*     SUBNAM, INFO, UPLO, DIAG, N, NB, IMAT
*
 9961 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO=''',A1,
     +       ''', DIAG =''',A1,''', N =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, IMAT
*
 9960 FORMAT (' *** Error code from ',A7,' =',I5,' for UPLO = ''',A1,
     +       ''', N =',I5,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, KD, IMAT
*
 9959 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO = ''',A1,
     +       ''', N =',I5,', KD =',I5,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, KD, NB, IMAT
*
 9958 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO = ''',A1,
     +       ''', N =',I5,', KD =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, KD, NRHS, IMAT
*
 9957 FORMAT (' *** Error code from ',A7,'=',I5,/' ==> UPLO = ''',A1,
     +       ''', N =',I5,', KD =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, NB, IMAT
*
 9956 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO = ''',A1,
     +       ''', N =',I5,', NB =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, N, NRHS, IMAT
*
 9955 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO = ''',A1,
     +       ''', N =',I5,', NRHS =',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, TRANS, DIAG, N, KD, NRHS, IMAT
*
 9954 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO=''',A1,
     +       ''', TRANS=''',A1,''', DIAG=''',A1,''', N=',I5,', KD=',I5,
     +       ', NRHS=',I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, TRANS, DIAG, N, NRHS, IMAT
*
 9953 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO=''',A1,
     +       ''', TRANS=''',A1,''', DIAG=''',A1,''', N =',I5,', NRHS =',
     +       I4,', type ',I2)
*
*     SUBNAM, INFO, UPLO, TRANS, DIAG, NORMIN, N, IMAT
*
 9952 FORMAT (' *** Error code from ',A7,' =',I5,/' ==> UPLO=''',A1,
     +       ''', TRANS=''',A1,''', DIAG=''',A1,''', NORMIN=''',A1,
     +       ''', N =',I5,', type ',I2)
*
*     SUBNAM, INFO, UPLO, TRANS, DIAG, NORMIN, N, KD, IMAT
*
 9951 FORMAT (' *** Error code from ',A6,' =',I5,/' ==> UPLO=''',A1,
     +       ''', TRANS=''',A1,''', DIAG=''',A1,''', NORMIN=''',A1,
     +       ''', N=',I5,', KD=',I5,', type ',I2)
*
*     Unknown type
*
 9950 FORMAT (' *** Error code from ',A7,' =',I5)
*
*     What we do next
*
