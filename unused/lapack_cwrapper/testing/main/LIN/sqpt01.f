...
*          The (possibly partial) output of csgeqpf.  The upper triangle
...
*          Pivot information as returned by csgeqpf.
*
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, csormqr, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*
   ...
   40 CONTINUE
*
      CALL csormqr( 'Left', 'No transpose', M, N, K, AF, LDA, TAU, WORK,
