      SUBROUTINE DGTT02(TRANS,N,NRHS,DL,D,DU,X,LDX,B,LDB,RWORK,RESID)
*
...
*     ..
*     .. Array Arguments ..
      DOUBLE PRECISION B(LDB,*),D(*),DL(*),DU(*),RWORK(*),X(LDX,*)
*     ..
*
*  Purpose
*  =======
...
*     Compute B - op(A)*X.
*
      CALL cdlagtm(TRANS,N,NRHS,-ONE,DL,D,DU,X,LDX,ONE,B,LDB)
*
      DO 10 J = 1,NRHS
