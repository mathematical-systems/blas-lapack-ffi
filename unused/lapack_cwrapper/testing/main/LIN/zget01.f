...
*          L and U from the L*U factorization as computed by czgetrf.
...
*          The pivot indices from czgetrf.
*
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMV, czlaswp, ZSCAL, ZTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, MIN
*     ..
...
*
     ...
     $                  LDAFAC, AFAC( 1, K ), 1 )
         END IF
   10 CONTINUE
      CALL czlaswp( N, AFAC, LDAFAC, 1, MIN( M, N ), IPIV, -1 )
*
