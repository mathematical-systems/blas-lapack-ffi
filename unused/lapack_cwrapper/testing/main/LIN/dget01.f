...
*          L and U from the L*U factorization as computed by cdgetrf.
...
*          The pivot indices from cdgetrf.
*
...
*     .. External Subroutines ..
      EXTERNAL DGEMV,cdlaswp,DSCAL,DTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MIN
*     ..
...
*
              ...
              IF (K+1.LE.M) THEN
                  ...
                  CALL DGEMV('No transpose',M-K,K-1,ONE,AFAC(K+1,1),
     +                       LDAFAC,AFAC(1,K),1,ONE,AFAC(K+1,K),1)
              END IF
*
...
*
     ...
     +                   AFAC(1,K),1)
          END IF
   10 CONTINUE
      CALL cdlaswp(N,AFAC,LDAFAC,1,MIN(M,N),IPIV,-1)
*
