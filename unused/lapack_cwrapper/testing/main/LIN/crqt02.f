...
*  =======
*
*  CRQT02 tests ccungrq, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, cclacpy, cclaset, ccungrq
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'ccungrq'
      CALL ccungrq( M, N, K, Q, LDA, TAU( M-K+1 ), WORK, LWORK, INFO )
*
*     Copy R(m-k+1:m,n-m+1:n)
*
      CALL cclaset( 'Full', K, M, CMPLX( ZERO ), CMPLX( ZERO ),
     $             R( M-K+1, N-M+1 ), LDA )
      CALL cclacpy( 'Upper', K, K, AF( M-K+1, N-K+1 ), LDA,
     $             R( M-K+1, N-K+1 ), LDA )
*
