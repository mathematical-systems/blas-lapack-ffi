...
*  =======
*
*  CCHKLQ tests ccgelqf, ccunglq and ccunmlq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  cclacpy, CLARHS, CLATB4, CLATMS, CLQT01, CLQT02,
     $                   CLQT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test ccunglq, using factorization
*                       returned by CLQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test ccunmlq, using factorization returned
*                       by CLQT01
*
...
*
     ...
     $                                  ISEED, INFO )
*
                           CALL cclacpy( 'Full', M, NRHS, B, LDA, X,
     $                                  LDA )
                           SRNAMT = 'CGELQS'
