...
*  =======
*
*  CQRT03 tests ccunmqr, which computes Q*C, Q'*C, C*Q or C*Q'.
*
*  CQRT03 compares the results of a call to ccunmqr with the results of
*  forming Q explicitly by a call to ccungqr and then performing matrix
...
*          returnedby ccgeqrf. See ccgeqrf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL        CGEMM, cclacpy, cclarnv, cclaset, ccungqr, ccunmqr
*     ..
*     .. Local Arrays ..
      INTEGER            ISEED( 4 )
*     ..
...
*
      ...
      CALL cclacpy( 'Lower', M-1, K, AF( 2, 1 ), LDA, Q( 2, 1 ), LDA )
*
*     Generate the m-by-m matrix Q
*
      SRNAMT = 'ccungqr'
      CALL ccungqr( M, M, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
      DO 30 ISIDE = 1, 2
         IF( ISIDE.EQ.1 ) THEN
            SIDE = 'L'
...
*
            SRNAMT = 'ccunmqr'
            CALL ccunmqr( SIDE, TRANS, MC, NC, K, AF, LDA, TAU, CC, LDA,
     $                   WORK, LWORK, INFO )
*
