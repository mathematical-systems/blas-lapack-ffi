...
*  =======
*
*  ZLQT03 tests czunmlq, which computes Q*C, Q'*C, C*Q or C*Q'.
*
*  ZLQT03 compares the results of a call to czunmlq with the results of
*  forming Q explicitly by a call to czunglq and then performing matrix
...
*          returned by czgelqf. See ccgelqf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL        ZGEMM, czlacpy, czlarnv, czlaset, czunglq, czunmlq
*     ..
*     .. Local Arrays ..
      INTEGER            ISEED( 4 )
*     ..
...
*
      ...
      CALL czlacpy( 'Upper', K, N-1, AF( 1, 2 ), LDA, Q( 1, 2 ), LDA )
*
*     Generate the n-by-n matrix Q
*
      SRNAMT = 'czunglq'
      CALL czunglq( N, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
      DO 30 ISIDE = 1, 2
         IF( ISIDE.EQ.1 ) THEN
            SIDE = 'L'
...
*
            SRNAMT = 'czunmlq'
            CALL czunmlq( SIDE, TRANS, MC, NC, K, AF, LDA, TAU, CC, LDA,
     $                   WORK, LWORK, INFO )
*
