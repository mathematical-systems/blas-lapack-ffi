...
*          of A.  See cdpbtrf for further details.
*
*  LDA     (input) INTEGER.
...
*
              IF (KLEN.GT.0) CALL DTRMV('Upper','Transpose','Non-unit',
...
*
              IF (KLEN.GT.0) CALL DSYR('Lower',KLEN,ONE,AFAC(2,K),1,
     +                                 AFAC(1,K+1),LDAFAC-1)
*
