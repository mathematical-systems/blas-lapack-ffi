...
*  CTZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cctzrqf.
*
*  Arguments
*  =========
*
...
*          The output of cctzrqf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, cclatzm, cclaset, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*
      DO 30 I = 1, M
         CALL cclatzm( 'Right', I, N-M+1, AF( I, M+1 ), LDA, TAU( I ),
