...
*     .. External Subroutines ..
      EXTERNAL           cclaset, ccunmrz, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*     Q := P(1) * ... * P(m) * Q
*
      CALL ccunmrz( 'Left', 'No transpose', N, N, M, N-M, AF, LDA, TAU,
     $             WORK, N, WORK( N*N+1 ), LWORK-N*N, INFO )
*
*     Q := P(m)' * ... * P(1)' * Q
*
      CALL ccunmrz('Left', 'Conjugate transpose', N, N, M, N-M, AF, LDA,
