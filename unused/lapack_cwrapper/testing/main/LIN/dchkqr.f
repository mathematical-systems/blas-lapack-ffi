...
*     .. Array Arguments ..
      ...
      DOUBLE PRECISION A(*),AC(*),AF(*),AQ(*),AR(*),B(*),RWORK(*),
     +                 TAU(*),WORK(*),X(*),XACT(*)
*     ..
*
*  Purpose
*  =======
*
*  DCHKQR tests cdgeqrf, cdorgqr and cdormqr.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL ALAERH,ALAHD,ALASUM,DERRQR,DGEQRS,DGET02,cdlacpy,DLARHS,
     +         DLATB4,DLATMS,DQRT01,DQRT02,DQRT03,XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
*     ..
...
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ELSE IF (M.GE.N) THEN
*
*                       Test cdorgqr, using factorization
*                       returned by DQRT01
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ...
                          IF (M.GE.K) THEN
*
*                       Test cdormqr, using factorization returned
*                       by DQRT01
*
