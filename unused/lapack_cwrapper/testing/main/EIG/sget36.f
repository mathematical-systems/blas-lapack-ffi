...
*  =======
*
*  SGET36 tests cstrexc, a routine for moving blocks (either 1 by 1 or
*  2 by 2) on the diagonal of a matrix in real Schur form.  Thus, cslaexc
...
*     .. External Subroutines ..
      EXTERNAL           SHST01, cslacpy, cslaset, cstrexc
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, SIGN
*     ..
...
*
   ...
   20 CONTINUE
      CALL cslacpy( 'F', N, N, TMP, LDT, T1, LDT )
      CALL cslacpy( 'F', N, N, TMP, LDT, T2, LDT )
      IFSTSV = IFST
      ILSTSV = ILST
      IFST1 = IFST
      ILST1 = ILST
...
*
      CALL cslaset( 'Full', N, N, ZERO, ONE, Q, LDT )
      CALL cstrexc( 'N', N, T1, LDT, Q, LDT, IFST1, ILST1, WORK, INFO1 )
      DO 40 I = 1, N
         DO 30 J = 1, N
...
*
      CALL cslaset( 'Full', N, N, ZERO, ONE, Q, LDT )
      CALL cstrexc( 'V', N, T2, LDT, Q, LDT, IFST2, ILST2, WORK, INFO2 )
*
*     Compare T1 with T2
*
      DO 60 I = 1, N
