...
*          as computed by csgehrd.  H is assumed to be zero below the
*          first subdiagonal.
*
*  LDH     (input) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, cslabad, cslacpy, SORT01
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      LDWORK = MAX( 1, N )
      CALL cslacpy( ' ', N, N, A, LDA, WORK, LDWORK )
*
*     Compute Q*H
*
