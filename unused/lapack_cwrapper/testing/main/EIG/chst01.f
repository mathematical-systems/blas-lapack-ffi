...
*          as computed by ccgehrd.  H is assumed to be zero below the
*          first subdiagonal.
*
*  LDH     (input) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, cclacpy, CUNT01, cslabad
*     ..
*     .. Intrinsic Functions ..
...
*
      LDWORK = MAX( 1, N )
      CALL cclacpy( ' ', N, N, A, LDA, WORK, LDWORK )
*
*     Compute Q*H
*
