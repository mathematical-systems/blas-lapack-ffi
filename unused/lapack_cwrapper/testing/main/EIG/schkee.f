...
*      Test csgehrd, csorghr, cshseqr, cstrevc, cshsein, and csormhr
*
*  SEP (Symmetric Eigenvalue Problem):
*      Test cssytrd, csorgtr, cssteqr, cssterf, csstein, csstedc,
*      and drivers cssyev(X), cssbev(X), csspev(X), csstev(X),
*                  cssyevD,   cssbevD,   csspevD,   csstevD
*
*  SVD (Singular Value Decomposition):
*      Test csgebrd, csorgbr, csbdsqr, csbdsdc
*      and the drivers csgesvD, csgesdd
*
...
*      Test csgghrd, csggbal, csggbak, cshgeqz, and cstgevc
*      and the driver routines csgegs and csgegv
*
...
*      Test cssygst, cssygv, cssygvD, cssygvX, csspgst, csspgv, csspgvD,
*      csspgvX, cssbgst, cssbgv, cssbgvD, and cssbgvX
*
...
*      Test cslaln2, cslasy2, SLAEQU, cslaexc, cstrsyl, cstrexc, cstrsna,
*      cstrsen, and cslaqtr
*
...
*      Tests csggqrf and csggrqf
*
*  GSV (Generalized Singular Value Decomposition):
*      Tests csggsvd, csggsvp, cstgsja, cslags2, cslapll, and cslapmt
*
...
*           The 3-character path name is 'SEV' to test csgeev, or
*           'SES' to test csgees.
*
*-----------------------------------------------------------------------
*
...
*
*  line 1:  'SBL' in columns 1-3 to test csgebal, or 'SBK' in
...
*
*  line 1:  'SGL' in columns 1-3 to test csggbal, or 'SGK' in
*           columns 1-3 to test csggbak.
*
*  The remaining lines consist of specially constructed test cases.
*
*-----------------------------------------------------------------------
...
*              csgeev (eigenvalues and eigenvectors)
*        --------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   WORK, LWORK, IWORK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'csgeev', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*
     ...
     $                   LOGWRK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'csgees', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              csgeevX (eigenvalues, eigenvectors and condition numbers)
*        --------------------------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   RESULT, WORK, LWORK, IWORK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'csgeevX', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              csgeesX (Schur form and condition numbers)
*        ---------------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'csgeesX', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              csggesX (Schur form and condition numbers)
*        -------------------------------------------------
*
         MAXTYP = 5
         NTYPES = MAXTYP
...
*              csggevX (eigenvalue/vector with condition numbers)
*        -------------------------------------------------
*
         MAXTYP = 2
         NTYPES = MAXTYP
...
*
 ...
 9979 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Driver',
     $      / '    csgeev (eigenvalues and eigevectors)' )
 ...
 9977 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Expert',
     $      ' Driver', / '    csgeevX (eigenvalues, eigenvectors and',
     $      ' condition numbers)' )
 9976 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Expert',
     $      ' Driver', / '    csgeesX (Schur form and condition',
     $      ' numbers)' )
 9975 FORMAT( / ' Tests of the Generalized Nonsymmetric Eigenvalue ',
     $      'Problem routines' )
 9974 FORMAT( ' Tests of cssbtrd', / ' (reduction of a symmetric band ',
