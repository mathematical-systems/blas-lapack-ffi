...
*  =======
*
*  SGET39 tests cslaqtr, a routine for solving the real or
...
*  estimation in the eigenproblem routine cstrsna.
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SGEMV, cslabad, cslaqtr
*     ..
*     .. Intrinsic Functions ..
...
*
                        ...
                        KNT = KNT + 1
                        CALL cslaqtr( .FALSE., .TRUE., N, T, LDT, DUM,
...
*
                        CALL SCOPY( N, D, 1, X, 1 )
                        KNT = KNT + 1
                        CALL cslaqtr( .TRUE., .TRUE., N, T, LDT, DUM,
     $                               DUMM, SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
...
*
                        ...
                        KNT = KNT + 1
                        CALL cslaqtr( .FALSE., .FALSE., N, T, LDT, B, W,
     $                               SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
...
*
                        CALL SCOPY( 2*N, D, 1, X, 1 )
                        KNT = KNT + 1
                        CALL cslaqtr( .TRUE., .FALSE., N, T, LDT, B, W,
     $                               SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
