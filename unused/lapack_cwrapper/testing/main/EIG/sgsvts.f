...
*  =======
*
*  SGSVTS tests csggsvd, which computes the GSVD of an M-by-N matrix A
...
*          Details of the GSVD of A and B, as returned by csggsvd,
*          see csggsvd for further details.
*
*  LDA     (input) INTEGER
...
*          ALPHA and BETA, see subroutine csggsvd for details.
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SGEMM, csggsvd, cslacpy, cslaset, SSYRK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL csggsvd( 'U', 'V', 'Q', M, N, P, K, L, AF, LDA, BF, LDB,
...
*     Compute I - U'*U
*
      CALL cslaset( 'Full', M, M, ZERO, ONE, WORK, LDQ )
...
*     Compute I - V'*V
*
      CALL cslaset( 'Full', P, P, ZERO, ONE, WORK, LDV )
...
*     Compute I - Q'*Q
*
      CALL cslaset( 'Full', N, N, ZERO, ONE, WORK, LDQ )
