...
*  =======
*
*  CDSYGST reduces a real symmetric-definite generalized eigenproblem
*  to standard form.
*
...
*
*  B must have been previously factorized as U**T*U or L*L**T by CDPOTRF.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CDSYGS2, DSYMM, DSYR2K, DTRMM, DTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CDSYGST', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CDSYGS2( ITYPE, UPLO, N, A, LDA, B, LDB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
                  CALL CDSYGS2( ITYPE, UPLO, KB, A( K, K ), LDA,
     $                         B( K, K ), LDB, INFO )
                  IF( K+KB.LE.N ) THEN
