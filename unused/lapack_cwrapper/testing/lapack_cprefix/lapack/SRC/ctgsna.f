...
*  =======
*
*  CCTGSNA estimates reciprocal condition numbers for specified
...
*          columns of VL, as returned by CCTGEVC.
...
*          (A, B), corresponding to the eigenpairs specified by HOWMNY
*          and SELECT.  The eigenvectors must be stored in consecutive
*          columns of VR, as returned by CCTGEVC.
...
*     .. External Subroutines ..
      EXTERNAL           CGEMV, CCLACPY, CCTGEXC, CCTGSYL, CSLABAD, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
               CALL CCLACPY( 'Full', N, N, A, LDA, WORK, N )
               CALL CCLACPY( 'Full', N, N, B, LDB, WORK( N*N+1 ), N )
               IFST = K
               ILST = 1
*
               CALL CCTGEXC( .FALSE., .FALSE., N, WORK, N, WORK( N*N+1 
     $  ), 
...
*
                  ...
                  N2 = N - N1
                  I = N*N + 1
                  CALL CCTGSYL( 'N', IDIFJB, N2, N1, WORK( N*N1+N1+1 ),
