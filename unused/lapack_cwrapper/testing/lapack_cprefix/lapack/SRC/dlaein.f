...
*  =======
*
*  CDLAEIN uses inverse iteration to find a right or left eigenvector
...
*     .. External Subroutines ..
      EXTERNAL           CDLADIV, CDLATRS, DSCAL
*     ..
*     .. Intrinsic Functions ..
...
*           overwriting x on v.
*
            CALL CDLATRS( 'Upper', TRANS, 'Nonunit', NORMIN, N, B, LDB,
     $                   VR, SCALE, WORK, IERR )
            NORMIN = 'Y'
*
...
*
                  CALL CDLADIV( XR, XI, B( I, I ), B( I+1, I ), VR( I 
     $  ), 
     $                         VI( I ) )
