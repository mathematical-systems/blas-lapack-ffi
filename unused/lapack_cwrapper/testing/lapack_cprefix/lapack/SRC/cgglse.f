...
*  =======
*
*  CCGGLSE solves the linear equality-constrained least squares (LSE)
*  problem:
*
...
*          CCGEQRF, CCGERQF, CCUNMQR and CCUNMRQ.
*
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CCOPY, CGEMV, CCGGRQF, CTRMV, CCTRTRS,
     $                   CCUNMQR, CCUNMRQ, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      EXTERNAL           ILAENV 
...
*
      IF( INFO.EQ.0) THEN
         ...
         ELSE
            ...
            NB3 = ILAENV( 1, 'CCUNMQR', ' ', M, N, P, -1 )
            NB4 = ILAENV( 1, 'CCUNMRQ', ' ', M, N, P, -1 )
...
*     unitary.
*
      CALL CCGGRQF( P, M, N, B, LDB, WORK, A, LDA, WORK( P+1 ),
...
*                       ( c2 ) M+P-N
*
      CALL CCUNMQR( 'Left', 'Conjugate Transpose', M, 1, MN, A, LDA,
...
*
      IF( P.GT.0 ) THEN
         CALL CCTRTRS( 'Upper', 'No transpose', 'Non-unit', P, 1,
...
*
      IF( N.GT.P ) THEN
         CALL CCTRTRS( 'Upper', 'No transpose', 'Non-unit', N-P, 1,
     $                A, LDA, C, N-P, INFO )
*
         IF( INFO.GT.0 ) THEN
            INFO = 2
...
*
      CALL CCUNMRQ( 'Left', 'Conjugate Transpose', N, 1, P, B, LDB,
