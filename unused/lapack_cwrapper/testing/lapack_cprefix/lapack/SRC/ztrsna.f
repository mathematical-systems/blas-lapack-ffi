...
*  =======
*
*  CZTRSNA estimates reciprocal condition numbers for specified
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCDRSCL, CZLACN2, CZLACPY, CZLATRS, 
     $  CZTREXC 
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CZLACPY( 'Full', N, N, T, LDT, WORK, LDWORK )
            CALL CZTREXC( 'No Q', N, WORK, LDWORK, DUMMY, 1, K, 1, IERR 
     $  ) 
*
...
*
            ...
            NORMIN = 'N'
   30       CONTINUE
            CALL CZLACN2( N-1, WORK( 1, N+1 ), WORK, EST, KASE, ISAVE )
*
            IF( KASE.NE.0 ) THEN
               IF( KASE.EQ.1 ) THEN
*
*                 Solve C'*x = scale*b
*
                  CALL CZLATRS( 'Upper', 'Conjugate transpose',
...
*                 Solve C*x = scale*b
*
                  CALL CZLATRS( 'Upper', 'No transpose', 'Nonunit',
