...
*  =======
*
*  CCGGGLM solves a general Gauss-Markov linear model (GLM) problem:
*
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CGEMV, CCGGQRF, CCTRTRS, CCUNMQR, 
     $  CCUNMRQ, 
     $                   XERBLA
*     ..
*     .. External Functions ..
...
*
      IF( INFO.EQ.0) THEN
         ...
         ELSE
            ...
            NB2 = ILAENV( 1, 'CCGERQF', ' ', N, M, -1, -1 )
            NB3 = ILAENV( 1, 'CCUNMQR', ' ', N, M, P, -1 )
            NB4 = ILAENV( 1, 'CCUNMRQ', ' ', N, M, P, -1 )
...
*     unitary.
*
      CALL CCGGQRF( N, M, P, A, LDA, WORK, B, LDB, WORK( M+1 ),
...
*                                             ( d2 ) N-M
*
      CALL CCUNMQR( 'Left', 'Conjugate transpose', N, 1, M, A, LDA, 
     $  WORK, 
...
*
      IF( N.GT.M ) THEN
         CALL CCTRTRS( 'Upper', 'No transpose', 'Non unit', N-M, 1,
...
*
      IF( M.GT.0 ) THEN
         CALL CCTRTRS( 'Upper', 'No Transpose', 'Non unit', M, 1, A, 
     $  LDA, 
     $                D, M, INFO )
*
         IF( INFO.GT.0 ) THEN
...
*
      CALL CCUNMRQ( 'Left', 'Conjugate transpose', P, 1, NP,
