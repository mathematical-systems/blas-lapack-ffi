...
*  =======
*
*  CSLATRD reduces NB rows and columns of a real symmetric matrix A to
*  symmetric tridiagonal form by an orthogonal similarity
*  transformation Q' * A * Q, and returns the matrices V and W which are
*  needed to apply the transformation to the unreduced part of A.
*
*  If UPLO = 'U', CSLATRD reduces the last NB rows and columns of a
*  matrix, of which the upper triangle is supplied;
*  if UPLO = 'L', CSLATRD reduces the first NB rows and columns of a
*  matrix, of which the lower triangle is supplied.
*
*  This is an auxiliary routine called by CSSYTRD.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SGEMV, CSLARFG, SSCAL, SSYMV
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               SDOT
...
*              A(1:i-2,i)
*
               CALL CSLARFG( I-1, A( I-1, I ), A( 1, I ), 1, TAU( I-1 ) 
     $  ) 
               E( I-1 ) = A( I-1, I )
               A( I-1, I ) = ONE
*
...
*              A(i+2:n,i)
*
               CALL CSLARFG( N-I, A( I+1, I ), A( MIN( I+2, N ), I ), 
     $  1, 
     $                      TAU( I ) )
               E( I ) = A( I+1, I )
               A( I+1, I ) = ONE
