...
*  =======
*
*  CDSPTRD reduces a real symmetric matrix A stored in packed form to
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, CDLARFG, DSPMV, DSPR2, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
            CALL CDLARFG( I, AP( I1+I-1 ), AP( I1 ), 1, TAUI )
            E( I ) = AP( I1+I-1 )
*
...
*
            CALL CDLARFG( N-I, AP( II+1 ), AP( II+2 ), 1, TAUI )
            E( I ) = AP( II+1 )
*
            IF( TAUI.NE.ZERO ) THEN
*
