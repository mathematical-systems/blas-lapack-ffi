...
*  =======
*
*  CCPBRFS improves the computed solution to a system of linear
...
*          CCPBTRF, in the same storage format as A (see AB).
*
*  LDAFB   (input) INTEGER
...
*          On entry, the solution matrix X, as computed by CCPBTRS.
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CCOPY, CHBMV, CCLACN2, CCPBTRS, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CCPBTRS( UPLO, N, KD, 1, AFB, LDAFB, WORK, N, INFO )
