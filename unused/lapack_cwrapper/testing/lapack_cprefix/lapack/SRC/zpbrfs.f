...
*  =======
*
*  CZPBRFS improves the computed solution to a system of linear
...
*          CZPBTRF, in the same storage format as A (see AB).
*
*  LDAFB   (input) INTEGER
...
*          On entry, the solution matrix X, as computed by CZPBTRS.
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, ZHBMV, CZLACN2, CZPBTRS
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CZPBTRS( UPLO, N, KD, 1, AFB, LDAFB, WORK, N, INFO )
