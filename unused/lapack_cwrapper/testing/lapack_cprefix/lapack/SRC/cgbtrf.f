...
*  =======
*
*  CCGBTRF computes an LU factorization of a complex m-by-n band matrix A
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CCGBTF2, CGEMM, CGERU, CCLASWP, CSCAL,
     $                   CSWAP, CTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*        Use unblocked code
*
         CALL CCGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use CCLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL CCLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
