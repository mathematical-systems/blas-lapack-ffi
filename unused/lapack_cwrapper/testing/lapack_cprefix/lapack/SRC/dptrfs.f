...
*  =======
*
*  CDPTRFS improves the computed solution to a system of linear
...
*          factorization computed by CDPTTRF.
*
*  EF      (input) DOUBLE PRECISION array, dimension (N-1)
*          The (n-1) subdiagonal elements of the unit bidiagonal factor
*          L from the factorization computed by CDPTTRF.
*
...
*          On entry, the solution matrix X, as computed by CDPTTRS.
...
*
            CALL CDPTTRS( N, 1, DF, EF, WORK( N+1 ), N, INFO )
