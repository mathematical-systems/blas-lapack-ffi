...
*  =======
*
*  CDLASD7 merges the two sets of singular values together into a single
...
*
*  CDLASD7 is called from CDLASD6.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDLAMRG, DROT, XERBLA
*     ..
*     .. External Functions ..
