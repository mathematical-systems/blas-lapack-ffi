...
*  =======
*
*  CCPPTRI computes the inverse of a complex Hermitian positive definite
...
*     .. External Subroutines ..
      EXTERNAL           CHPR, CSSCAL, CTPMV, CCTPTRI, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          REAL
*     ..
...
*
      CALL CCTPTRI( UPLO, 'Non-unit', N, AP, INFO )
      IF( INFO.GT.0 )
     $   RETURN
      IF( UPPER ) THEN
*
