...
*  =======
*
*  CCTBCON estimates the reciprocal of the condition number of a
...
*              Multiply by inv(A).
*
               CALL CCLATBS( UPLO, 'No transpose', DIAG, NORMIN, N, KD,
     $                      AB, LDAB, WORK, SCALE, RWORK, INFO )
            ELSE
*
*              Multiply by inv(A').
*
               CALL CCLATBS( UPLO, 'Conjugate transpose', DIAG, NORMIN,
