...
*  =======
*
*  CCZGTSVX uses the LU factorization to compute the solution to a complex
...
*          the LU factorization of A as computed by CZGTTRF.
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, CZGTCON, CZGTRFS, CZGTTRF, 
     $  CZGTTRS, 
     $                   CZLACPY
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         END IF
         CALL CZGTTRF( N, DLF, DF, DUF, DU2, IPIV, INFO )
*
...
*
      CALL CZGTCON( NORM, N, DLF, DF, DUF, DU2, IPIV, ANORM, RCOND, 
     $  WORK, 
     $             INFO )
*
...
*
      ...
      CALL CZGTTRS( TRANS, N, NRHS, DLF, DF, DUF, DU2, IPIV, X, LDX,
     $             INFO )
*
*     Use iterative refinement to improve the computed solutions and
*     compute error bounds and backward error estimates for them.
*
      CALL CZGTRFS( TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2, IPIV,
