...
*  =======
*
*  CCCGBSVX uses the LU factorization to compute the solution to a complex
...
*          A, as computed by CCGBTRF.  U is stored as an upper triangular
...
*          as computed by CCGBTRF; row i of the matrix was interchanged
*          with row IPIV(i).
*
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CCGBCON, CCGBEQU, CCGBRFS, CCGBTRF, 
     $  CCGBTRS, 
     $                   CCLACPY, CCLAQGB, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         CALL CCGBEQU( N, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,
     $                AMAX, INFEQU )
         IF( INFEQU.EQ.0 ) THEN
*
*           Equilibrate the matrix.
*
            CALL CCLAQGB( N, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,
     $                   AMAX, EQUED )
            ROWEQU = LSAME( EQUED, 'R' ) .OR. LSAME( EQUED, 'B' )
            COLEQU = LSAME( EQUED, 'C' ) .OR. LSAME( EQUED, 'B' )
         END IF
...
*
   ...
   70    CONTINUE
*
         CALL CCGBTRF( N, N, KL, KU, AFB, LDAFB, IPIV, INFO )
*
...
*
      CALL CCGBCON( NORM, N, KL, KU, AFB, LDAFB, IPIV, ANORM, RCOND,
     $             WORK, RWORK, INFO )
*
*     Compute the solution matrix X.
*
      CALL CCLACPY( 'Full', N, NRHS, B, LDB, X, LDX )
      CALL CCGBTRS( TRANS, N, KL, KU, NRHS, AFB, LDAFB, IPIV, X, LDX,
     $             INFO )
*
*     Use iterative refinement to improve the computed solution and
*     compute error bounds and backward error estimates for it.
*
      CALL CCGBRFS( TRANS, N, KL, KU, NRHS, AB, LDAB, AFB, LDAFB, IPIV,
