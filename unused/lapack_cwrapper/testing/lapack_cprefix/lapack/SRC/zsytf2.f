...
*  =======
*
*  CZSYTF2 computes the factorization of a complex symmetric matrix A
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZSCAL, ZSWAP, CZSYR
*     ..
*     .. Intrinsic Functions ..
...
*
               R1 = CONE / A( K, K )
               CALL CZSYR( UPLO, K-1, -R1, A( 1, K ), 1, A, LDA )
*
...
*
                  R1 = CONE / A( K, K )
                  CALL CZSYR( UPLO, N-K, -R1, A( K+1, K ), 1,
     $                       A( K+1, K+1 ), LDA )
*
