...
*  =======
*
*  CZTBCON estimates the reciprocal of the condition number of a
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCDRSCL, CZLACN2, CZLATBS
*     ..
*     .. Intrinsic Functions ..
...
*              Multiply by inv(A).
*
               CALL CZLATBS( UPLO, 'No transpose', DIAG, NORMIN, N, KD,
     $                      AB, LDAB, WORK, SCALE, RWORK, INFO )
            ELSE
*
*              Multiply by inv(A').
*
               CALL CZLATBS( UPLO, 'Conjugate transpose', DIAG, NORMIN,
