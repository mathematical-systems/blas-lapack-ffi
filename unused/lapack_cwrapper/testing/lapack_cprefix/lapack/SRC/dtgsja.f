...
*  =======
*
*  CDTGSJA computes the generalized singular value decomposition (GSVD)
*  of two real upper triangular (or trapezoidal) matrices A and B.
*
*  On entry, it is assumed that matrices A and B have the following
*  forms, which may be obtained by the preprocessing subroutine CDGGSVP
...
*          of A and B, whose GSVD is going to be computed by CDTGSJA.
*          See Further details.
*
...
*          the orthogonal matrix returned by CDGGSVP).
*          On exit,
...
*  ===============
*
*  CDTGSJA essentially uses a variant of Kogbetliantz algorithm to reduce
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, CDLAGS2, CDLAPLL, CDLARTG, CDLASET, 
     $  DROT, 
     $                   DSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INITU )
     $   CALL CDLASET( 'Full', M, M, ZERO, ONE, U, LDU )
      IF( INITV )
     $   CALL CDLASET( 'Full', P, P, ZERO, ONE, V, LDV )
      IF( INITQ )
...
*
     ...
     $               A2 = A( K+J, N-L+I )
               ...
               END IF
*
               CALL CDLAGS2( UPPER, A1, A2, A3, B1, B2, B3, CSU, SNU,
     $                      CSV, SNV, CSQ, SNQ )
*
...
*
            ...
            DO 30 I = 1, MIN( L, M-K )
               ...
               CALL CDLAPLL( L-I+1, WORK, 1, WORK( L+1 ), 1, SSMIN )
