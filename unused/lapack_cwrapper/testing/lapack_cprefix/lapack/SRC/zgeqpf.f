...
*  =======
*
*  This routine is deprecated and has been replaced by routine CZGEQP3.
*
*  CZGEQPF computes a QR factorization with column pivoting of a
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, CZGEQR2, CZLARF, CZLARFG, ZSWAP, 
     $  CZUNM2R 
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( ITEMP.GT.0 ) THEN
         MA = MIN( ITEMP, M )
         CALL CZGEQR2( M, MA, A, LDA, TAU, WORK, INFO )
         IF( MA.LT.N ) THEN
            CALL CZUNM2R( 'Left', 'Conjugate transpose', M, N-MA, MA, 
     $  A, 
...
*
            AII = A( I, I )
            CALL CZLARFG( M-I+1, AII, A( MIN( I+1, M ), I ), 1,
     $                   TAU( I ) )
            A( I, I ) = AII
*
            IF( I.LT.N ) THEN
