...
*  =======
*
*  CSLAEIN uses inverse iteration to find a right or left eigenvector
...
*     .. Local Scalars ..
     ...
     $                   REC, ROOTN, SCALE, TEMP, VCRIT, VMAX, VNORM, 
     $  W, 
     $                   W1, X, XI, XR, Y
*     ..
*     .. External Functions ..
...
*     .. External Subroutines ..
      EXTERNAL           CSLADIV, CSLATRS, SSCAL
*     ..
*     .. Intrinsic Functions ..
...
*           overwriting x on v.
*
            CALL CSLATRS( 'Upper', TRANS, 'Nonunit', NORMIN, N, B, LDB,
     $                   VR, SCALE, WORK, IERR )
            NORMIN = 'Y'
*
...
*
                  CALL CSLADIV( XR, XI, B( I, I ), B( I+1, I ), VR( I 
     $  ), 
     $                         VI( I ) )
