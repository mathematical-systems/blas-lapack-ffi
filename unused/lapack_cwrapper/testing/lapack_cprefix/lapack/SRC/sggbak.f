...
*  =======
*
*  CSGGBAK forms the right or left eigenvectors of a real generalized
...
*                  scaling.
*          JOB must be the same as the argument JOB supplied to CSGGBAL.
*
...
*  ILO     (input) INTEGER
*  IHI     (input) INTEGER
*          The integers ILO and IHI determined by CSGGBAL.
*          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.
*
*  LSCALE  (input) REAL array, dimension (N)
*          Details of the permutations and/or scaling factors applied
*          to the left side of A and B, as returned by CSGGBAL.
*
*  RSCALE  (input) REAL array, dimension (N)
*          Details of the permutations and/or scaling factors applied
*          to the right side of A and B, as returned by CSGGBAL.
*
*  M       (input) INTEGER
...
*          transformed, as returned by CSTGEVC.
