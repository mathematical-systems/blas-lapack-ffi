      SUBROUTINE SLAED9( K, KSTART, KSTOP, N, D, Q, LDQ, RHO, DLAMDA, 
     $  W, 
     $                   S, LDS, INFO )
*
...
*  =======
*
*  CSLAED9 finds the roots of the secular equation, as defined by the
*  values in D, Z, and RHO, between KSTART and KSTOP.  It makes the
*  appropriate calls to CSLAED4 and then stores the new matrix of
