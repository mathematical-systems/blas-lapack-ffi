...
*  =======
*
*  CCHPGST reduces a complex Hermitian-definite generalized
...
*
*  B must have been previously factorized as U**H*U or L*L**H by CCPPTRF.
*
*  Arguments
*  =========
*
...
*          stored in the same format as A, as returned by CCPPTRF.
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
