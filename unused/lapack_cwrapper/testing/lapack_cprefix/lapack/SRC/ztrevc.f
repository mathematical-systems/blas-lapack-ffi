...
*  =======
*
*  CZTREVC computes some or all of the right and/or left eigenvectors of
*  a complex upper triangular matrix T.
*  Matrices of this type are produced by the Schur factorization of
*  a complex general matrix:  A = Q*T*Q**H, as computed by CZHSEQR.
*  
...
*          Schur vectors returned by CZHSEQR).
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, ZDSCAL, ZGEMV, CZLATRS
*     ..
*     .. Intrinsic Functions ..
...
*
            IF( KI.GT.1 ) THEN
               CALL CZLATRS( 'Upper', 'No transpose', 'Non-unit', 'Y',
