...
*  =======
*
*  CZGGSVD computes the generalized singular value decomposition (GSVD)
...
*                converge.  For further details, see subroutine CZTGSJA.
*
*  Internal Parameters
*  ===================
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, XERBLA, CZGGSVP, CZTGSJA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      CALL CZGGSVP( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB, TOLA,
     $             TOLB, K, L, U, LDU, V, LDV, Q, LDQ, IWORK, RWORK,
     $             WORK, WORK( N+1 ), INFO )
*
*     Compute the GSVD of two upper "triangular" matrices
*
      CALL CZTGSJA( JOBU, JOBV, JOBQ, M, P, N, K, L, A, LDA, B, LDB,
