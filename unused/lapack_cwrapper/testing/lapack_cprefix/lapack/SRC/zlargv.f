...
*  =======
*
*  CZLARGV generates a vector of complex plane rotations with real
...
*
*  The following conventions are used (these are the same as in CZLARTG,
*  but differ from the BLAS1 routine CZROTG):
...
*     END IF
      ...
      DO 60 I = 1, N
         ...
         G = Y( IY )
*
*        Use identical algorithm as in CZLARTG
*
