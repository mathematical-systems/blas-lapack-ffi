...
void fcgghrd_(char* compq, char* compz, int* n, int* ilo, int* ihi, void* a, int* lda, void* b, int* ldb, void* q, int* ldq, void* z, int* ldz, int* info)
{
	...
	lapack_cgghrd(compqC, compzC, *n, *ilo, *ihi, a, *lda, b, *ldb, q, *ldq, z, *ldz, info);
}
