...
void fzlatps_(char* uplo, char* trans, char* diag, char* normin, int* n, void* ap, void* x, double* scale, double* cnorm, int* info)
{
	...
	lapack_zlatps(uploC, transC, diagC, norminC, *n, ap, x, scale, cnorm, info);
}
