...
void fclatps_(char* uplo, char* trans, char* diag, char* normin, int* n, void* ap, void* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_clatps(uploC, transC, diagC, norminC, *n, ap, x, scale, cnorm, info);
}
