...
void fchgeqz_(char* job, char* compq, char* compz, int* n, int* ilo, int* ihi, void* h, int* ldh, void* t, int* ldt, void* alpha, void* beta, void* q, int* ldq, void* z, int* ldz, void* work, int* lwork, float* rwork, int* info)
{
	...
	lapack_chgeqz(jobC, compqC, compzC, *n, *ilo, *ihi, h, *ldh, t, *ldt, alpha, beta, q, *ldq, z, *ldz, work, *lwork, rwork, info);
}
