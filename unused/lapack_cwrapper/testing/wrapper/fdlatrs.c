...
void fdlatrs_(char* uplo, char* trans, char* diag, char* normin, int* n, double* a, int* lda, double* x, double* scale, double* cnorm, int* info)
{
	...
	lapack_dlatrs(uploC, transC, diagC, norminC, *n, a, *lda, x, scale, cnorm, info);
}
