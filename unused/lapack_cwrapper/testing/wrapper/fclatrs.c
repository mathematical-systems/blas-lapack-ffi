...
void fclatrs_(char* uplo, char* trans, char* diag, char* normin, int* n, void* a, int* lda, void* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_clatrs(uploC, transC, diagC, norminC, *n, a, *lda, x, scale, cnorm, info);
}
