...
void fctrsyl_(char* trana, char* tranb, int* isgn, int* m, int* n, void* a, int* lda, void* b, int* ldb, void* c, int* ldc, float* scale, int* info)
{
	...
	lapack_ctrsyl(tranaC, tranbC, *isgn, *m, *n, a, *lda, b, *ldb, c, *ldc, scale, info);
}
