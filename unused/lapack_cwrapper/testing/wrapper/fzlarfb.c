...
void fzlarfb_(char* side, char* trans, char* direct, char* storev, int* m, int* n, int* k, void* v, int* ldv, void* t, int* ldt, void* c, int* ldc, void* work, int* ldwork)
{
	...
	lapack_zlarfb(sideC, transC, directC, storevC, *m, *n, *k, v, *ldv, t, *ldt, c, *ldc, work, *ldwork);
}
