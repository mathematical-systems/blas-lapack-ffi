...
void fdlarzb_(char* side, char* trans, char* direct, char* storev, int* m, int* n, int* k, int* l, double* v, int* ldv, double* t, int* ldt, double* c, int* ldc, double* work, int* ldwork)
{
	...
	lapack_dlarzb(sideC, transC, directC, storevC, *m, *n, *k, *l, v, *ldv, t, *ldt, c, *ldc, work, *ldwork);
}
