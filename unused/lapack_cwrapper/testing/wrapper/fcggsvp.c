...
void fcggsvp_(char* jobu, char* jobv, char* jobq, int* m, int* p, int* n, void* a, int* lda, void* b, int* ldb, float* tola, float* tolb, int* k, int* l, void* u, int* ldu, void* v, int* ldv, void* q, int* ldq, int* iwork, float* rwork, void* tau, void* work, int* info)
{
	...
	lapack_cggsvp(jobuC, jobvC, jobqC, *m, *p, *n, a, *lda, b, *ldb, *tola, *tolb, k, l, u, *ldu, v, *ldv, q, *ldq, iwork, rwork, tau, work, info);
}
