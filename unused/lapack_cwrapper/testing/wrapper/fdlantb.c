...
void fdlantb_(double* output, char* norm, char* uplo, char* diag, int* n, int* k, double* ab, int* ldab, double* work)
{
	...
	*output = lapack_dlantb( normC, uploC, diagC, *n, *k, ab, *ldab, work);
}
