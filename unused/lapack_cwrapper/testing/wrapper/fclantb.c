...
void fclantb_(float* output, char* norm, char* uplo, char* diag, int* n, int* k, void* ab, int* ldab, float* work)
{
	...
	*output = lapack_clantb( normC, uploC, diagC, *n, *k, ab, *ldab, work);
}
