...
*  =======
*
*  DGET39 tests cdlaqtr, a routine for solving the real or
...
*  estimation in the eigenproblem routine cdtrsna.
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DGEMV, cdlabad, cdlaqtr
*     ..
*     .. Intrinsic Functions ..
...
*
                        ...
                        KNT = KNT + 1
                        CALL cdlaqtr( .FALSE., .TRUE., N, T, LDT, DUM,
...
*
                        CALL DCOPY( N, D, 1, X, 1 )
                        KNT = KNT + 1
                        CALL cdlaqtr( .TRUE., .TRUE., N, T, LDT, DUM,
     $                               DUMM, SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
...
*
                        ...
                        KNT = KNT + 1
                        CALL cdlaqtr( .FALSE., .FALSE., N, T, LDT, B, W,
     $                               SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
...
*
                        CALL DCOPY( 2*N, D, 1, X, 1 )
                        KNT = KNT + 1
                        CALL cdlaqtr( .TRUE., .FALSE., N, T, LDT, B, W,
     $                               SCALE, X, WORK, INFO )
                        IF( INFO.NE.0 )
     $                     NINFO = NINFO + 1
*
