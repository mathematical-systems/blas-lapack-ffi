...
*          as computed by czgehrd.  H is assumed to be zero below the
*          first subdiagonal.
*
*  LDH     (input) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           cdlabad, ZGEMM, czlacpy, ZUNT01
*     ..
*     .. Intrinsic Functions ..
...
*
      LDWORK = MAX( 1, N )
      CALL czlacpy( ' ', N, N, A, LDA, WORK, LDWORK )
*
*     Compute Q*H
*
