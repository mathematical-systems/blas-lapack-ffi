...
*      Test czgehrd, czunghr, czhseqr, cztrevc, czhsein, and czunmhr
*
*  SEP (Hermitian Eigenvalue Problem):
*      Test czhetrd, czungtr, czsteqr, ZSTERF, czstein, czstedc,
*      and drivers czheev(X), czhbev(X), czhpev(X),
*                  czheevD,   czhbevD,   czhpevD
*
*  SVD (Singular Value Decomposition):
*      Test czgebrd, czungbr, and czbdsqr
*      and the drivers czgesvD, czgesdd
*
...
*      Test czgghrd, czggbal, czggbak, czhgeqz, and cztgevc
*      and the driver routines czgegs and czgegv
*
...
*      Test czhegst, czhegv, czhegvD, czhegvX, czhpgst, czhpgv, czhpgvD,
*      czhpgvX, czhbgst, czhbgv, czhbgvD, and czhbgvX
*
...
*      Test cztrsyl, cztrexc, cztrsna, and cztrsen
*
...
*      Tests czggqrf and czggrqf
*
*  GSV (Generalized Singular Value Decomposition):
*      Tests czggsvd, czggsvp, cztgsja, czlags2, czlapll, and czlapmt
*
...
*           The 3-character path name is 'ZEV' to test ccgeev, or
*           'ZES' to test ccgees.
*
*-----------------------------------------------------------------------
*
...
*
*  line 1:  'ZBL' in columns 1-3 to test ccgebal, or 'ZBK' in
...
*
*  line 1:  'ZGL' in columns 1-3 to test czggbal, or 'ZGK' in
*           columns 1-3 to test czggbak.
*
*  The remaining lines consist of specially constructed test cases.
*
*-----------------------------------------------------------------------
...
*              czgeev (eigenvalues and eigenvectors)
*        --------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   IWORK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'czgeev', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*
     ...
     $                   INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'czgees', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              czgeevX (eigenvalues, eigenvectors and condition numbers)
*        --------------------------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   RWORK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'czgeevX', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              czgeesX (Schur form and condition numbers)
*        ---------------------------------------------------
*
         MAXTYP = 21
         NTYPES = MIN( MAXTYP, NTYPES )
     ...
     $                   LOGWRK, INFO )
            IF( INFO.NE.0 )
     $         WRITE( NOUT, FMT = 9980 )'czgeesX', INFO
         END IF
         WRITE( NOUT, FMT = 9973 )
         GO TO 10
*
...
*              czggesX (Schur form and condition numbers)
*        -------------------------------------------------
*
         MAXTYP = 5
         NTYPES = MAXTYP
...
*              czggevX (eigenvalue/vector with condition numbers)
*        -------------------------------------------------
*
         MAXTYP = 2
         NTYPES = MAXTYP
...
*
 ...
 9979 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Driver',
     $      / '    czgeev (eigenvalues and eigevectors)' )
 ...
 9977 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Expert',
     $      ' Driver', / '    czgeevX (eigenvalues, eigenvectors and',
     $      ' condition numbers)' )
 9976 FORMAT( / ' Tests of the Nonsymmetric Eigenvalue Problem Expert',
     $      ' Driver', / '    czgeesX (Schur form and condition',
     $      ' numbers)' )
 9975 FORMAT( / ' Tests of the Generalized Nonsymmetric Eigenvalue ',
     $      'Problem routines' )
 9974 FORMAT( ' Tests of czhbtrd', / ' (reduction of a Hermitian band ',
