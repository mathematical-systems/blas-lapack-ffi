...
*     .. External Subroutines ..
      EXTERNAL      CHKXER, czgebak, czgebal, czgehrd, czhsein, czhseqr,
...
*
     ...
     $                M, W, RW, IFAILL, IFAILR, INFO )
         CALL CHKXER( 'czhsein', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL czhsein( 'R', 'N', 'N', SEL, -1, A, 1, X, VL, 1, VR, 1, 0,
     $                M, W, RW, IFAILL, IFAILR, INFO )
         CALL CHKXER( 'czhsein', INFOT, NOUT, LERR, OK )
         INFOT = 7
...
*
         SRNAMT = 'cztrevc'
         INFOT = 1
         CALL cztrevc('/', 'A', SEL, 0, A, 1, VL, 1, VR, 1, 0, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL cztrevc('L', '/', SEL, 0, A, 1, VL, 1, VR, 1, 0, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 4
     ...
     $                RW, INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL cztrevc('L', 'A', SEL, 2, A, 1, VL, 2, VR, 1, 4, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL cztrevc('L', 'A', SEL, 2, A, 2, VL, 1, VR, 1, 4, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL cztrevc('R', 'A', SEL, 2, A, 2, VL, 1, VR, 1, 4, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         INFOT = 11
         CALL cztrevc('L', 'A', SEL, 2, A, 2, VL, 2, VR, 1, 1, M, W, RW,
     $                INFO )
         CALL CHKXER( 'cztrevc', INFOT, NOUT, LERR, OK )
         NT = NT + 7
      END IF
