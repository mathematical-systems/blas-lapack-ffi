...
*  =======
*
*  DGSVTS tests cdggsvd, which computes the GSVD of an M-by-N matrix A
...
*          Details of the GSVD of A and B, as returned by cdggsvd,
*          see cdggsvd for further details.
*
*  LDA     (input) INTEGER
...
*          ALPHA and BETA, see subroutine cdggsvd for details.
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DGEMM, cdggsvd, cdlacpy, cdlaset, DSYRK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL cdggsvd( 'U', 'V', 'Q', M, N, P, K, L, AF, LDA, BF, LDB,
...
*     Compute I - U'*U
*
      CALL cdlaset( 'Full', M, M, ZERO, ONE, WORK, LDQ )
...
*     Compute I - V'*V
*
      CALL cdlaset( 'Full', P, P, ZERO, ONE, WORK, LDV )
...
*     Compute I - Q'*Q
*
      CALL cdlaset( 'Full', N, N, ZERO, ONE, WORK, LDQ )
