...
*  =======
*
*  CGSVTS tests ccggsvd, which computes the GSVD of an M-by-N matrix A
...
*          Details of the GSVD of A and B, as returned by ccggsvd,
*          see ccggsvd for further details.
*
*  LDA     (input) INTEGER
...
*          ALPHA and BETA, see subroutine ccggsvd for details.
*
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, ccggsvd, CHERK, cclacpy, cclaset, SCOPY
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL ccggsvd( 'U', 'V', 'Q', M, N, P, K, L, AF, LDA, BF, LDB,
...
*     Compute I - U'*U
*
      CALL cclaset( 'Full', M, M, CZERO, CONE, WORK, LDQ )
...
*     Compute I - V'*V
*
      CALL cclaset( 'Full', P, P, CZERO, CONE, WORK, LDV )
...
*     Compute I - Q'*Q
*
      CALL cclaset( 'Full', N, N, CZERO, CONE, WORK, LDQ )
