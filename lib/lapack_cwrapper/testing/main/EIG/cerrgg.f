...
*     .. External Subroutines ..
      EXTERNAL       ccgges, ccggesX, ccggev, ccggevX, ccggglm, ccgghrd,
     $             ccgglse, ccggqrf, ccggrqf, ccggsvd, ccggsvp, cchgeqz,
     $              CHKXER, cctgevc, cctgexc, cctgsen, cctgsja, cctgsna,
     $                   cctgsyl
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
     ...
     $                Q, 1, Z, 1, W, 1, RW, INFO )
         CALL CHKXER( 'cchgeqz', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL cchgeqz( 'E', 'N', 'N', -1, 0, 0, A, 1, B, 1, ALPHA, BETA,
     $                Q, 1, Z, 1, W, 1, RW, INFO )
         CALL CHKXER( 'cchgeqz', INFOT, NOUT, LERR, OK )
         INFOT = 5
...
*
         SRNAMT = 'cctgevc'
         INFOT = 1
         CALL cctgevc('/', 'A', SEL, 0, A, 1, B, 1, Q, 1, Z, 1, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL cctgevc('R', '/', SEL, 0, A, 1, B, 1, Q, 1, Z, 1, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 4
     ...
     $                W, RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL cctgevc('R', 'A', SEL, 2, A, 1, B, 2, Q, 1, Z, 2, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL cctgevc('R', 'A', SEL, 2, A, 2, B, 1, Q, 1, Z, 2, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL cctgevc('L', 'A', SEL, 2, A, 2, B, 2, Q, 1, Z, 1, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 12
         CALL cctgevc('R', 'A', SEL, 2, A, 2, B, 2, Q, 1, Z, 1, 0, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         INFOT = 13
         CALL cctgevc('R', 'A', SEL, 2, A, 2, B, 2, Q, 1, Z, 2, 1, M, W,
     $                RW, INFO )
         CALL CHKXER( 'cctgevc', INFOT, NOUT, LERR, OK )
         NT = NT + 8
*
...
*
     ...
     $                1, R1, R2, U, 1, V, 1, Q, 1, W, RW, IW, INFO )
         CALL CHKXER( 'ccggsvd', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL ccggsvd( 'N', 'N', 'N', -1, 0, 0, DUMMYK, DUMMYL, A, 1, B,
     $                1, R1, R2, U, 1, V, 1, Q, 1, W, RW, IW, INFO )
         CALL CHKXER( 'ccggsvd', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL ccggsvd( 'N', 'N', 'N', 0, -1, 0, DUMMYK, DUMMYL, A, 1, B,
     $                1, R1, R2, U, 1, V, 1, Q, 1, W, RW, IW, INFO )
         CALL CHKXER( 'ccggsvd', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL ccggsvd( 'N', 'N', 'N', 0, 0, -1, DUMMYK, DUMMYL, A, 1, B,
     $                1, R1, R2, U, 1, V, 1, Q, 1, W, RW, IW, INFO )
         CALL CHKXER( 'ccggsvd', INFOT, NOUT, LERR, OK )
         INFOT = 10
...
*
     ...
     $                NCYCLE, INFO )
         CALL CHKXER( 'cctgsja', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL cctgsja( 'N', 'N', 'N', -1, 0, 0, DUMMYK, DUMMYL, A, 1, B,
     $                1, TOLA, TOLB, R1, R2, U, 1, V, 1, Q, 1, W,
     $                NCYCLE, INFO )
         CALL CHKXER( 'cctgsja', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL cctgsja( 'N', 'N', 'N', 0, -1, 0, DUMMYK, DUMMYL, A, 1, B,
     $                1, TOLA, TOLB, R1, R2, U, 1, V, 1, Q, 1, W,
     $                NCYCLE, INFO )
         CALL CHKXER( 'cctgsja', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL cctgsja( 'N', 'N', 'N', 0, 0, -1, DUMMYK, DUMMYL, A, 1, B,
     $                1, TOLA, TOLB, R1, R2, U, 1, V, 1, Q, 1, W,
     $                NCYCLE, INFO )
         CALL CHKXER( 'cctgsja', INFOT, NOUT, LERR, OK )
         INFOT = 10
...
*
         SRNAMT = 'ccgges '
         INFOT = 1
         CALL ccgges( '/', 'N', 'S', CLCTES, 1, A, 1, B, 1, SDIM, ALPHA,
     ...
     $               BETA, Q, 1, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 3
         CALL ccgges( 'N', 'V', '/', CLCTES, 1, A, 1, B, 1, SDIM, ALPHA,
     $               BETA, Q, 1, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL ccgges('N', 'V', 'S', CLCTES, -1, A, 1, B, 1, SDIM, ALPHA,
     $               BETA, Q, 1, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 7
         CALL ccgges( 'N', 'V', 'S', CLCTES, 1, A, 0, B, 1, SDIM, ALPHA,
     $               BETA, Q, 1, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 9
         CALL ccgges( 'N', 'V', 'S', CLCTES, 1, A, 1, B, 0, SDIM, ALPHA,
     $               BETA, Q, 1, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 14
         CALL ccgges( 'N', 'V', 'S', CLCTES, 1, A, 1, B, 1, SDIM, ALPHA,
     $               BETA, Q, 0, U, 1, W, 1, RW, BW, INFO )
         CALL CHKXER( 'ccgges ', INFOT, NOUT, LERR, OK )
         INFOT = 14
         CALL ccgges( 'V', 'V', 'S', CLCTES, 2, A, 2, B, 2, SDIM, ALPHA,
...
*
         ...
         P1=1
         P2=2
         CALL ccggevX('/', 'N', 'N', 'N', 1, A, 1, B, 1, ALPHA, BETA, Q,
     ...
     $                1, RW, IW, BW, INFO )
         CALL CHKXER( 'ccggevX', INFOT, NOUT, LERR, OK )
         INFOT = 7
         CALL ccggevX('N', 'N', 'N', 'N', 1, A, 0, B, 1, ALPHA, BETA, Q,
     $              1, U, 1, P1, P2, LS, RS, ANRM, BNRM, RCE, RCV, W, 1,
     $                RW, IW, BW, INFO )
         CALL CHKXER( 'ccggevX', INFOT, NOUT, LERR, OK )
         INFOT = 9
         CALL ccggevX('N', 'N', 'N', 'N', 1, A, 1, B, 0, ALPHA, BETA, Q,
     $           1, U, 1, P1, P2, LS, RS, ANRM, BNRM, RCE, RCV, W, 1,
     $                RW, IW, BW, INFO )
         CALL CHKXER( 'ccggevX', INFOT, NOUT, LERR, OK )
         INFOT = 13
         CALL ccggevX('N', 'N', 'N', 'N', 1, A, 1, B, 1, ALPHA, BETA, Q,
     $            0, U, 1, P1, P2, LS, RS, ANRM, BNRM, RCE, RCV, W, 1,
     $                RW, IW, BW, INFO )
         CALL CHKXER( 'ccggevX', INFOT, NOUT, LERR, OK )
         INFOT = 13
         P2 = 2
         CALL ccggevX('N', 'V', 'N', 'N', 2, A, 2, B, 2, ALPHA, BETA, Q,
     ...
     $                RW, IW, BW, INFO )
         ...
         INFOT = 15
         P2 = 2
         CALL ccggevX('N', 'N', 'V', 'N', 2, A, 2, B, 2, ALPHA, BETA, Q,
...
*
         SRNAMT = 'cctgexc'
         INFOT = 3
         CALL cctgexc( .TRUE., .TRUE., -1, A, 1, B, 1, Q, 1, Z, 1, IFST,
     $                ILST, INFO )
     ...
     $                ILST, INFO )
         CALL CHKXER( 'cctgexc', INFOT, NOUT, LERR, OK )
         INFOT = 9
         CALL cctgexc( .FALSE., .TRUE., 1, A, 1, B, 1, Q, 0, Z, 1, IFST,
     $                ILST, INFO )
         CALL CHKXER( 'cctgexc', INFOT, NOUT, LERR, OK )
         INFOT = 9
     ...
     $                ILST, INFO )
         CALL CHKXER( 'cctgexc', INFOT, NOUT, LERR, OK )
         INFOT = 11
         CALL cctgexc( .TRUE., .FALSE., 1, A, 1, B, 1, Q, 1, Z, 0, IFST,
     $                ILST, INFO )
         CALL CHKXER( 'cctgexc', INFOT, NOUT, LERR, OK )
         INFOT = 11
...
*
         SRNAMT = 'cctgsna'
         INFOT = 1
         CALL cctgsna( '/', 'A', SEL, 1, A, 1, B, 1, Q, 1, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL cctgsna( 'B', '/', SEL, 1, A, 1, B, 1, Q, 1, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL cctgsna('B', 'A', SEL, -1, A, 1, B, 1, Q, 1, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL cctgsna( 'B', 'A', SEL, 1, A, 0, B, 1, Q, 1, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL cctgsna( 'B', 'A', SEL, 1, A, 1, B, 0, Q, 1, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL cctgsna( 'E', 'A', SEL, 1, A, 1, B, 1, Q, 0, U, 1, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 12
         CALL cctgsna( 'E', 'A', SEL, 1, A, 1, B, 1, Q, 1, U, 0, R1, R2,
     $                1, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 15
         CALL cctgsna( 'E', 'A', SEL, 1, A, 1, B, 1, Q, 1, U, 1, R1, R2,
     $                0, M, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsna', INFOT, NOUT, LERR, OK )
         INFOT = 18
         CALL cctgsna( 'E', 'A', SEL, 1, A, 1, B, 1, Q, 1, U, 1, R1, R2,
...
*
         SRNAMT = 'cctgsyl'
         INFOT = 1
         CALL cctgsyl( '/', 0, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL cctgsyl('N', -1, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 3
         CALL cctgsyl( 'N', 0, 0, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 4
         CALL cctgsyl( 'N', 0, 1, 0, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 6
         CALL cctgsyl( 'N', 0, 1, 1, A, 0, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 8
         CALL cctgsyl( 'N', 0, 1, 1, A, 1, B, 0, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 10
         CALL cctgsyl( 'N', 0, 1, 1, A, 1, B, 1, Q, 0, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 12
         CALL cctgsyl( 'N', 0, 1, 1, A, 1, B, 1, Q, 1, U, 0, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 14
         CALL cctgsyl( 'N', 0, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 0, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 16
         CALL cctgsyl( 'N', 0, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 0,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 20
         CALL cctgsyl( 'N', 1, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         INFOT = 20
         CALL cctgsyl( 'N', 2, 1, 1, A, 1, B, 1, Q, 1, U, 1, V, 1, Z, 1,
     $                SCALE, DIF, W, 1, IW, INFO )
         CALL CHKXER( 'cctgsyl', INFOT, NOUT, LERR, OK )
         NT = NT + 12
      END IF
