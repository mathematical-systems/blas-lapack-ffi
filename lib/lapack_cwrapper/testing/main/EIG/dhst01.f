...
*          as computed by cdgehrd.  H is assumed to be zero below the
*          first subdiagonal.
*
*  LDH     (input) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM, cdlabad, cdlacpy, DORT01
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      LDWORK = MAX( 1, N )
      CALL cdlacpy( ' ', N, N, A, LDA, WORK, LDWORK )
*
*     Compute Q*H
*
