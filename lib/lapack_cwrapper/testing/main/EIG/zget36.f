...
*  =======
*
*  ZGET36 tests cztrexc, a routine for reordering diagonal entries of a
...
*     .. External Subroutines ..
      EXTERNAL           ZCOPY, ZHST01, czlacpy, czlaset, cztrexc
*     ..
...
*
   ...
   20 CONTINUE
      CALL czlacpy( 'F', N, N, TMP, LDT, T1, LDT )
      CALL czlacpy( 'F', N, N, TMP, LDT, T2, LDT )
      RES = ZERO
*
*     Test without accumulating Q
*
      CALL czlaset( 'Full', N, N, CZERO, CONE, Q, LDT )
      CALL cztrexc( 'N', N, T1, LDT, Q, LDT, IFST, ILST, INFO1 )
      DO 40 I = 1, N
         DO 30 J = 1, N
...
*
      CALL czlaset( 'Full', N, N, CZERO, CONE, Q, LDT )
      CALL cztrexc( 'V', N, T2, LDT, Q, LDT, IFST, ILST, INFO2 )
*
*     Compare T1 with T2
*
      DO 60 I = 1, N
