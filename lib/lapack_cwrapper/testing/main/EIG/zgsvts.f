...
*  =======
*
*  ZGSVTS tests czggsvd, which computes the GSVD of an M-by-N matrix A
...
*          Details of the GSVD of A and B, as returned by czggsvd,
*          see czggsvd for further details.
*
*  LDA     (input) INTEGER
...
*          ALPHA and BETA, see subroutine czggsvd for details.
*
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, ZGEMM, czggsvd, ZHERK, czlacpy, czlaset
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL czggsvd( 'U', 'V', 'Q', M, N, P, K, L, AF, LDA, BF, LDB,
...
*     Compute I - U'*U
*
      CALL czlaset( 'Full', M, M, CZERO, CONE, WORK, LDQ )
...
*     Compute I - V'*V
*
      CALL czlaset( 'Full', P, P, CZERO, CONE, WORK, LDV )
...
*     Compute I - Q'*Q
*
      CALL czlaset( 'Full', N, N, CZERO, CONE, WORK, LDQ )
