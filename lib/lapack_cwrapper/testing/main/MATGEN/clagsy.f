...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CGEMV, CGERC, cclacgv, cclarnv, CSCAL,
     $                   ccsymv, cxerbla
*     ..
*     .. External Functions ..
      REAL               SCNRM2
...
*
         CALL cclarnv( 3, ISEED, N-I+1, WORK )
...
*
         CALL cclacgv( N-I+1, WORK, 1 )
         CALL ccsymv( 'Lower',N-I+1, TAU, A( I, I ), LDA, WORK, 1, ZERO,
     $               WORK( N+1 ), 1 )
         CALL cclacgv( N-I+1, WORK, 1 )
*
...
*
*        CALL ccsyr2( 'Lower', N-I+1, -ONE, WORK, 1, WORK( N+1 ), 1,
*        $               A( I, I ), LDA )
*
         DO 50 JJ = I, N
            DO 40 II = JJ, N
...
*        compute  y := tau * A * conjg(u)
*
         CALL cclacgv( N-K-I+1, A( K+I, I ), 1 )
         CALL ccsymv( 'Lower', N-K-I+1, TAU, A( K+I, K+I ), LDA,
...
*
*        CALL ccsyr2( 'Lower', N-K-I+1, -ONE, A( K+I, I ), 1, WORK, 1,
*        $               A( K+I, K+I ), LDA )
*
         DO 80 JJ = K + I, N
            DO 70 II = JJ, N
