...
*     .. External Subroutines ..
      EXTERNAL           cxerbla, ZAXPY, ZGEMV, ZGERC, czlacgv, czlarnv,
     $                   ZSCAL, czsymv
*     ..
*     .. External Functions ..
...
*
         CALL czlacgv( N-I+1, WORK, 1 )
        CALL czsymv( 'Lower', N-I+1, TAU, A( I, I ), LDA, WORK, 1, ZERO,
     $               WORK( N+1 ), 1 )
         CALL czlacgv( N-I+1, WORK, 1 )
*
...
*
*        CALL czsyr2( 'Lower', N-I+1, -ONE, WORK, 1, WORK( N+1 ), 1,
*        $               A( I, I ), LDA )
*
         DO 50 JJ = I, N
            DO 40 II = JJ, N
...
*        compute  y := tau * A * conjg(u)
*
         CALL czlacgv( N-K-I+1, A( K+I, I ), 1 )
         CALL czsymv( 'Lower', N-K-I+1, TAU, A( K+I, K+I ), LDA,
...
*
*        CALL czsyr2( 'Lower', N-K-I+1, -ONE, A( K+I, I ), 1, WORK, 1,
*        $               A( K+I, K+I ), LDA )
*
         DO 80 JJ = K + I, N
            DO 70 II = JJ, N
