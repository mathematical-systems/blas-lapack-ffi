...
*     .. External Subroutines ..
      EXTERNAL           xerbla, czlaset, czunmrz
*     ..
*     .. Intrinsic Functions ..
...
*     Q := I
*
      CALL czlaset( 'Full', N, N, DCMPLX( ZERO ), DCMPLX( ONE ), WORK,
     $             N )
*
*     Q := P(1) * ... * P(m) * Q
*
      CALL czunmrz( 'Left', 'No transpose', N, N, M, N-M, AF, LDA, TAU,
     $             WORK, N, WORK( N*N+1 ), LWORK-N*N, INFO )
*
*     Q := P(m)' * ... * P(1)' * Q
*
      CALL czunmrz('Left', 'Conjugate transpose', N, N, M, N-M, AF, LDA,
