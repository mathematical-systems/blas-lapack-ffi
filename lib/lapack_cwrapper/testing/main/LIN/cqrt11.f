...
*     .. External Subroutines ..
      EXTERNAL           cclaset, ccunm2r, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $   RETURN
*
      CALL cclaset( 'Full', M, M, CMPLX( ZERO ), CMPLX( ONE ), WORK, M )
*
*     Form Q
*
      CALL ccunm2r( 'Left', 'No transpose', M, M, K, A, LDA, TAU, WORK,
     $             M, WORK( M*M+1 ), INFO )
*
*     Form Q'*Q
*
      CALL ccunm2r( 'Left', 'Conjugate transpose', M, M, K, A, LDA, TAU,
