...
*  =======
*
*  DQLT02 tests cdorgql, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL DGEMM,cdlacpy,cdlaset,cdorgql,DSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*
      ...
      IF (K.LT.M) CALL cdlacpy('Full',M-K,K,AF(1,N-K+1),LDA,Q(1,N-K+1),
     +                         LDA)
...
*
      SRNAMT = 'cdorgql'
      CALL cdorgql(M,N,K,Q,LDA,TAU(N-K+1),WORK,LWORK,INFO)
*
*     Copy L(m-n+1:m,n-k+1:n)
*
      CALL cdlaset('Full',N,K,ZERO,ZERO,L(M-N+1,N-K+1),LDA)
      CALL cdlacpy('Lower',K,K,AF(M-K+1,N-K+1),LDA,L(M-K+1,N-K+1),LDA)
*
