...
*  =======
*
*  CCHKHE tests cchetrf, -TRI, -TRS, -RFS, and -CON.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, CERRHE, CGET04, cchecon,
     $              ccherfs, CHET01, cchetrf, cchetri, cchetrs, cclacpy,
...
*
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'cchetrf'
                  CALL cchetrf( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK,
     $                         INFO )
*
...
*
  ...
  100                CONTINUE
                  ...
                  END IF
*
*                 Check error code from cchetrf.
*
                  IF( INFO.NE.K )
     $               CALL ALAERH( PATH, 'cchetrf', INFO, K, UPLO, N, N,
...
*
     ...
     $                            INFO )
*
*                 Check error code from cchetri.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'cchetri', INFO, -1, UPLO, N,
...
*
                     SRNAMT = 'cchetrs'
                     CALL cchetrs( UPLO, N, NRHS, AFAC, LDA, IWORK, X,
     $                            LDA, INFO )
*
*                 Check error code from cchetrs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'cchetrs', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'ccherfs'
                     CALL ccherfs( UPLO, N, NRHS, A, LDA, AFAC, LDA,
     $                            IWORK, B, LDA, X, LDA, RWORK,
     $                            RWORK( NRHS+1 ), WORK,
     $                            RWORK( 2*NRHS+1 ), INFO )
*
*                 Check error code from ccherfs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'ccherfs', INFO, 0, UPLO, N,
     $                               N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140             CONTINUE
                  ...
                  SRNAMT = 'cchecon'
                  CALL cchecon( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND,
     $                         WORK, INFO )
*
*                 Check error code from cchecon.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'cchecon', INFO, 0, UPLO, N, N,
