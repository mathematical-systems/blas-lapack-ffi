...
*     .. External Subroutines ..
      EXTERNAL           cslabad, cslarnv, cslascl
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          SIGN
*     ..
...
*           matrix scaled up
*
            CALL cslascl( 'General', 0, 0, NORMA, BIGNUM, M, N, A, LDA,
     $                   INFO )
         ELSE IF( SCALE.EQ.3 ) THEN
*
*           matrix scaled down
*
            CALL cslascl( 'General', 0, 0, NORMA, SMLNUM, M, N, A, LDA,
     $                   INFO )
         END IF
      END IF
*
