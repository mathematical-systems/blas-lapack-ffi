...
*  =======
*
*  ZCHKQR tests czgeqrf, czungqr and ccunmqr.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  ZGET02, czlacpy, ZLARHS, ZLATB4, ZLATMS, ZQRT01,
     $                   ZQRT02, ZQRT03
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.GE.N ) THEN
*
*                       Test czungqr, using factorization
*                       returned by ZQRT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test czunmqr, using factorization returned
*                       by ZQRT01
*
...
*
     ...
     $                                  ISEED, INFO )
*
                           CALL czlacpy( 'Full', M, NRHS, B, LDA, X,
     $                                  LDA )
                           SRNAMT = 'ZGEQRS'
