...
*     .. External Subroutines ..
      EXTERNAL cdlabad,cdlarnv,cdlascl
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC SIGN
*     ..
...
*           matrix scaled up
*
              CALL cdlascl('General',0,0,NORMA,BIGNUM,M,N,A,LDA,INFO)
          ELSE IF (SCALE.EQ.3) THEN
*
*           matrix scaled down
*
              CALL cdlascl('General',0,0,NORMA,SMLNUM,M,N,A,LDA,INFO)
          END IF
      END IF
*
