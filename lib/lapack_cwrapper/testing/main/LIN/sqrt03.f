...
*  =======
*
*  SQRT03 tests csormqr, which computes Q*C, Q'*C, C*Q or C*Q'.
*
*  SQRT03 compares the results of a call to csormqr with the results of
*  forming Q explicitly by a call to csorgqr and then performing matrix
...
*          returnedby csgeqrf. See csgeqrf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, cslacpy, cslarnv, cslaset, csorgqr, 
     $  csormqr 
*     ..
*     .. Local Arrays ..
      INTEGER            ISEED( 4 )
...
*
      ...
      CALL cslacpy( 'Lower', M-1, K, AF( 2, 1 ), LDA, Q( 2, 1 ), LDA )
*
*     Generate the m-by-m matrix Q
*
      SRNAMT = 'csorgqr'
      CALL csorgqr( M, M, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
      DO 30 ISIDE = 1, 2
         IF( ISIDE.EQ.1 ) THEN
            SIDE = 'L'
...
*
            SRNAMT = 'csormqr'
            CALL csormqr( SIDE, TRANS, MC, NC, K, AF, LDA, TAU, CC, 
     $  LDA, 
     $                   WORK, LWORK, INFO )
*
