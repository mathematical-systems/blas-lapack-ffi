...
*     from the symmetric factorization computed by cchptrf.
*     cchptrf produces a factorization of the form
*          U * D * U^H     or     L * D * L^H,
...
*           determined by ccsptrf or cchptrf.
...
*     .. External Subroutines ..
      EXTERNAL           CGEMV, CGERU, cclacgv, CSCAL, CSWAP, xerbla
*     ..
*     .. Intrinsic Functions ..
