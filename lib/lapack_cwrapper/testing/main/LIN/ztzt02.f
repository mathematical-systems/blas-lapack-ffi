...
*     .. External Subroutines ..
      EXTERNAL           xerbla, czlaset, czlatzm
*     ..
*     .. Intrinsic Functions ..
...
*
      DO 10 I = M, 1, -1
         CALL czlatzm( 'Left', N-M+1, N, AF( I, M+1 ), LDA, TAU( I ),
...
*
      DO 20 I = 1, M
         CALL czlatzm( 'Left', N-M+1, N, AF( I, M+1 ), LDA,
