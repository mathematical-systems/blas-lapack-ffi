...
*     .. External Subroutines ..
      EXTERNAL           cslabad, cslarnv, SLATB4, SLATMS, SROT, SROTG,
     $                   SSCAL
*     ..
*     .. Intrinsic Functions ..
...
*
  ...
  180       CONTINUE
         ELSE
            JC = 1
            DO 190 J = 1, N
               CALL cslarnv( 2, ISEED, N-J+1, A( JC ) )
               A( JC ) = SIGN( TWO, A( JC ) )
               JC = JC + N - J + 1
  190       CONTINUE
         END IF
...
*
  ...
  200       CONTINUE
         ...
         ELSE
            JC = 1
            DO 210 J = 1, N
               CALL cslarnv( 2, ISEED, N-J, A( JC+1 ) )
