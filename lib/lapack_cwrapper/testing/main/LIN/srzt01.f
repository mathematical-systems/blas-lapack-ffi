...
*  SRZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cstzrzf.
*
*  Arguments
*  =========
*
...
*          The output of cstzrzf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, cslaset, csormrz, xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, REAL
*     ..
...
*     R = R * P(1) * ... *P(m)
*
      CALL csormrz( 'Right', 'No tranpose', M, N, M, N-M, AF, LDA, TAU,
