...
*  =======
*
*  DCHKRQ tests cdgerqf, cdorgrq and cdormrq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL ALAERH,ALAHD,ALASUM,DERRRQ,DGERQS,DGET02,cdlacpy,DLARHS,
     +         DLATB4,DLATMS,DRQT01,DRQT02,DRQT03,XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
*     ..
...
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ELSE IF (M.LE.N) THEN
*
*                       Test cdorgrq, using factorization
*                       returned by DRQT01
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ...
                          IF (M.GE.K) THEN
*
*                       Test cdormrq, using factorization returned
*                       by DRQT01
*
...
*
     ...
     +                                        ISEED,INFO)
*
                                  CALL cdlacpy('Full',M,NRHS,B,LDA,
     +                                         X(N-M+1),LDA)
                                  SRNAMT = 'DGERQS'
