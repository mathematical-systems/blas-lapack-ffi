...
*  =======
*
*  SCHKLQ tests csgelqf, csorglq and csormlq.
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
      CHARACTER          DIST, TYPE
      CHARACTER*3        PATH
      INTEGER            I, IK, IM, IMAT, IN, INB, INFO, K, KL, KU, 
     $  LDA, 
     $                   LWORK, M, MINMN, MODE, N, NB, NERRS, NFAIL, 
     $  NK, 
     $                   NRUN, NT, NX
      REAL               ANORM, CNDNUM
*     ..
...
*     .. External Subroutines ..
     ...
     $                   cslacpy, SLARHS, SLATB4, SLATMS, SLQT01, 
     $  SLQT02, 
     $                   SLQT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      CNDNUM, ANORM, KL, KU, 'No packing', A, 
     $  LDA, 
     $                      WORK, INFO )
*
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test csorglq, using factorization
*                       returned by SLQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test csormlq, using factorization returned
*                       by SLQT01
*
...
*
     ...
     $                                  NRHS, A, LDA, XACT, LDA, B, 
     $  LDA, 
     $                                  ISEED, INFO )
*
                           CALL cslacpy( 'Full', M, NRHS, B, LDA, X,
     $                                  LDA )
                           SRNAMT = 'SGELQS'
