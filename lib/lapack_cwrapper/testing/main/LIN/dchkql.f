...
*     .. Array Arguments ..
      ...
      DOUBLE PRECISION A(*),AC(*),AF(*),AL(*),AQ(*),B(*),RWORK(*),
     +                 TAU(*),WORK(*),X(*),XACT(*)
*     ..
*
*  Purpose
*  =======
*
*  DCHKQL tests cdgeqlf, cdorgql and cdormql.
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
      CHARACTER DIST,TYPE
      CHARACTER*3 PATH
      INTEGER I,IK,IM,IMAT,IN,INB,INFO,K,KL,KU,LDA,LWORK,M,MINMN,MODE,N,
     +        NB,NERRS,NFAIL,NK,NRUN,NT,NX
...
*     .. External Subroutines ..
      EXTERNAL ALAERH,ALAHD,ALASUM,DERRQL,DGEQLS,DGET02,cdlacpy,DLARHS,
     +         DLATB4,DLATMS,DQLT01,DQLT02,DQLT03,XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
*     ..
...
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ELSE IF (M.GE.N) THEN
*
*                       Test cdorgql, using factorization
*                       returned by DQLT01
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ...
                          IF (M.GE.K) THEN
*
*                       Test cdormql, using factorization returned
*                       by DQLT01
*
...
*
     ...
     +                                        ISEED,INFO)
*
                                  CALL cdlacpy('Full',M,NRHS,B,LDA,X,
     +                                         LDA)
                                  SRNAMT = 'DGEQLS'
...
*
 9999 FORMAT (' M=',I5,', N=',I5,', K=',I5,', NB=',I4,', NX=',I5,
