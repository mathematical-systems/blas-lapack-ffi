...
*  =======
*
*  DCHKLQ tests cdgelqf, cdorglq and cdormlq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL ALAERH,ALAHD,ALASUM,DERRLQ,DGELQS,DGET02,cdlacpy,DLARHS,
     +         DLATB4,DLATMS,DLQT01,DLQT02,DLQT03,XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
*     ..
...
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ELSE IF (M.LE.N) THEN
*
*                       Test cdorglq, using factorization
*                       returned by DLQT01
*
     ...
     +                                    LWORK,RWORK,RESULT(1))
                          ...
                          IF (M.GE.K) THEN
*
*                       Test cdormlq, using factorization returned
*                       by DLQT01
*
