...
*  ZRZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cztzrzf.
*
*  Arguments
*  =========
*
...
*          The output of cztzrzf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL           xerbla, ZAXPY, czlaset, czunmrz
*     ..
*     .. Intrinsic Functions ..
...
*     R = R * P(1) * ... *P(m)
*
      CALL czunmrz( 'Right', 'No tranpose', M, N, M, N-M, AF, LDA, TAU,
