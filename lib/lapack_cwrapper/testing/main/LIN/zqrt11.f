...
*     .. External Subroutines ..
      EXTERNAL           xerbla, czlaset, czunm2r
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $   RETURN
*
      CALL czlaset( 'Full', M, M, DCMPLX( ZERO ), DCMPLX( ONE ), WORK,
     $             M )
*
*     Form Q
*
      CALL czunm2r( 'Left', 'No transpose', M, M, K, A, LDA, TAU, WORK,
     $             M, WORK( M*M+1 ), INFO )
*
*     Form Q'*Q
*
      CALL czunm2r( 'Left', 'Conjugate transpose', M, M, K, A, LDA, TAU,
