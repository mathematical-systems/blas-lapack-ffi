...
*  =======
*
*  CCHKQR tests ccgeqrf, ccungqr and ccunmqr.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  cclacpy, CLARHS, CLATB4, CLATMS, CQRT01, CQRT02,
     $                   CQRT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.GE.N ) THEN
*
*                       Test ccungqr, using factorization
*                       returned by CQRT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test ccunmqr, using factorization returned
*                       by CQRT01
*
