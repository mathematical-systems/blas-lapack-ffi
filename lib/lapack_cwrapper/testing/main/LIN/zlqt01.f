...
*  =======
*
*  ZLQT01 tests czgelqf, which computes the LQ factorization of an m-by-n
*  matrix A, and partially tests czunglq which forms the n-by-n
*  orthogonal matrix Q.
*
...
*          Details of the LQ factorization of A, as returned by czgelqf.
*          See czgelqf for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL          czgelqf, ZGEMM, ZHERK, czlacpy, czlaset, czunglq
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'czgelqf'
      CALL czgelqf( M, N, AF, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy details of Q
*
      CALL czlaset( 'Full', N, N, ROGUE, ROGUE, Q, LDA )
      IF( N.GT.1 )
     $  CALL czlacpy( 'Upper', M, N-1, AF( 1, 2 ), LDA, Q( 1, 2 ), LDA )
*
*     Generate the n-by-n matrix Q
*
      SRNAMT = 'czunglq'
      CALL czunglq( N, N, MINMN, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy L
*
      CALL czlaset( 'Full', M, N, DCMPLX( ZERO ), DCMPLX( ZERO ), L,
     $             LDA )
      CALL czlacpy( 'Lower', M, N, AF, LDA, L, LDA )
*
*     Compute L - A*Q'
*
...
*     Compute I - Q*Q'
*
      CALL czlaset('Full', N, N, DCMPLX( ZERO ), DCMPLX( ONE ), L, LDA )
