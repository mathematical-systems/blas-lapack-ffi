...
*  =======
*
*  CCHKRQ tests ccgerqf, ccungrq and ccunmrq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  cclacpy, CLARHS, CLATB4, CLATMS, CRQT01, CRQT02,
     $                   CRQT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test ccungrq, using factorization
*                       returned by CRQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test ccunmrq, using factorization returned
*                       by CRQT01
*
...
*
     ...
     $                                  ISEED, INFO )
*
                           CALL cclacpy( 'Full', M, NRHS, B, LDA,
     $                                  X( N-M+1 ), LDA )
                           SRNAMT = 'CGERQS'
