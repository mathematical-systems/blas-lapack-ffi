...
*          L and U from the L*U factorization as computed by ccgetrf.
...
*          The pivot indices from ccgetrf.
*
...
*     .. External Subroutines ..
      EXTERNAL           CGEMV, cclaswp, CSCAL, CTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, REAL
*     ..
...
*
     ...
     $                  LDAFAC, AFAC( 1, K ), 1 )
         END IF
   10 CONTINUE
      CALL cclaswp( N, AFAC, LDAFAC, 1, MIN( M, N ), IPIV, -1 )
*
