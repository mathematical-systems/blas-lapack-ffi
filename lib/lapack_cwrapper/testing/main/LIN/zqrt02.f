...
*  =======
*
*  ZQRT02 tests czungqr, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMM, ZHERK, czlacpy, czlaset, czungqr
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'czungqr'
      CALL czungqr( M, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy R(1:n,1:k)
*
      CALL czlaset( 'Full', N, K, DCMPLX( ZERO ), DCMPLX( ZERO ), R,
     $             LDA )
      CALL czlacpy( 'Upper', N, K, AF, LDA, R, LDA )
*
