...
*     .. External Subroutines ..
      EXTERNAL           cslaset, csorm2r, xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          REAL
*     ..
...
*
     ...
     $   RETURN
*
      CALL cslaset( 'Full', M, M, ZERO, ONE, WORK, M )
*
*     Form Q
*
      CALL csorm2r( 'Left', 'No transpose', M, M, K, A, LDA, TAU, WORK,
     $             M, WORK( M*M+1 ), INFO )
*
*     Form Q'*Q
*
      CALL csorm2r( 'Left', 'Transpose', M, M, K, A, LDA, TAU, WORK, M,
     $             WORK( M*M+1 ), INFO )
*
      DO 10 J = 1, M
