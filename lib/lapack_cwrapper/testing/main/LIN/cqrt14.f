...
*     .. External Subroutines ..
      EXTERNAL           ccgelq2, ccgeqr2, cclacpy, cclascl, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*     Copy and scale A
*
      CALL cclacpy( 'All', M, N, A, LDA, WORK, LDWORK )
      ANRM = CLANGE( 'M', M, N, WORK, LDWORK, RWORK )
      IF( ANRM.NE.ZERO )
     $   CALL cclascl( 'G', 0, 0, ANRM, ONE, M, N, WORK, LDWORK, INFO )
*
...
*
         ...
         IF( XNRM.NE.ZERO )
     $      CALL cclascl( 'G', 0, 0, XNRM, ONE, NRHS, N, WORK( M+1 ),
     $                   LDWORK, INFO )
*
*        Compute LQ factorization of work
*
         CALL ccgelq2( LDWORK, N, WORK, LDWORK, WORK( LDWORK*N+1 ),
