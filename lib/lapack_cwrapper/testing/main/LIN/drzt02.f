...
*     .. External Subroutines ..
      EXTERNAL cdlaset,cdormrz,xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*     Q := P(1) * ... * P(m) * Q
*
      CALL cdormrz('Left','No transpose',N,N,M,N-M,AF,LDA,TAU,WORK,N,
     +             WORK(N*N+1),LWORK-N*N,INFO)
*
*     Q := P(m) * ... * P(1) * Q
*
      CALL cdormrz('Left','Transpose',N,N,M,N-M,AF,LDA,TAU,WORK,N,
     +             WORK(N*N+1),LWORK-N*N,INFO)
*
*     Q := Q - I
*
