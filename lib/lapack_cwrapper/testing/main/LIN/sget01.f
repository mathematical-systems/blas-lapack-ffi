...
*          L and U from the L*U factorization as computed by csgetrf.
...
*          The pivot indices from csgetrf.
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEMV, cslaswp, SSCAL, STRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, REAL
*     ..
...
*
     ...
     $                  LDAFAC, AFAC( 1, K ), 1 )
         END IF
   10 CONTINUE
      CALL cslaswp( N, AFAC, LDAFAC, 1, MIN( M, N ), IPIV, -1 )
*
