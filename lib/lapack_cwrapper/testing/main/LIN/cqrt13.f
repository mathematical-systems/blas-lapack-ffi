...
*     .. External Subroutines ..
      EXTERNAL           cclarnv, cclascl, cslabad
*     ..
*     .. Intrinsic Functions ..
...
*           matrix scaled up
*
            CALL cclascl( 'General', 0, 0, NORMA, BIGNUM, M, N, A, LDA,
     $                   INFO )
         ELSE IF( SCALE.EQ.3 ) THEN
*
*           matrix scaled down
*
            CALL cclascl( 'General', 0, 0, NORMA, SMLNUM, M, N, A, LDA,
     $                   INFO )
         END IF
      END IF
*
