...
*  =======
*
*  ZCHKSP tests czsptrf, -TRI, -TRS, -RFS, and -CON
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  czlacpy, ZLARHS, ZLATB4, ZLATMS, ZLATSP, ZPPT05,
     $                czspcon, czsprFS, ZSPT01, ZSPT02, ZSPT03, czsptrf,
     $                   czsptri, czsptrs
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
  ...
  100             CONTINUE
               ...
               END IF
*
*              Check error code from czsptrf.
*
               IF( INFO.NE.K )
     $            CALL ALAERH( PATH, 'czsptrf', INFO, K, UPLO, N, N, -1,
...
*
*              Check error code from czsptri.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'czsptri', INFO, 0, UPLO, N, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
                  SRNAMT = 'czsptrs'
                  CALL czsptrs( UPLO, N, NRHS, AFAC, IWORK, X, LDA,
     $                         INFO )
*
*              Check error code from czsptrs.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'czsptrs', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'czsprFS'
                 CALL czsprFS( UPLO, N, NRHS, A, AFAC, IWORK, B, LDA, X,
     $                         LDA, RWORK, RWORK( NRHS+1 ), WORK,
     $                         RWORK( 2*NRHS+1 ), INFO )
*
*              Check error code from czsprFS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'czsprFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140          CONTINUE
               ...
               SRNAMT = 'czspcon'
               CALL czspcon( UPLO, N, AFAC, IWORK, ANORM, RCOND, WORK,
     $                      INFO )
*
*              Check error code from czspcon.
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'czspcon', INFO, 0, UPLO, N, N, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
