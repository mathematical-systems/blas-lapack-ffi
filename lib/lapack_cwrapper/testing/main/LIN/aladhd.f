...
*
 ...
 9991 FORMAT (/1X,A3,' drivers:  ',A9,' indefinite packed matrices')
...
*     PO, PP matrix types
*
 9985 FORMAT (4X,'1. Diagonal',24X,'6. Random, CNDNUM = sqrt(0.1/EPS)',
...
*
 9983 FORMAT (4X,'1. Diagonal',24X,'6. Last n/2 rows and columns zero',
     +       /4X,'2. Random, CNDNUM = 2',14X,
...
*
 9982 FORMAT (4X,'1. Diagonal',24X,'7. Random, CNDNUM = sqrt(0.1/EPS)',
     +       /4X,'2. Random, CNDNUM = 2',14X,
     +       '8. Random, CNDNUM = 0.1/EPS',/4X,
     +       '3. First row and column zero',7X,
     +       '9. Scaled near underflow',/4X,
