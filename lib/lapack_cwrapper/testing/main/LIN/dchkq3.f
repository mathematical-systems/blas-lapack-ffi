...
*     .. Local Scalars ..
      CHARACTER*3 PATH
      INTEGER I,IHIGH,ILOW,IM,IMODE,IN,INB,INFO,ISTEP,K,LDA,LW,LWORK,M,
     +        MNMIN,MODE,N,NB,NERRS,NFAIL,NRUN,NX
...
*     .. External Subroutines ..
      EXTERNAL ALAHD,ALASUM,cdgeqp3,cdlacpy,DLAORD,cdlaset,DLATMS,ICOPY,
     +         XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
...
*
                      SRNAMT = 'cdgeqp3'
                      CALL cdgeqp3(M,N,A,LDA,IWORK(N+1),TAU,WORK,LW,
     +                             INFO)
*
...
*
     ...
     +                            NERRS.EQ.0) CALL ALAHD(NOUT,PATH)
                              WRITE (NOUT,FMT=9999) 'cdgeqp3',M,N,NB,
     +                          IMODE,K,RESULT(K)
                              NFAIL = NFAIL + 1
                          END IF
   50                 CONTINUE
...
*
 9999 FORMAT (1X,A6,' M =',I5,', N =',I5,', NB =',I4,', type ',I2,
     +       ', test ',I2,', ratio =',G12.5)
*
*     End of DCHKQ3
*
