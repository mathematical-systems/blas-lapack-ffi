...
*  =======
*
*  SCHKRQ tests csgerqf, csorgrq and csormrq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                   cslacpy, SLARHS, SLATB4, SLATMS, SRQT01, 
     $  SRQT02, 
     $                   SRQT03, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test csorgrq, using factorization
*                       returned by SRQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test csormrq, using factorization returned
*                       by SRQT01
*
...
*
     ...
     $                                  ISEED, INFO )
*
                           CALL cslacpy( 'Full', M, NRHS, B, LDA,
     $                                  X( N-M+1 ), LDA )
                           SRNAMT = 'SGERQS'
