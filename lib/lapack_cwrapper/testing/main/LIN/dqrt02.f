...
*  =======
*
*  DQRT02 tests cdorgqr, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL DGEMM,cdlacpy,cdlaset,cdorgqr,DSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*
      SRNAMT = 'cdorgqr'
      CALL cdorgqr(M,N,K,Q,LDA,TAU,WORK,LWORK,INFO)
*
*     Copy R(1:n,1:k)
*
      CALL cdlaset('Full',N,K,ZERO,ZERO,R,LDA)
      CALL cdlacpy('Upper',N,K,AF,LDA,R,LDA)
*
