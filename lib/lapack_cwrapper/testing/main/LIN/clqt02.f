...
*  =======
*
*  CLQT02 tests ccunglq, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, cclacpy, cclaset, ccunglq
*     ..
*     .. Intrinsic Functions ..
...
*
      SRNAMT = 'ccunglq'
      CALL ccunglq( M, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy L(1:k,1:m)
*
      CALL cclaset( 'Full', K, M, CMPLX( ZERO ), CMPLX( ZERO ), L, LDA )
      CALL cclacpy( 'Lower', K, M, AF, LDA, L, LDA )
*
