...
*     .. External Subroutines ..
      EXTERNAL           csgelq2, csgeqr2, cslacpy, cslascl, xerbla
*     ..
*     .. Intrinsic Functions ..
...
*     Copy and scale A
*
      CALL cslacpy( 'All', M, N, A, LDA, WORK, LDWORK )
      ANRM = SLANGE( 'M', M, N, WORK, LDWORK, RWORK )
      IF( ANRM.NE.ZERO )
     $   CALL cslascl( 'G', 0, 0, ANRM, ONE, M, N, WORK, LDWORK, INFO )
*
...
*
         ...
         IF( XNRM.NE.ZERO )
     $      CALL cslascl( 'G', 0, 0, XNRM, ONE, NRHS, N, WORK( M+1 ),
     $                   LDWORK, INFO )
*
*        Compute LQ factorization of work
*
         CALL csgelq2( LDWORK, N, WORK, LDWORK, WORK( LDWORK*N+1 ),
