...
*  =======
*
*  ZCHKRQ tests czgerqf, czungrq and ccunmrq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  ZGET02, czlacpy, ZLARHS, ZLATB4, ZLATMS, ZRQT01,
     $                   ZRQT02, ZRQT03
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test czungrq, using factorization
*                       returned by ZRQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test czunmrq, using factorization returned
*                       by ZRQT01
*
...
*
     ...
     $                                  ISEED, INFO )
*
                           CALL czlacpy( 'Full', M, NRHS, B, LDA,
     $                                  X( N-M+1 ), LDA )
                           SRNAMT = 'ZGERQS'
