...
*  =======
*
*  ZCHKHE tests czhetrf, -TRI, -TRS, -RFS, and -CON.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $              czhecon, czherfs, ZHET01, czhetrf, czhetri, czhetrs,
     $                  czlacpy, ZLAIPD, ZLARHS, ZLATB4, ZLATMS, ZPOT02,
     $                   ZPOT03, ZPOT05
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'czhetrf'
                  CALL czhetrf( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK,
     $                         INFO )
*
...
*
  ...
  100                CONTINUE
                  ...
                  END IF
*
*                 Check error code from czhetrf.
*
                  IF( INFO.NE.K )
     $               CALL ALAERH( PATH, 'czhetrf', INFO, K, UPLO, N, N,
...
*
     ...
     $                            INFO )
*
*                 Check error code from czhetri.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czhetri', INFO, -1, UPLO, N,
...
*
                     SRNAMT = 'czhetrs'
                     CALL czhetrs( UPLO, N, NRHS, AFAC, LDA, IWORK, X,
     $                            LDA, INFO )
*
*                 Check error code from czhetrs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czhetrs', INFO, 0, UPLO, N,
...
*
                     SRNAMT = 'czherfs'
                     CALL czherfs( UPLO, N, NRHS, A, LDA, AFAC, LDA,
     $                            IWORK, B, LDA, X, LDA, RWORK,
     $                            RWORK( NRHS+1 ), WORK,
     $                            RWORK( 2*NRHS+1 ), INFO )
*
*                 Check error code from czherfs.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'czherfs', INFO, 0, UPLO, N,
     $                               N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140             CONTINUE
                  ...
                  SRNAMT = 'czhecon'
                  CALL czhecon( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND,
     $                         WORK, INFO )
*
*                 Check error code from czhecon.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'czhecon', INFO, 0, UPLO, N, N,
