...
*          The (possibly partial) output of czgeqpf.  The upper triangle
...
*          Pivot information as returned by czgeqpf.
*
...
*     .. External Subroutines ..
      EXTERNAL           xerbla, ZAXPY, ZCOPY, czunmqr
*     ..
*     .. Intrinsic Functions ..
...
*
   ...
   40 CONTINUE
*
      CALL czunmqr( 'Left', 'No transpose', M, N, K, AF, LDA, TAU, WORK,
