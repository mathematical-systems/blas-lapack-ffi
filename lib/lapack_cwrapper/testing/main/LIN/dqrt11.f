...
*     .. External Subroutines ..
      EXTERNAL cdlaset,cdorm2r,xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE
*     ..
...
*
      IF (M.LE.0) RETURN
*
      CALL cdlaset('Full',M,M,ZERO,ONE,WORK,M)
*
*     Form Q
*
      CALL cdorm2r('Left','No transpose',M,M,K,A,LDA,TAU,WORK,M,
     +             WORK(M*M+1),INFO)
*
*     Form Q'*Q
*
      CALL cdorm2r('Left','Transpose',M,M,K,A,LDA,TAU,WORK,M,
     +             WORK(M*M+1),INFO)
*
      DO 10 J = 1,M
