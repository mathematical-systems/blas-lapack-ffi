      SUBROUTINE DCHKQP(DOTYPE,NM,MVAL,NN,NVAL,THRESH,TSTERR,A,COPYA,S,
     +                  COPYS,TAU,WORK,IWORK,NOUT)
*
...
*     .. Local Scalars ..
      CHARACTER*3 PATH
      INTEGER I,IHIGH,ILOW,IM,IMODE,IN,INFO,ISTEP,K,LDA,LWORK,M,MNMIN,
...
*     .. External Subroutines ..
      EXTERNAL ALAHD,ALASUM,DERRQP,cdgeqpf,cdlacpy,DLAORD,cdlaset,DLATMS
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC MAX,MIN
*     ..
...
*
      IF (TSTERR) CALL DERRQP(PATH,NOUT)
      INFOT = 0
...
*
   ...
   20             CONTINUE
                  IF (IMODE.EQ.1) THEN
                      CALL cdlaset('Full',M,N,ZERO,ZERO,COPYA,LDA)
                      DO 30 I = 1,MNMIN
                          COPYS(I) = ZERO
   30                 CONTINUE
                  ELSE
...
*
                  CALL cdlacpy('All',M,N,COPYA,LDA,A,LDA)
*
*              Compute the QR factorization with pivoting of A
*
                  SRNAMT = 'cdgeqpf'
                  CALL cdgeqpf(M,N,A,LDA,IWORK,TAU,WORK,INFO)
*
...
*
                  RESULT(2) = DQPT01(M,N,MNMIN,COPYA,A,LDA,TAU,IWORK,
     +                        WORK,LWORK)
*
*              Compute Q'*Q
*
