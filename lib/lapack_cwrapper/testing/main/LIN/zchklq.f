...
*  =======
*
*  ZCHKLQ tests czgelqf, czunglq and ccunmlq.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                  ZGET02, czlacpy, ZLARHS, ZLATB4, ZLATMS, ZLQT01,
     $                   ZLQT02, ZLQT03
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ELSE IF( M.LE.N ) THEN
*
*                       Test czunglq, using factorization
*                       returned by ZLQT01
*
     ...
     $                               WORK, LWORK, RWORK, RESULT( 1 ) )
                     ...
                     IF( M.GE.K ) THEN
*
*                       Test czunmlq, using factorization returned
*                       by ZLQT01
*
