...
*  =======
*
*  SQRT02 tests csorgqr, which generates an m-by-n matrix Q with
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, cslacpy, cslaset, csorgqr, SSYRK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, REAL
*     ..
...
*
      SRNAMT = 'csorgqr'
      CALL csorgqr( M, N, K, Q, LDA, TAU, WORK, LWORK, INFO )
*
*     Copy R(1:n,1:k)
*
      CALL cslaset( 'Full', N, K, ZERO, ZERO, R, LDA )
      CALL cslacpy( 'Upper', N, K, AF, LDA, R, LDA )
*
