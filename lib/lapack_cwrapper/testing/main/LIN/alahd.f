...
*
 9979 FORMAT (4X,'1. Diagonal',24X,'7. Last n/2 columns zero',/4X,
     ...
     +       '10. Scaled near underflow',/4X,'5. First column zero',14X,
     +       '11. Scaled near overflow',/4X,'6. Last column zero')
*
*     GB matrix types
*
...
*
 9977 FORMAT (' Matrix types (1-6 have specified condition numbers):',
     ...
     +       '9. Last column zero',/4X,'4. Random, CNDNUM = 0.1/EPS',7X,
     +       '10. Last n/2 columns zero',/4X,'5. Scaled near underflow',
     +       10X,'11. Scaled near underflow',/4X,
...
*
 9976 FORMAT (' Matrix types (1-6 have specified condition numbers):',
     +       /4X,'1. Diagonal',24X,'7. Random, unspecified CNDNUM',/4X,
     +       '2. Random, CNDNUM = 2',14X,'8. First row and column zero',
     ...
     +       '5. Scaled near underflow',10X,'11. Scaled near underflow',
     +       /4X,'6. Scaled near overflow',11X,
     +       '12. Scaled near overflow')
*
*     PO, PP matrix types
*
 9975 FORMAT (4X,'1. Diagonal',24X,'6. Random, CNDNUM = sqrt(0.1/EPS)',
...
*     CH matrix types
*
 9974 FORMAT (4X,'1. Diagonal',24X,'6. Random, CNDNUM = sqrt(0.1/EPS)',
     +       /4X,'2. Random, CNDNUM = 2',14X,
     +       '7. Random, CNDNUM = 0.1/EPS',/3X,
     +       '*3. First row and column zero',7X,
     +       '8. Scaled near underflow',/3X,
...
*
 9972 FORMAT (4X,'1. Diagonal',24X,'6. Last n/2 rows and columns zero',
     +       /4X,'2. Random, CNDNUM = 2',14X,
...
*
 9971 FORMAT (4X,'1. Diagonal',24X,'7. Random, CNDNUM = sqrt(0.1/EPS)',
     +       /4X,'2. Random, CNDNUM = 2',14X,
     +       '8. Random, CNDNUM = 0.1/EPS',/4X,
     +       '3. First row and column zero',7X,
     +       '9. Scaled near underflow',/4X,
...
*     QR matrix types
*
 9970 FORMAT (4X,'1. Diagonal',24X,'5. Random, CNDNUM = sqrt(0.1/EPS)',
     +       /4X,'2. Upper triangular',16X,
     +       '6. Random, CNDNUM = 0.1/EPS',/4X,'3. Lower triangular',
     +       16X,'7. Scaled near underflow',/4X,'4. Random, CNDNUM = 2',
...
*     TR, TP matrix types
*
 9966 FORMAT (' Matrix types for ',A3,' routines:',/4X,'1. Diagonal',
     +       24X,'6. Scaled near overflow',/4X,'2. Random, CNDNUM = 2',
     +       14X,'7. Identity',/4X,'3. Random, CNDNUM = sqrt(0.1/EPS)  '
...
*
 9964 FORMAT (' Matrix types for ',A3,' routines:',/4X,
     ...
     +       '4. Scaled near underflow',11X,'9. Unit, CNDNUM = 0.1/EPS',
     +       /4X,'5. Scaled near overflow')
...
*
 ...
 9936 FORMAT (' Test ratios (1-2: ',A1,'GELS, 3-6: ',A1,'GELSS, 7-10: ',
     +       A1,'GELSX):')
 ...
 9929 FORMAT (' Test ratios (1-3: ',A1,'TZRQF, 4-6: ',A1,'TZRZF):')
 9920 FORMAT (3X,' 7-10: same as 3-6',3X,' 11-14: same as 3-6',3X,
     +       ' 15-18: same as 3-6')
 9921 FORMAT (' Test ratios:',/'    (1-2: ',A1,'GELS, 3-6: ',A1,
     +       'GELSX, 7-10: ',A1,'GELSY, 11-14: ',A1,'GELSS, 15-18: ',A1,
     +       'GELSD)')
*
      RETURN
*
