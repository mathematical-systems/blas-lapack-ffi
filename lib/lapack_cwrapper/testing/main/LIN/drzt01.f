...
*  DRZT01 returns
*       || A - R*Q || / ( M * eps * ||A|| )
*  for an upper trapezoidal A that was factored with cdtzrzf.
*
*  Arguments
*  =========
*
...
*          The output of cdtzrzf for input matrix A.
...
*     .. External Subroutines ..
      EXTERNAL DAXPY,cdlaset,cdormrz,xerbla
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC DBLE,MAX
*     ..
...
*     R = R * P(1) * ... *P(m)
*
      CALL cdormrz('Right','No tranpose',M,N,M,N-M,AF,LDA,TAU,WORK,M,
