...
*  =======
*
*  CCZGBSVX uses the LU factorization to compute the solution to a complex
...
*          A, as computed by CZGBTRF.  U is stored as an upper triangular
...
*          as computed by CZGBTRF; row i of the matrix was interchanged
*          with row IPIV(i).
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, CZGBCON, CZGBEQU, CZGBRFS, 
     $  CZGBTRF, 
     $                   CZGBTRS, CZLACPY, CZLAQGB
*     ..
*     .. Intrinsic Functions ..
...
*
         CALL CZGBEQU( N, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,
     $                AMAX, INFEQU )
         IF( INFEQU.EQ.0 ) THEN
*
*           Equilibrate the matrix.
*
            CALL CZLAQGB( N, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,
     $                   AMAX, EQUED )
            ROWEQU = LSAME( EQUED, 'R' ) .OR. LSAME( EQUED, 'B' )
            COLEQU = LSAME( EQUED, 'C' ) .OR. LSAME( EQUED, 'B' )
         END IF
...
*
   ...
   70    CONTINUE
*
         CALL CZGBTRF( N, N, KL, KU, AFB, LDAFB, IPIV, INFO )
*
...
*
      CALL CZGBCON( NORM, N, KL, KU, AFB, LDAFB, IPIV, ANORM, RCOND,
     $             WORK, RWORK, INFO )
*
*     Compute the solution matrix X.
*
      CALL CZLACPY( 'Full', N, NRHS, B, LDB, X, LDX )
      CALL CZGBTRS( TRANS, N, KL, KU, NRHS, AFB, LDAFB, IPIV, X, LDX,
     $             INFO )
*
*     Use iterative refinement to improve the computed solution and
*     compute error bounds and backward error estimates for it.
*
      CALL CZGBRFS( TRANS, N, KL, KU, NRHS, AB, LDAB, AFB, LDAFB, IPIV,
