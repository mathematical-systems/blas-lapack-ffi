...
*  =======
*
*  CDLASD3 finds all the square roots of the roots of the secular
*  equation, as defined by the values in D and Z.  It makes the
*  appropriate calls to CDLASD4 and then updates the singular
...
*
*  CDLASD3 is called from CDLASD1.
*
*  Arguments
*  =========
*
...
*
*         The rows of the singular vectors found by CDLASD4
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DGEMM, CDLACPY, CDLASCL, CDLASD4, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
      RHO = DNRM2( K, Z, 1 )
      CALL CDLASCL( 'G', 0, 0, RHO, ONE, K, 1, Z, K, INFO )
      RHO = RHO*RHO
*
*     Find the new singular values.
*
      DO 30 J = 1, K
         CALL CDLASD4( K, J, DSIGMA, Z, U( 1, J ), RHO, D( J ),
     $                VT( 1, J ), INFO )
*
...
*
     ...
     $               LDU2, Q( KTEMP, 1 ), LDQ, ZERO, U( 1, 1 ), LDU )
      ELSE
         CALL CDLACPY( 'F', NL, K, U2, LDU2, U, LDU )
      END IF
