...
*  =======
*
*  CZGBTRF computes an LU factorization of a complex m-by-n band matrix A
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, CZGBTF2, ZGEMM, ZGERU, 
     $  CZLASWP, 
     $                   ZSCAL, ZSWAP, ZTRSM
*     ..
*     .. Intrinsic Functions ..
...
*        Use unblocked code
*
         CALL CZGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use CZLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL CZLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
