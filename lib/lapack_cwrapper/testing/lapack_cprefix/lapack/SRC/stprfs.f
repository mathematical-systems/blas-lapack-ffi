...
*  =======
*
*  CSTPRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular packed
*  coefficient matrix.
*
*  The solution matrix X must be computed by CSTPTRS or some other
*  means before entering this routine.  CSTPRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, CSLACN2, STPMV, STPSV, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
