...
*  =======
*
*  This routine is deprecated and has been replaced by routine CCDGELSY.
*
*  CCDGELSX computes the minimum-norm solution to a real linear least
*  squares problem:
*      minimize || A * X - B ||
...
*     .. External Subroutines ..
      EXTERNAL           CDGEQPF, CDLAIC1, CDLASCL, CDLASET, CDLATZM, 
     $  CDORM2R, 
     $                   DTRSM, CDTZRQF, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*        A * P = Q * R
*
      CALL CDGEQPF( M, N, A, LDA, JPVT, WORK( 1 ), WORK( MN+1 ), INFO )
*
...
*
      IF( RANK.LT.N )
     $   CALL CDTZRQF( RANK, N, A, LDA, WORK( MN+1 ), INFO )
*
*     Details of Householder rotations stored in WORK(MN+1:2*MN)
*
*     B(1:M,1:NRHS) := Q' * B(1:M,1:NRHS)
*
      CALL CDORM2R( 'Left', 'Transpose', M, NRHS, MN, A, LDA, WORK( 1 
     $  ), 
...
*
      IF( RANK.LT.N ) THEN
         DO 50 I = 1, RANK
            CALL CDLATZM( 'Left', N-RANK+1, NRHS, A( I, RANK+1 ), LDA,
