...
*  =======
*
*  CCLARNV returns a vector of n random complex numbers from a uniform or
*  normal distribution.
*
*  Arguments
*  =========
...
*  ===============
*
*  This routine calls the auxiliary routine CSLARUV to generate random
...
*
      DO 60 IV = 1, N, LV / 2
         IL = MIN( LV / 2, N-IV+1 )
*
*        Call CSLARUV to generate 2*IL real numbers from a uniform (0,1)
*        distribution (2*IL <= LV)
*
         CALL CSLARUV( ISEED, 2*IL, U )
*
         IF( IDIST.EQ.1 ) THEN
*
