...
*  =======
*
*  CDLAUUM computes the product U * U' or L' * L, where the triangular
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM, CDLAUU2, DSYRK, DTRMM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CDLAUUM', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CDLAUU2( UPLO, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code
*
...
*
     ...
     $                     LDA )
               CALL CDLAUU2( 'Upper', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
...
*
     ...
     $                     I-1, ONE, A( I, I ), LDA, A( I, 1 ), LDA )
               CALL CDLAUU2( 'Lower', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
