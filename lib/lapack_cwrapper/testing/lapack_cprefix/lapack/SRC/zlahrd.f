...
*  =======
*
*  CZLAHRD reduces the first NB columns of a complex general n-by-(n-k+1)
*  matrix A so that elements below the k-th subdiagonal are zero. The
*  reduction is performed by a unitary similarity transformation
*  Q' * A * Q. The routine returns the matrices V and T which determine
*  Q as a block reflector I - V*T*V', and also the matrix Y = A * V * T.
*
*  This is an auxiliary routine called by CZGEHRD.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ZAXPY, ZCOPY, ZGEMV, CZLACGV, CZLARFG, ZSCAL,
     $                   ZTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*
            CALL CZLACGV( I-1, A( K+I-1, 1 ), LDA )
...
*
         EI = A( K+I, I )
         CALL CZLARFG( N-K-I+1, EI, A( MIN( K+I+1, N ), I ), 1,
     $                TAU( I ) )
         A( K+I, I ) = ONE
*
*        Compute  Y(1:n,i)
