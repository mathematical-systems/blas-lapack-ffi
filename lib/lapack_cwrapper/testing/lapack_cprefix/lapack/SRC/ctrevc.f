...
*  =======
*
*  CCTREVC computes some or all of the right and/or left eigenvectors of
*  a complex upper triangular matrix T.
*  Matrices of this type are produced by the Schur factorization of
*  a complex general matrix:  A = Q*T*Q**H, as computed by CCHSEQR.
*  
...
*          Schur vectors returned by CCHSEQR).
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CGEMV, CCLATRS, CSSCAL, CSLABAD, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
            IF( KI.GT.1 ) THEN
               CALL CCLATRS( 'Upper', 'No transpose', 'Non-unit', 'Y',
