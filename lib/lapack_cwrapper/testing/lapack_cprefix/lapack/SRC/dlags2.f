...
*  =======
*
*  CDLAGS2 computes 2-by-2 orthogonal matrices U, V and Q, such
*  that if ( UPPER ) then
*
*            U'*A*Q = U'*( A1 A2 )*Q = ( x  0  )
*                        ( 0  A3 )     ( x  x  )
...
*
         CALL CDLASV2( A, B, D, S1, S2, SNR, CSR, SNL, CSL )
*
...
*
     ...
     $             ( ABS( VB11R )+ABS( VB12 ) ) ) THEN
                  CALL CDLARTG( -UA11R, UA12, CSQ, SNQ, R )
               ELSE
                  CALL CDLARTG( -VB11R, VB12, CSQ, SNQ, R )
               END IF
            ELSE
               CALL CDLARTG( -VB11R, VB12, CSQ, SNQ, R )
            END IF
...
*
     ...
     $             ( ABS( VB21 )+ABS( VB22 ) ) ) THEN
                  CALL CDLARTG( -UA21, UA22, CSQ, SNQ, R )
               ELSE
                  CALL CDLARTG( -VB21, VB22, CSQ, SNQ, R )
               END IF
            ELSE
               CALL CDLARTG( -VB21, VB22, CSQ, SNQ, R )
            END IF
...
*
         CALL CDLASV2( A, C, D, S1, S2, SNR, CSR, SNL, CSL )
*
...
*
     ...
     $             ( ABS( VB21 )+ABS( VB22R ) ) ) THEN
                  CALL CDLARTG( UA22R, UA21, CSQ, SNQ, R )
               ELSE
                  CALL CDLARTG( VB22R, VB21, CSQ, SNQ, R )
               END IF
            ELSE
               CALL CDLARTG( VB22R, VB21, CSQ, SNQ, R )
            END IF
...
*
     ...
     $             ( ABS( VB11 )+ABS( VB12 ) ) ) THEN
                  CALL CDLARTG( UA12, UA11, CSQ, SNQ, R )
               ELSE
                  CALL CDLARTG( VB12, VB11, CSQ, SNQ, R )
               END IF
            ELSE
               CALL CDLARTG( VB12, VB11, CSQ, SNQ, R )
            END IF
