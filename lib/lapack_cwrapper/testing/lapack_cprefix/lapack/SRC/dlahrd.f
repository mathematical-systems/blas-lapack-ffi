...
*  =======
*
*  CDLAHRD reduces the first NB columns of a real general n-by-(n-k+1)
*  matrix A so that elements below the k-th subdiagonal are zero. The
*  reduction is performed by an orthogonal similarity transformation
*  Q' * A * Q. The routine returns the matrices V and T which determine
*  Q as a block reflector I - V*T*V', and also the matrix Y = A * V * T.
*
*  This is an auxiliary routine called by CDGEHRD.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, DGEMV, CDLARFG, DSCAL, DTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*        A(k+i+1:n,i)
*
         CALL CDLARFG( N-K-I+1, A( K+I, I ), A( MIN( K+I+1, N ), I ), 
     $  1, 
     $                TAU( I ) )
         EI = A( K+I, I )
         A( K+I, I ) = ONE
