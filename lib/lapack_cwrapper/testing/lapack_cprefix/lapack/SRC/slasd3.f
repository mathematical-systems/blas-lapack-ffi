...
*  =======
*
*  CSLASD3 finds all the square roots of the roots of the secular
*  equation, as defined by the values in D and Z.  It makes the
*  appropriate calls to CSLASD4 and then updates the singular
...
*
*  CSLASD3 is called from CSLASD1.
*
*  Arguments
*  =========
*
...
*
*         The rows of the singular vectors found by CSLASD4
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SGEMM, CSLACPY, CSLASCL, CSLASD4, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
      RHO = SNRM2( K, Z, 1 )
      CALL CSLASCL( 'G', 0, 0, RHO, ONE, K, 1, Z, K, INFO )
      RHO = RHO*RHO
*
*     Find the new singular values.
*
      DO 30 J = 1, K
         CALL CSLASD4( K, J, DSIGMA, Z, U( 1, J ), RHO, D( J ),
     $                VT( 1, J ), INFO )
*
...
*
     ...
     $               LDU2, Q( KTEMP, 1 ), LDQ, ZERO, U( 1, 1 ), LDU )
      ELSE
         CALL CSLACPY( 'F', NL, K, U2, LDU2, U, LDU )
      END IF
