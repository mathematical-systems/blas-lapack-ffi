...
*  =======
*
* CDSTEGR computes selected eigenvalues and, optionally, eigenvectors
...
*
*  Note 1 : Currently CDSTEGR is only set up to find ALL the n
*  eigenvalues and eigenvectors of T in O(n^2) time
*  Note 2 : Currently the routine CDSTEIN is called when an appropriate
*  sigma_i cannot be chosen in step (c) above. CDSTEIN invokes modified
*  Gram-Schmidt when eigenvalues are close.
*  Note 3 : CDSTEGR works only on machines which follow ieee-754
*  floating-point standard in their handling of infinities and NaNs.
*  Normal execution of CDSTEGR may create NaNs and infinities and hence
...
*     .. External Subroutines ..
      EXTERNAL           CDLARRE, CDLARRV, CDLASET, DSCAL, DSWAP, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      IINDWK = 2*N + 1
*
      CALL CDLASET( 'Full', N, N, ZERO, ZERO, Z, LDZ )
*
...
*
   ...
   20    CONTINUE
*
         CALL CDLARRV( N, D, E, IWORK( IINSPL ), M, W, IWORK( IINDBL ),
