...
*  =======
*
*  CSTBRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular band
*  coefficient matrix.
*
*  The solution matrix X must be computed by CSTBTRS or some other
*  means before entering this routine.  CSTBRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, CSLACN2, STBMV, STBSV, XERBLA
*     ..
*     .. Intrinsic Functions ..
