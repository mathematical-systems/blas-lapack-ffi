...
*  =======
*
*  Given the tridiagonal matrix T, CSLARRE sets "small" off-diagonal
...
*  CSSTEGR to compute the eigenvectors of a symmetric tridiagonal
...
*  matrices are found by the dqds algorithm (subroutine CSLASQ2). As
*  an added benefit, CSLARRE also outputs the n Gerschgorin
...
*
*  INFO    (output) INTEGER
*          Output error code from CSLASQ2
*
*  Further Details
*  ===============
*
