...
*  =======
*
*  CCPBSTF computes a split Cholesky factorization of a complex
*  Hermitian positive definite band matrix A.
*
*  This routine is designed to be used in conjunction with CCHBGST.
*
...
*     .. External Subroutines ..
      EXTERNAL           CHER, CCLACGV, CSSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            ...
            CALL CCLACGV( KM, AB( KM+1, J-KM ), KLD )
