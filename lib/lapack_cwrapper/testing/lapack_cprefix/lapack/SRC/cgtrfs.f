...
*  =======
*
*  CCGTRFS improves the computed solution to a system of linear
...
*          LU factorization of A as computed by CCGTTRF.
*
...
*          On entry, the solution matrix X, as computed by CCGTTRS.
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CCOPY, CCGTTRS, CCLACN2, CCLAGTM, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         CALL CCLAGTM( TRANS, N, 1, -ONE, DL, D, DU, X( 1, J ), LDX, 
     $  ONE, 
     $                WORK, N )
*
...
*
            CALL CCGTTRS( TRANS, N, 1, DLF, DF, DUF, DU2, IPIV, WORK, 
     $  N, 
     $                   INFO )
...
*
               CALL CCGTTRS( TRANST, N, 1, DLF, DF, DUF, DU2, IPIV, 
     $  WORK, 
     $                      N, INFO )
               DO 80 I = 1, N
...
*
               DO 90 I = 1, N
                  WORK( I ) = RWORK( I )*WORK( I )
   90          CONTINUE
               CALL CCGTTRS( TRANSN, N, 1, DLF, DF, DUF, DU2, IPIV, 
     $  WORK, 
     $                      N, INFO )
            END IF
            GO TO 70
