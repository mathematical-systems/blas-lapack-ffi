...
*  =======
*
*  CZHSEIN uses inverse iteration to find specified right and/or left
...
*          = 'Q': the eigenvalues were found using CZHSEQR; thus, if
*                 H has zero subdiagonal elements, and so is
*                 block-triangular, then the j-th eigenvalue can be
*                 assumed to be an eigenvalue of the block containing
*                 the j-th row/column.  This property allows CZHSEIN to
*                 perform inverse iteration on just one diagonal block.
*          = 'N': no assumptions are made on the correspondence
*                 between eigenvalues and diagonal blocks.  In this
*                 case, CZHSEIN must always perform inverse iteration
...
*
               CALL CZLAEIN( .FALSE., NOINIT, N-KL+1, H( KL, KL ), LDH,
...
*
               CALL CZLAEIN( .TRUE., NOINIT, KR, H, LDH, WK, VR( 1, KS 
     $  ), 
