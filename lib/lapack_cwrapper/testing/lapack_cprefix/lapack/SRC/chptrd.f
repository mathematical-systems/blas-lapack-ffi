...
*  =======
*
*  CCHPTRD reduces a complex Hermitian matrix A stored in packed form to
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CHPMV, CHPR2, CCLARFG, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      COMPLEX            CDOTC
...
*
            ALPHA = AP( I1+I-1 )
            CALL CCLARFG( I, ALPHA, AP( I1 ), 1, TAUI )
            E( I ) = ALPHA
*
...
*
            ALPHA = AP( II+1 )
            CALL CCLARFG( N-I, ALPHA, AP( II+2 ), 1, TAUI )
            E( I ) = ALPHA
*
            IF( TAUI.NE.ZERO ) THEN
*
