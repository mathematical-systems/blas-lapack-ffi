...
*  =======
*
*  Using the divide and conquer method, CCLAED0 computes all eigenvalues
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CCLACRM, CCLAED7, SCOPY, CSSTEQR, 
     $  XERBLA 
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
*
     ...
     $   RETURN
*
      SMLSIZ = ILAENV( 9, 'CCLAED0', ' ', 0, 0, 0, 0 )
*
...
*
     ...
     $                RWORK( LL ), MATSIZ, RWORK, INFO )
         CALL CCLACRM( QSIZ, MATSIZ, Q( 1, SUBMAT ), LDQ, RWORK( LL ),
...
*     into an eigensystem of size MATSIZ.  CCLAED7 handles the case
*     when the eigenvectors of a full or band Hermitian matrix (which
*     was reduced to tridiagonal form) are desired.
*
*     I am free to use Q as a valuable working space until Loop 150.
*
            CALL CCLAED7( MATSIZ, MSD2, QSIZ, TLVLS, CURLVL, CURPRB,
