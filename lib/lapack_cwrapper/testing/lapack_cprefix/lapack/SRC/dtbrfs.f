...
*  =======
*
*  CDTBRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular band
*  coefficient matrix.
*
*  The solution matrix X must be computed by CDTBTRS or some other
*  means before entering this routine.  CDTBRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, CDLACN2, DTBMV, DTBSV, XERBLA
*     ..
*     .. Intrinsic Functions ..
