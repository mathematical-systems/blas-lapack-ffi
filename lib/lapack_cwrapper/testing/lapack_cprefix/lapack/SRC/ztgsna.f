...
*  =======
*
*  CZTGSNA estimates reciprocal condition numbers for specified
...
*          columns of VL, as returned by CZTGEVC.
...
*          (A, B), corresponding to the eigenpairs specified by HOWMNY
*          and SELECT.  The eigenvectors must be stored in consecutive
*          columns of VR, as returned by CZTGEVC.
...
*     .. External Subroutines ..
      EXTERNAL           CDLABAD, XERBLA, ZGEMV, CZLACPY, CZTGEXC, 
     $  CZTGSYL 
*     ..
*     .. Intrinsic Functions ..
...
*
               CALL CZLACPY( 'Full', N, N, A, LDA, WORK, N )
               CALL CZLACPY( 'Full', N, N, B, LDB, WORK( N*N+1 ), N )
               IFST = K
               ILST = 1
*
               CALL CZTGEXC( .FALSE., .FALSE., N, WORK, N, WORK( N*N+1 
     $  ), 
...
*
                  ...
                  N2 = N - N1
                  I = N*N + 1
                  CALL CZTGSYL( 'N', IDIFJB, N2, N1, WORK( N*N1+N1+1 ),
