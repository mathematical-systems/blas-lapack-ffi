...
*  =======
*
*  CZPBSTF computes a split Cholesky factorization of a complex
*  Hermitian positive definite band matrix A.
*
*  This routine is designed to be used in conjunction with CZHBGST.
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZDSCAL, ZHER, CZLACGV
*     ..
*     .. Intrinsic Functions ..
...
*
            ...
            CALL CZLACGV( KM, AB( KM+1, J-KM ), KLD )
