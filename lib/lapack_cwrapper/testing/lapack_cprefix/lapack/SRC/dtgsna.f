...
*  =======
*
*  CDTGSNA estimates reciprocal condition numbers for specified
*  eigenvalues and/or eigenvectors of a matrix pair (A, B) in
*  generalized real Schur canonical form (or of any matrix pair
*  (Q*A*Z', Q*B*Z') with orthogonal matrices Q and Z, where
*  Z' denotes the transpose of Z.
*
*  (A, B) must be in generalized real Schur form (as returned by CDGGES),
...
*          columns of VL, as returned by CDTGEVC.
...
*          (A, B), corresponding to the eigenpairs specified by HOWMNY
*          and SELECT. The eigenvectors must be stored in consecutive
*          columns ov VR, as returned by CDTGEVC.
...
*     (see CDLATDF), then the parameter DIFDRI (see below) should be
*     changed from 3 to 4 (routine CDLATDF(IJOB = 2 will be used)).
*     See CDTGSYL for more details.
*
...
*     CDLATDF), then the parameter DIFDRI (see below) should be changed
*     from 3 to 4 (routine CDLATDF(IJOB = 2 will be used)). See CDTGSYL
*     for more details.
*
...
*     .. External Subroutines ..
      EXTERNAL           DGEMV, CDLACPY, CDLAG2, CDTGEXC, CDTGSYL, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
               ...
               WORK( 7 ) = B( K, K+1 )
               WORK( 8 ) = B( K+1, K+1 )
               CALL CDLAG2( WORK, 2, WORK( 5 ), 2, SMLNUM*EPS, BETA,
...
*
            CALL CDLACPY( 'Full', N, N, A, LDA, WORK, N )
            CALL CDLACPY( 'Full', N, N, B, LDB, WORK( N*N+1 ), N )
            IFST = K
            ILST = 1
*
            CALL CDTGEXC( .FALSE., .FALSE., N, WORK, N, WORK( N*N+1 ), 
     $  N, 
...
*
     ...
     $            N1 = 2
               ...
               ELSE
                  I = N*N + 1
                  IZ = 2*N*N + 1
                  CALL CDTGSYL( 'N', DIFDRI, N2, N1, WORK( N*N1+N1+1 ),
