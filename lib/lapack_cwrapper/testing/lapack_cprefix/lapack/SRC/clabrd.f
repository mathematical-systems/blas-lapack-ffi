...
*  =======
*
*  CCLABRD reduces the first NB rows and columns of a complex general
...
*  bidiagonal form.
*
*  This is an auxiliary routine called by CCGEBRD
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CGEMV, CCLACGV, CCLARFG, CSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
               ...
               CALL CCLACGV( I, A( I, 1 ), LDA )
               CALL CGEMV( 'No transpose', N-I, I, -ONE, Y( I+1, 1 ),
     $                     LDY, A( I, 1 ), LDA, ONE, A( I, I+1 ), LDA )
               CALL CCLACGV( I, A( I, 1 ), LDA )
               CALL CCLACGV( I-1, X( I, 1 ), LDX )
               CALL CGEMV( 'Conjugate transpose', I-1, N-I, -ONE,
