...
*  =======
*
*  CCTRSNA estimates reciprocal condition numbers for specified
...
*     .. External Subroutines ..
      EXTERNAL           CCLACN2, CCLACPY, CCLATRS, CCSRSCL, CCTREXC, 
     $  CSLABAD, 
     $                   XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CCLACPY( 'Full', N, N, T, LDT, WORK, LDWORK )
            CALL CCTREXC( 'No Q', N, WORK, LDWORK, DUMMY, 1, K, 1, IERR 
     $  ) 
*
...
*
            ...
            NORMIN = 'N'
   30       CONTINUE
            CALL CCLACN2( N-1, WORK( 1, N+1 ), WORK, EST, KASE, ISAVE )
*
            IF( KASE.NE.0 ) THEN
               IF( KASE.EQ.1 ) THEN
*
*                 Solve C'*x = scale*b
*
                  CALL CCLATRS( 'Upper', 'Conjugate transpose',
...
*                 Solve C*x = scale*b
*
                  CALL CCLATRS( 'Upper', 'No transpose', 'Nonunit',
