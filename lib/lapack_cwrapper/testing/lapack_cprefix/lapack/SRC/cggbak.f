...
*  =======
*
*  CCGGBAK forms the right or left eigenvectors of a complex generalized
...
*                  scaling.
*          JOB must be the same as the argument JOB supplied to CCGGBAL.
*
...
*  ILO     (input) INTEGER
*  IHI     (input) INTEGER
*          The integers ILO and IHI determined by CCGGBAL.
*          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.
*
*  LSCALE  (input) REAL array, dimension (N)
*          Details of the permutations and/or scaling factors applied
*          to the left side of A and B, as returned by CCGGBAL.
*
*  RSCALE  (input) REAL array, dimension (N)
*          Details of the permutations and/or scaling factors applied
*          to the right side of A and B, as returned by CCGGBAL.
*
*  M       (input) INTEGER
...
*          transformed, as returned by CCTGEVC.
