...
*  =======
*
*  CCSYTF2 computes the factorization of a complex symmetric matrix A
...
*     .. External Subroutines ..
      EXTERNAL           CSCAL, CSWAP, CCSYR, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               R1 = CONE / A( K, K )
               CALL CCSYR( UPLO, K-1, -R1, A( 1, K ), 1, A, LDA )
*
...
*
                  R1 = CONE / A( K, K )
                  CALL CCSYR( UPLO, N-K, -R1, A( K+1, K ), 1,
     $                       A( K+1, K+1 ), LDA )
*
