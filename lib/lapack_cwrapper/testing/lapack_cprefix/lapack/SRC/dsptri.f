...
*  =======
*
*  CDSPTRI computes the inverse of a real symmetric indefinite matrix
*  A in packed storage using the factorization A = U*D*U**T or
*  A = L*D*L**T computed by CDSPTRF.
*
*  Arguments
*  =========
*
...
*          used to obtain the factor U or L as computed by CDSPTRF,
