...
*  =======
*
*  CCPBTRF computes the Cholesky factorization of a complex Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, CCPBTF2, CCPOTF2, CTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
      NB = ILAENV( 1, 'CCPBTRF', UPLO, N, KD, -1, -1 )
*
...
*        Use unblocked code
*
         CALL CCPBTF2( UPLO, N, KD, AB, LDAB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               CALL CCPOTF2( UPLO, IB, AB( KD+1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
...
*                    Update A12
*
                     CALL CTRSM( 'Left', 'Upper', 'Conjugate 
     $  transpose', 
     $                           'Non-unit', IB, I2, CONE,
     $                           AB( KD+1, I ), LDAB-1,
...
*              Factorize the diagonal block
*
               CALL CCPOTF2( UPLO, IB, AB( 1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
