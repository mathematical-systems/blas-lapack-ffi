...
*  =======
*
*  CZHPTRS solves a system of linear equations A*X = B with a complex
*  Hermitian matrix A stored in packed format using the factorization
*  A = U*D*U**H or A = L*D*L**H computed by CZHPTRF.
*
*  Arguments
*  =========
*
...
*          obtain the factor U or L as computed by CZHPTRF, stored as a
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZDSCAL, ZGEMV, ZGERU, CZLACGV, ZSWAP
*     ..
*     .. Intrinsic Functions ..
