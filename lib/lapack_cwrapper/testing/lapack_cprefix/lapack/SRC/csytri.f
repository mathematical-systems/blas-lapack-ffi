...
*  =======
*
*  CCSYTRI computes the inverse of a complex symmetric indefinite matrix
...
*          used to obtain the factor U or L as computed by CCSYTRF.
*
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CSWAP, CCSYMV, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
...
*
            IF( K.GT.1 ) THEN
               ...
               CALL CCSYMV( UPLO, K-1, -ONE, A, LDA, WORK, 1, ZERO,
     $                     A( 1, K ), 1 )
...
*
            IF( K.LT.N ) THEN
               ...
               CALL CCSYMV( UPLO, N-K, -ONE, A( K+1, K+1 ), LDA, WORK, 
     $  1, 
     $                     ZERO, A( K+1, K ), 1 )
