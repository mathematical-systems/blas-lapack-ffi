...
*  =======
*
*  CZTBRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular band
*  coefficient matrix.
*
*  The solution matrix X must be computed by CZTBTRS or some other
*  means before entering this routine.  CZTBRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, CZLACN2, ZTBMV, ZTBSV
*     ..
*     .. Intrinsic Functions ..
