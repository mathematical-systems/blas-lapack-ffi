...
*  =======
*
*  CCHPGVD computes all the eigenvalues and, optionally, the eigenvectors
...
*          > 0:  CCPPTRF or CCHPEVD returned an error code:
*             <= N:  if INFO = i, CCHPEVD failed to converge;
...
*     .. External Subroutines ..
      EXTERNAL           CCHPEVD, CCHPGST, CCPPTRF, CTPMV, CTPSV, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, REAL
...
*
      CALL CCHPGST( ITYPE, UPLO, N, AP, BP, INFO )
      CALL CCHPEVD( JOBZ, UPLO, N, AP, W, Z, LDZ, WORK, LWORK, RWORK,
