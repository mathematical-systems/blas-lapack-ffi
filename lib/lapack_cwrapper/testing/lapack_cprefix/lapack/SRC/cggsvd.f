...
*  =======
*
*  CCGGSVD computes the generalized singular value decomposition (GSVD)
...
*                converge.  For further details, see subroutine CCTGSJA.
*
*  Internal Parameters
*  ===================
*
...
*     .. Local Scalars ..
      ...
      REAL               ANORM, BNORM, SMAX, TEMP, TOLA, TOLB, ULP, 
     $  UNFL 
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*     .. External Subroutines ..
      EXTERNAL           CCGGSVP, CCTGSJA, SCOPY, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      CALL CCGGSVP( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB, TOLA,
     $             TOLB, K, L, U, LDU, V, LDV, Q, LDQ, IWORK, RWORK,
     $             WORK, WORK( N+1 ), INFO )
*
*     Compute the GSVD of two upper "triangular" matrices
*
      CALL CCTGSJA( JOBU, JOBV, JOBQ, M, P, N, K, L, A, LDA, B, LDB,
