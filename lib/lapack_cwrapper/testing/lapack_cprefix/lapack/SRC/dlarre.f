...
*  =======
*
*  Given the tridiagonal matrix T, CDLARRE sets "small" off-diagonal
...
*  CDSTEGR to compute the eigenvectors of a symmetric tridiagonal
...
*  matrices are found by the dqds algorithm (subroutine CDLASQ2). As
*  an added benefit, CDLARRE also outputs the n Gerschgorin
...
*
*  INFO    (output) INTEGER
*          Output error code from CDLASQ2
*
*  Further Details
*  ===============
*
