...
*  =======
*
*  CZTRCON estimates the reciprocal of the condition number of a
...
*              Multiply by inv(A).
*
               CALL CZLATRS( UPLO, 'No transpose', DIAG, NORMIN, N, A,
     $                      LDA, WORK, SCALE, RWORK, INFO )
            ELSE
*
*              Multiply by inv(A').
*
               CALL CZLATRS( UPLO, 'Conjugate transpose', DIAG, NORMIN,
