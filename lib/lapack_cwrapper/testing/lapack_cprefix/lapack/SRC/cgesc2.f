...
*  =======
*
*  CCGESC2 solves a system of linear equations
*
*            A * X = scale* RHS
*
*  with a general N-by-N matrix A using the LU factorization with
*  complete pivoting computed by CCGETC2.
*
*
*  Arguments
*  =========
...
*          matrix A computed by CCGETC2:  A = P * L * U * Q
*
*  LDA     (input) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           CCLASWP, CSCAL, CSLABAD
*     ..
*     .. External Functions ..
      INTEGER            ICAMAX
      REAL               SLAMCH
...
*
      CALL CCLASWP( 1, RHS, LDA, 1, N-1, IPIV, 1 )
*
*     Solve for L part
*
      DO 20 I = 1, N - 1
...
*
      CALL CCLASWP( 1, RHS, LDA, 1, N-1, JPIV, -1 )
      RETURN
*
*     End of CCGESC2
*
