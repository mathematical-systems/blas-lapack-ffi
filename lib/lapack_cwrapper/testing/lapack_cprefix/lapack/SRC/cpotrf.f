...
*  =======
*
*  CCPOTRF computes the Cholesky factorization of a complex Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CHERK, CCPOTF2, CTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CCPOTRF', UPLO, N, -1, -1, -1 )
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code.
*
         CALL CCPOTF2( UPLO, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code.
*
...
*
     ...
     $                     -ONE, A( 1, J ), LDA, ONE, A( J, J ), LDA )
               CALL CCPOTF2( 'Upper', JB, A( J, J ), LDA, INFO )
               IF( INFO.NE.0 )
     $            GO TO 30
               IF( J+JB.LE.N ) THEN
*
...
*
     ...
     $                     A( J, 1 ), LDA, ONE, A( J, J ), LDA )
               CALL CCPOTF2( 'Lower', JB, A( J, J ), LDA, INFO )
               IF( INFO.NE.0 )
     $            GO TO 30
               IF( J+JB.LE.N ) THEN
*
