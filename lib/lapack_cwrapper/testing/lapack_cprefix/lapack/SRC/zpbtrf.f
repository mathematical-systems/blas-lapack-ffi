...
*  =======
*
*  CZPBTRF computes the Cholesky factorization of a complex Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZGEMM, ZHERK, CZPBTF2, CZPOTF2, ZTRSM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
      NB = ILAENV( 1, 'CZPBTRF', UPLO, N, KD, -1, -1 )
*
...
*        Use unblocked code
*
         CALL CZPBTF2( UPLO, N, KD, AB, LDAB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               CALL CZPOTF2( UPLO, IB, AB( KD+1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
...
*                    Update A12
*
                     CALL ZTRSM( 'Left', 'Upper', 'Conjugate 
     $  transpose', 
     $                           'Non-unit', IB, I2, CONE,
     $                           AB( KD+1, I ), LDAB-1,
...
*              Factorize the diagonal block
*
               CALL CZPOTF2( UPLO, IB, AB( 1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
