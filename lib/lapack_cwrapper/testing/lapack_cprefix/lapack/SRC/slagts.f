...
*  =======
*
*  CSLAGTS may be used to solve one of the systems of equations
*
...
*     (T - lambda*I) = P*L*U ,
*
*  by routine CSLAGTF. The choice of equation to be solved is
...
*
*  JOB     (input) INTEGER
*          Specifies the job to be performed by CSLAGTS as follows:
...
*          returned from CSLAGTF.
*
*  B       (input) REAL array, dimension (N-1)
*          On entry, B must contain the first super-diagonal elements of
*          U as returned from CSLAGTF.
*
