...
*  =======
*
*  CSSPGST reduces a real symmetric-definite generalized eigenproblem
...
*
*  B must have been previously factorized as U**T*U or L*L**T by CSPPTRF.
*
*  Arguments
*  =========
*
...
*          stored in the same format as A, as returned by CSPPTRF.
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
