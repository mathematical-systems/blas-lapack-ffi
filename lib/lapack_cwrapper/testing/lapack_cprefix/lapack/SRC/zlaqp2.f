...
*  =======
*
*  CZLAQP2 computes a QR factorization with column pivoting of
...
*
         IF( OFFPI.LT.M ) THEN
            CALL CZLARFG( M-OFFPI+1, A( OFFPI, I ), A( OFFPI+1, I ), 
     $  1, 
     $                   TAU( I ) )
         ELSE
            CALL CZLARFG( 1, A( M, I ), A( M, I ), 1, TAU( I ) )
         END IF
*
         IF( I.LT.N ) THEN
*
...
*
            AII = A( OFFPI, I )
            A( OFFPI, I ) = CONE
            CALL CZLARF( 'Left', M-OFFPI+1, N-I, A( OFFPI, I ), 1,
