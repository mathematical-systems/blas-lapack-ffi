...
*  =======
*
*  CCTBRFS provides error bounds and backward error estimates for the
*  solution to a system of linear equations with a triangular band
*  coefficient matrix.
*
*  The solution matrix X must be computed by CCTBTRS or some other
*  means before entering this routine.  CCTBRFS does not do iterative
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CCOPY, CCLACN2, CTBMV, CTBSV, XERBLA
*     ..
*     .. Intrinsic Functions ..
