...
*  =======
*
*  CCLAHRD reduces the first NB columns of a complex general n-by-(n-k+1)
*  matrix A so that elements below the k-th subdiagonal are zero. The
*  reduction is performed by a unitary similarity transformation
*  Q' * A * Q. The routine returns the matrices V and T which determine
*  Q as a block reflector I - V*T*V', and also the matrix Y = A * V * T.
*
*  This is an auxiliary routine called by CCGEHRD.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CCOPY, CGEMV, CCLACGV, CCLARFG, CSCAL,
     $                   CTRMV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
...
*
            CALL CCLACGV( I-1, A( K+I-1, 1 ), LDA )
...
*
         EI = A( K+I, I )
         CALL CCLARFG( N-K-I+1, EI, A( MIN( K+I+1, N ), I ), 1,
     $                TAU( I ) )
         A( K+I, I ) = ONE
*
*        Compute  Y(1:n,i)
*
     ...
     $               1 )
         CALL CGEMV( 'No transpose', N, I-1, -ONE, Y, LDY, T( 1, I ), 
     $  1, 
     $               ONE, Y( 1, I ), 1 )
