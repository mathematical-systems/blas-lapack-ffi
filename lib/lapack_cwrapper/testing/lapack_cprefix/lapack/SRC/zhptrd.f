...
*  =======
*
*  CZHPTRD reduces a complex Hermitian matrix A stored in packed form to
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZHPMV, ZHPR2, CZLARFG
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      COMPLEX*16         ZDOTC
...
*
            ALPHA = AP( I1+I-1 )
            CALL CZLARFG( I, ALPHA, AP( I1 ), 1, TAUI )
            E( I ) = ALPHA
*
...
*
            ALPHA = AP( II+1 )
            CALL CZLARFG( N-I, ALPHA, AP( II+2 ), 1, TAUI )
            E( I ) = ALPHA
*
            IF( TAUI.NE.ZERO ) THEN
*
