...
*  =======
*
*  CDSYGS2 reduces a real symmetric-definite generalized eigenproblem
*  to standard form.
*
...
*
*  B must have been previously factorized as U'*U or L*L' by CDPOTRF.
*
*  Arguments
*  =========
*
