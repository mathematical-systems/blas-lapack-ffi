...
*  =======
*
*  CCSPTRF computes the factorization of a complex symmetric matrix A
...
*     .. External Subroutines ..
      EXTERNAL           CSCAL, CCSPR, CSWAP, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               R1 = CONE / AP( KC+K-1 )
               CALL CCSPR( UPLO, K-1, -R1, AP( KC ), 1, AP )
*
...
*
                  R1 = CONE / AP( KC )
                  CALL CCSPR( UPLO, N-K, -R1, AP( KC+1 ), 1,
     $                       AP( KC+N-K+1 ) )
*
