...
*  =======
*
*  CSLAUUM computes the product U * U' or L' * L, where the triangular
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, CSLAUU2, SSYRK, STRMM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CSLAUUM', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CSLAUU2( UPLO, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code
*
...
*
     ...
     $                     LDA )
               CALL CSLAUU2( 'Upper', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
...
*
     ...
     $                     I-1, ONE, A( I, I ), LDA, A( I, 1 ), LDA )
               CALL CSLAUU2( 'Lower', IB, A( I, I ), LDA, INFO )
               IF( I+IB.LE.N ) THEN
