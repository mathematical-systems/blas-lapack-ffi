...
*  =======
*
*  CCLARZB applies a complex block reflector H or its transpose H**H
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CGEMM, CCLACGV, CTRMM, XERBLA
*     ..
