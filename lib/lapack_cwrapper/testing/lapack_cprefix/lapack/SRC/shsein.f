...
*  =======
*
*  CSHSEIN uses inverse iteration to find specified right and/or left
...
*          = 'Q': the eigenvalues were found using CSHSEQR; thus, if
*                 H has zero subdiagonal elements, and so is
*                 block-triangular, then the j-th eigenvalue can be
*                 assumed to be an eigenvalue of the block containing
*                 the j-th row/column.  This property allows CSHSEIN to
*                 perform inverse iteration on just one diagonal block.
*          = 'N': no assumptions are made on the correspondence
*                 between eigenvalues and diagonal blocks.  In this
*                 case, CSHSEIN must always perform inverse iteration
...
*
               CALL CSLAEIN( .FALSE., NOINIT, N-KL+1, H( KL, KL ), LDH,
...
*
               CALL CSLAEIN( .TRUE., NOINIT, KR, H, LDH, WKR, WKI,
