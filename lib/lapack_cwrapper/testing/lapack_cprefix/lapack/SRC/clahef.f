...
*  =======
*
*  CCLAHEF computes a partial factorization of a complex Hermitian
...
*
*  CCLAHEF is an auxiliary routine called by CCHETRF. It uses blocked code
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CGEMM, CGEMV, CCLACGV, CSSCAL, CSWAP
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                     W( IMAX+1, KW-1 ), 1 )
               CALL CCLACGV( K-IMAX, W( IMAX+1, KW-1 ), 1 )
               IF( K.LT.N ) THEN
...
*
     ...
     $                     LDA )
               CALL CCLACGV( KK-1-KP, A( KP, KP+1 ), LDA )
...
*
     ...
     $                     LDA )
               CALL CCLACGV( KP-KK-1, A( KP, KK+1 ), LDA )
               IF( KP.LT.N )
...
*
               CALL CCLACGV( N-K, W( K+1, K ), 1 )
               CALL CCLACGV( N-K-1, W( K+2, K+1 ), 1 )
            END IF
         END IF
*
*        Store details of the interchanges in IPIV
