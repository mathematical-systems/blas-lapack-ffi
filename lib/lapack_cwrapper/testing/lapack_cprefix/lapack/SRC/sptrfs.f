...
*  =======
*
*  CSPTRFS improves the computed solution to a system of linear
...
*          factorization computed by CSPTTRF.
*
*  EF      (input) REAL array, dimension (N-1)
*          The (n-1) subdiagonal elements of the unit bidiagonal factor
*          L from the factorization computed by CSPTTRF.
*
...
*          On entry, the solution matrix X, as computed by CSPTTRS.
...
*
            CALL CSPTTRS( N, 1, DF, EF, WORK( N+1 ), N, INFO )
