...
*  =======
*
*  CSLAQP2 computes a QR factorization with column pivoting of
...
*
         IF( OFFPI.LT.M ) THEN
            CALL CSLARFG( M-OFFPI+1, A( OFFPI, I ), A( OFFPI+1, I ), 
     $  1, 
     $                   TAU( I ) )
         ELSE
            CALL CSLARFG( 1, A( M, I ), A( M, I ), 1, TAU( I ) )
         END IF
*
         IF( I.LT.N ) THEN
*
...
*
            AII = A( OFFPI, I )
            A( OFFPI, I ) = ONE
            CALL CSLARF( 'Left', M-OFFPI+1, N-I, A( OFFPI, I ), 1,
