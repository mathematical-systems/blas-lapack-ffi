...
*  =======
*
*  CCHEGST reduces a complex Hermitian-definite generalized
...
*
*  B must have been previously factorized as U**H*U or L*L**H by CCPOTRF.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CCHEGS2, CHEMM, CHER2K, CTRMM, CTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = ILAENV( 1, 'CCHEGST', UPLO, N, -1, -1, -1 )
*
      IF( NB.LE.1 .OR. NB.GE.N ) THEN
*
*        Use unblocked code
*
         CALL CCHEGS2( ITYPE, UPLO, N, A, LDA, B, LDB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
                  CALL CCHEGS2( ITYPE, UPLO, KB, A( K, K ), LDA,
     $                         B( K, K ), LDB, INFO )
                  IF( K+KB.LE.N ) THEN
