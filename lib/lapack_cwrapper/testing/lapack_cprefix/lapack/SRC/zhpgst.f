...
*  =======
*
*  CZHPGST reduces a complex Hermitian-definite generalized
...
*
*  B must have been previously factorized as U**H*U or L*L**H by CZPPTRF.
*
*  Arguments
*  =========
*
...
*          stored in the same format as A, as returned by CZPPTRF.
*
*  INFO    (output) INTEGER
*          = 0:  successful exit
