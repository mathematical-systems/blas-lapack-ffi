...
*  =======
*
*  CDPBTRF computes the Cholesky factorization of a real symmetric
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM, CDPBTF2, CDPOTF2, DSYRK, DTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN
*     ..
...
*
      NB = ILAENV( 1, 'CDPBTRF', UPLO, N, KD, -1, -1 )
*
...
*        Use unblocked code
*
         CALL CDPBTF2( UPLO, N, KD, AB, LDAB, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               CALL CDPOTF2( UPLO, IB, AB( KD+1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
...
*              Factorize the diagonal block
*
               CALL CDPOTF2( UPLO, IB, AB( 1, I ), LDAB-1, II )
               IF( II.NE.0 ) THEN
                  INFO = I + II - 1
                  GO TO 150
               END IF
