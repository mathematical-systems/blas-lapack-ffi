...
*  =======
*
* CSSTEGR computes selected eigenvalues and, optionally, eigenvectors
...
*
*  Note 1 : Currently CSSTEGR is only set up to find ALL the n
*  eigenvalues and eigenvectors of T in O(n^2) time
*  Note 2 : Currently the routine CSSTEIN is called when an appropriate
*  sigma_i cannot be chosen in step (c) above. CSSTEIN invokes modified
*  Gram-Schmidt when eigenvalues are close.
*  Note 3 : CSSTEGR works only on machines which follow ieee-754
*  floating-point standard in their handling of infinities and NaNs.
*  Normal execution of CSSTEGR may create NaNs and infinities and hence
...
*     .. External Subroutines ..
      EXTERNAL           CSLARRE, CSLARRV, CSLASET, SSCAL, SSWAP, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      IINDWK = 2*N + 1
*
      CALL CSLASET( 'Full', N, N, ZERO, ZERO, Z, LDZ )
*
...
*
   ...
   20    CONTINUE
*
         CALL CSLARRV( N, D, E, IWORK( IINSPL ), M, W, IWORK( IINDBL ),
