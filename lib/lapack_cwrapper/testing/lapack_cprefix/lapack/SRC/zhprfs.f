...
*  =======
*
*  CZHPRFS improves the computed solution to a system of linear
...
*          A = L*D*L**H as computed by CZHPTRF, stored as a packed
*          triangular matrix.
*
*  IPIV    (input) INTEGER array, dimension (N)
*          Details of the interchanges and the block structure of D
*          as determined by CZHPTRF.
*
...
*          On entry, the solution matrix X, as computed by CZHPTRS.
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, ZHPMV, CZHPTRS, CZLACN2
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL CZHPTRS( UPLO, N, 1, AFP, IPIV, WORK, N, INFO )
