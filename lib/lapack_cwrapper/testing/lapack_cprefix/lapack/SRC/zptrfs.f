...
*  =======
*
*  CZPTRFS improves the computed solution to a system of linear
...
*          the factorization computed by CZPTTRF.
*
*  EF      (input) COMPLEX*16 array, dimension (N-1)
*          The (n-1) off-diagonal elements of the unit bidiagonal
*          factor U or L from the factorization computed by CZPTTRF
*          (see UPLO).
*
...
*          On entry, the solution matrix X, as computed by CZPTTRS.
...
*
            CALL CZPTTRS( UPLO, N, 1, DF, EF, WORK, N, INFO )
