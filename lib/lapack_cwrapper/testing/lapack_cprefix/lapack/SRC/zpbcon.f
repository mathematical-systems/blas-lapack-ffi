...
*  =======
*
*  CZPBCON estimates the reciprocal of the condition number (in the
...
*           Multiply by inv(L).
*
            CALL CZLATBS( 'Lower', 'No transpose', 'Non-unit', NORMIN, 
     $  N, 
...
*           Multiply by inv(L').
*
            CALL CZLATBS( 'Lower', 'Conjugate transpose', 'Non-unit',
