...
*  =======
*
*  CCHETD2 reduces a complex Hermitian matrix A to real symmetric
...
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CHEMV, CHER2, CCLARFG, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      COMPLEX            CDOTC
...
*
            ALPHA = A( I, I+1 )
            CALL CCLARFG( I, ALPHA, A( 1, I+1 ), 1, TAUI )
            E( I ) = ALPHA
*
...
*
            ALPHA = A( I+1, I )
            CALL CCLARFG( N-I, ALPHA, A( MIN( I+2, N ), I ), 1, TAUI )
            E( I ) = ALPHA
*
            IF( TAUI.NE.ZERO ) THEN
*
