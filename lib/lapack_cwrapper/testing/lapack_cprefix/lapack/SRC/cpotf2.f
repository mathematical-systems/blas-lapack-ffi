...
*  =======
*
*  CCPOTF2 computes the Cholesky factorization of a complex Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           CGEMV, CCLACGV, CSSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
