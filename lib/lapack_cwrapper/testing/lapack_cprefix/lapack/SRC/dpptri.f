...
*  =======
*
*  CDPPTRI computes the inverse of a real symmetric positive definite
...
*     .. External Subroutines ..
      EXTERNAL           DSCAL, DSPR, DTPMV, CDTPTRI, XERBLA
*     ..
...
*
      CALL CDTPTRI( UPLO, 'Non-unit', N, AP, INFO )
      IF( INFO.GT.0 )
     $   RETURN
*
      IF( UPPER ) THEN
