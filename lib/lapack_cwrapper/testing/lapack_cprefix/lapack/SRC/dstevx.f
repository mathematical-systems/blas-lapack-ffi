...
*  =======
*
*  CCDSTEVX computes selected eigenvalues and, optionally, eigenvectors
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DSCAL, CDSTEBZ, CDSTEIN, CDSTEQR, 
     $  CDSTERF, 
     $                   DSWAP, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*     call CDSTERF or CSSTEQR.  If this fails for some eigenvalue, then
*     try CDSTEBZ.
*
      TEST = .FALSE.
      IF( INDEIG ) THEN
      ...
      IF( ( ALLEIG .OR. TEST ) .AND. ( ABSTOL.LE.ZERO ) ) THEN
         ...
         ELSE
            CALL CDSTEQR( 'I', N, W, WORK, Z, LDZ, WORK( INDWRK ), INFO 
     $  ) 
            IF( INFO.EQ.0 ) THEN
               DO 10 I = 1, N
                  IFAIL( I ) = 0
