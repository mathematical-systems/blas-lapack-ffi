...
*  =======
*
*  CZGGLSE solves the linear equality-constrained least squares (LSE)
*  problem:
*
...
*          CZGEQRF, CCGERQF, CZUNMQR and CCUNMRQ.
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZAXPY, ZCOPY, ZGEMV, CZGGRQF, ZTRMV,
     $                   CZTRTRS, CZUNMQR, CZUNMRQ
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      EXTERNAL           ILAENV
...
*
      IF( INFO.EQ.0) THEN
         ...
         ELSE
            ...
            NB3 = ILAENV( 1, 'CZUNMQR', ' ', M, N, P, -1 )
            NB4 = ILAENV( 1, 'CZUNMRQ', ' ', M, N, P, -1 )
...
*     unitary.
*
      CALL CZGGRQF( P, M, N, B, LDB, WORK, A, LDA, WORK( P+1 ),
...
*                       ( c2 ) M+P-N
*
      CALL CZUNMQR( 'Left', 'Conjugate Transpose', M, 1, MN, A, LDA,
...
*
      CALL CZUNMRQ( 'Left', 'Conjugate Transpose', N, 1, P, B, LDB,
