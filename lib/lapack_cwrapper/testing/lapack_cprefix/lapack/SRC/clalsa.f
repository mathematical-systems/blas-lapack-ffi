...
*  =======
*
*  CCLALSA is an itermediate step in solving the least squares problem
*  by computing the SVD of the coefficient matrix in compact form (The
*  singular vectors are computed as products of simple orthorgonal
*  matrices.).
*
*  If ICOMPQ = 0, CCLALSA applies the inverse of the left singular vector
*  matrix of an upper bidiagonal matrix to the right hand side; and if
*  ICOMPQ = 1, CCLALSA applies the right singular vector matrix to the
*  right hand side. The singular vector matrices were generated in
*  compact form by CCLALSA.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CCLALS0, SGEMM, CSLASDT, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*     by CSLASDQ. The corresponding left and right singular vector
...
*
         ...
         DO 150 I = LF, LL
            ...
            NRF = IC + 1
            J = J - 1
            CALL CCLALS0( ICOMPQ, NL, NR, SQRE, NRHS, BX( NLF, 1 ), 
     $  LDBX, 
...
*
         ...
         DO 180 I = LL, LF, -1
            ...
            END IF
            J = J + 1
            CALL CCLALS0( ICOMPQ, NL, NR, SQRE, NRHS, B( NLF, 1 ), LDB,
...
*
*     The nodes on the bottom level of the tree were solved
*     by CSLASDQ. The corresponding right singular vector
