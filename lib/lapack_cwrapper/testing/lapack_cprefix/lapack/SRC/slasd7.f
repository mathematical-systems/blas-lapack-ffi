...
*  =======
*
*  CSLASD7 merges the two sets of singular values together into a single
...
*
*  CSLASD7 is called from CSLASD6.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, CSLAMRG, SROT, XERBLA
*     ..
*     .. External Functions ..
      REAL               SLAMCH, SLAPY2
