...
*  =======
*
*  CZTGEXC reorders the generalized Schur decomposition of a complex
...
*
         CALL CZTGEX2( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, LDQ, Z, LDZ,
     $                HERE, INFO )
         IF( INFO.NE.0 ) THEN
            ILST = HERE
            RETURN
