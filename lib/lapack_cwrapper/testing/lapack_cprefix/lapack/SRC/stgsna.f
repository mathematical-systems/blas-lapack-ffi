...
*  =======
*
*  CSTGSNA estimates reciprocal condition numbers for specified
*  eigenvalues and/or eigenvectors of a matrix pair (A, B) in
*  generalized real Schur canonical form (or of any matrix pair
*  (Q*A*Z', Q*B*Z') with orthogonal matrices Q and Z, where
*  Z' denotes the transpose of Z.
*
*  (A, B) must be in generalized real Schur form (as returned by CSGGES),
...
*          columns of VL, as returned by CSTGEVC.
...
*          (A, B), corresponding to the eigenpairs specified by HOWMNY
*          and SELECT. The eigenvectors must be stored in consecutive
*          columns ov VR, as returned by CSTGEVC.
...
*     (see CSLATDF), then the parameter DIFDRI (see below) should be
*     changed from 3 to 4 (routine CSLATDF(IJOB = 2 will be used)).
*     See CSTGSYL for more details.
*
...
*     CSLATDF), then the parameter DIFDRI (see below) should be changed
*     from 3 to 4 (routine CSLATDF(IJOB = 2 will be used)). See CSTGSYL
*     for more details.
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEMV, CSLACPY, CSLAG2, CSTGEXC, CSTGSYL, 
     $  XERBLA 
*     ..
*     .. Intrinsic Functions ..
...
*
               ...
               WORK( 7 ) = B( K, K+1 )
               WORK( 8 ) = B( K+1, K+1 )
               CALL CSLAG2( WORK, 2, WORK( 5 ), 2, SMLNUM*EPS, BETA,
...
*
            CALL CSLACPY( 'Full', N, N, A, LDA, WORK, N )
            CALL CSLACPY( 'Full', N, N, B, LDB, WORK( N*N+1 ), N )
            IFST = K
            ILST = 1
*
            CALL CSTGEXC( .FALSE., .FALSE., N, WORK, N, WORK( N*N+1 ), 
     $  N, 
...
*
     ...
     $            N1 = 2
               ...
               ELSE
                  I = N*N + 1
                  IZ = 2*N*N + 1
                  CALL CSTGSYL( 'N', DIFDRI, N2, N1, WORK( N*N1+N1+1 ),
