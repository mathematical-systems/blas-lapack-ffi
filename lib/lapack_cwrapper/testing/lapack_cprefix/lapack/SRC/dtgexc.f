...
*  =======
*
*  CDTGEXC reorders the generalized real Schur decomposition of a real
...
*
     ...
     $            NBNEXT = 2
            END IF
            CALL CDTGEX2( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, LDQ, Z,
...
*
               CALL CDTGEX2( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, LDQ, 
     $  Z, 
...
*
                  CALL CDTGEX2( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, 
     $  LDQ, 
