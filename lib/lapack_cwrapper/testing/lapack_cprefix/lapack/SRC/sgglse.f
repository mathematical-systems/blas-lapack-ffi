...
*  =======
*
*  CSGGLSE solves the linear equality-constrained least squares (LSE)
*  problem:
*
...
*          CSGEQRF, CSGERQF, CSORMQR and CSORMRQ.
*
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, SGEMV, CSGGRQF, CSORMQR, 
     $  CSORMRQ, 
     $                   STRMV, CSTRTRS, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      EXTERNAL           ILAENV 
...
*
      IF( INFO.EQ.0) THEN
         ...
         ELSE
            ...
            NB3 = ILAENV( 1, 'CSORMQR', ' ', M, N, P, -1 )
            NB4 = ILAENV( 1, 'CSORMRQ', ' ', M, N, P, -1 )
...
*     orthogonal.
*
      CALL CSGGRQF( P, M, N, B, LDB, WORK, A, LDA, WORK( P+1 ),
...
*                       ( c2 ) M+P-N
*
      CALL CSORMQR( 'Left', 'Transpose', M, 1, MN, A, LDA, WORK( P+1 ),
...
*
      IF( P.GT.0 ) THEN
         CALL CSTRTRS( 'Upper', 'No transpose', 'Non-unit', P, 1,
...
*
      IF( N.GT.P ) THEN
         CALL CSTRTRS( 'Upper', 'No transpose', 'Non-unit', N-P, 1,
     $                A, LDA, C, N-P, INFO )
*
         IF( INFO.GT.0 ) THEN
            INFO = 2
...
*
      CALL CSORMRQ( 'Left', 'Transpose', N, 1, P, B, LDB, WORK( 1 ), X,
