...
*  =======
*
*  CDLARRV computes the eigenvectors of the tridiagonal matrix
...
*                if INFO = 2, internal error in CDSTEIN
*
*  Further Details
*  ===============
*
...
*     .. Local Scalars ..
     ...
     $                   NEWFRS, NEWFTT, NEWLST, NEWSIZ, NSPLIT, 
     $  OLDCLS, 
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, CDLAR1V, CDLARRB, CDLARRF, 
     $  CDLASET, 
     $                   DSCAL, CDSTEIN
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                               INFO )
                        ...
                        ELSE
                           ...
                           ELSE
*
*                             Call CDSTEIN to process this tight cluster.
...
*
   ...
   90                   CONTINUE
                        LAMBDA = WORK( K )
                        CALL CDLAR1V( IN, 1, IN, LAMBDA, D( IBEGIN ),
