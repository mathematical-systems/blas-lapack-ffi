...
*  =======
*
*  CSPPTRI computes the inverse of a real symmetric positive definite
...
*     .. External Subroutines ..
      EXTERNAL           SSCAL, SSPR, STPMV, CSTPTRI, XERBLA
*     ..
...
*
      CALL CSTPTRI( UPLO, 'Non-unit', N, AP, INFO )
      IF( INFO.GT.0 )
     $   RETURN
*
      IF( UPPER ) THEN
