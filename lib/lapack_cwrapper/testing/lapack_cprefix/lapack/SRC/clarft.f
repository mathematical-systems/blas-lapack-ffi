...
*  =======
*
*  CCLARFT forms the triangular factor T of a complex block reflector H
...
*
                     CALL CCLACGV( N-K+I-1, V( I, 1 ), LDV )
                     CALL CGEMV( 'No transpose', K-I, N-K+I, -TAU( I ),
     $                           V( I+1, 1 ), LDV, V( I, 1 ), LDV, 
     $  ZERO, 
     $                           T( I+1, I ), 1 )
                     CALL CCLACGV( N-K+I-1, V( I, 1 ), LDV )
                     V( I, N-K+I ) = VII
