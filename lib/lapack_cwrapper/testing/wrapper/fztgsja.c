...
void fztgsja_(char* jobu, char* jobv, char* jobq, int* m, int* p, int* n, int* k, int* l, void* a, int* lda, void* b, int* ldb, double* tola, double* tolb, double* alpha, double* beta, void* u, int* ldu, void* v, int* ldv, void* q, int* ldq, void* work, int* ncycle, int* info)
{
	...
	lapack_ztgsja(jobuC, jobvC, jobqC, *m, *p, *n, *k, *l, a, *lda, b, *ldb, *tola, *tolb, alpha, beta, u, *ldu, v, *ldv, q, *ldq, work, ncycle, info);
}
