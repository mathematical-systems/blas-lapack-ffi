...
void fchsein_(char* side, char* eigsrc, char* initv, long int* select, int* n, void* h, int* ldh, void* w, void* vl, int* ldvl, void* vr, int* ldvr, int* mm, int* m, void* work, float* rwork, int* ifaill, int* ifailr, int* info)
{
	...
	lapack_chsein(sideC, eigsrcC, initvC, select, *n, h, *ldh, w, vl, *ldvl, vr, *ldvr, *mm, m, work, rwork, ifaill, ifailr, info);
}
