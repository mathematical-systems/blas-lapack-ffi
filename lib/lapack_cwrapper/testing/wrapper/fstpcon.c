...
void fstpcon_(char* norm, char* uplo, char* diag, int* n, float* ap, float* rcond, float* work, int* iwork, int* info)
{
	...
	lapack_stpcon(normC, uploC, diagC, *n, ap, rcond, work, iwork, info);
}
