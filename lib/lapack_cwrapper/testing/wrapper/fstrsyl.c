...
void fstrsyl_(char* trana, char* tranb, int* isgn, int* m, int* n, float* a, int* lda, float* b, int* ldb, float* c, int* ldc, float* scale, int* info)
{
	...
	lapack_strsyl(tranaC, tranbC, *isgn, *m, *n, a, *lda, b, *ldb, c, *ldc, scale, info);
}
