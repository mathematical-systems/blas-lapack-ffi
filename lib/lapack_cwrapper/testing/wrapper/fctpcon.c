...
void fctpcon_(char* norm, char* uplo, char* diag, int* n, void* ap, float* rcond, void* work, float* rwork, int* info)
{
	...
	lapack_ctpcon(normC, uploC, diagC, *n, ap, rcond, work, rwork, info);
}
