...
void fslatrs_(char* uplo, char* trans, char* diag, char* normin, int* n, float* a, int* lda, float* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_slatrs(uploC, transC, diagC, norminC, *n, a, *lda, x, scale, cnorm, info);
}
