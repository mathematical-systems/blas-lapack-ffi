...
void fzgeev_(char* jobvl, char* jobvr, int* n, void* a, int* lda, void* w, void* vl, int* ldvl, void* vr, int* ldvr, void* work, int* lwork, double* rwork, int* info)
{
	...
	lapack_zgeev(jobvlC, jobvrC, *n, a, *lda, w, vl, *ldvl, vr, *ldvr, work, *lwork, rwork, info);
}
