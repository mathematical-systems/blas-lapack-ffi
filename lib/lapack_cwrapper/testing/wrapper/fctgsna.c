...
void fctgsna_(char* job, char* howmny, long int* select, int* n, void* a, int* lda, void* b, int* ldb, void* vl, int* ldvl, void* vr, int* ldvr, float* s, float* dif, int* mm, int* m, void* work, int* lwork, int* iwork, int* info)
{
	...
	lapack_ctgsna(jobC, howmnyC, select, *n, a, *lda, b, *ldb, vl, *ldvl, vr, *ldvr, s, dif, *mm, m, work, *lwork, iwork, info);
}
