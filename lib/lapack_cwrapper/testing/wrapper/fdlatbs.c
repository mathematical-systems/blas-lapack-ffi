...
void fdlatbs_(char* uplo, char* trans, char* diag, char* normin, int* n, int* kd, double* ab, int* ldab, double* x, double* scale, double* cnorm, int* info)
{
	...
	lapack_dlatbs(uploC, transC, diagC, norminC, *n, *kd, ab, *ldab, x, scale, cnorm, info);
}
