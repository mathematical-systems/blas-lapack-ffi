...
void fslantb_(float* output, char* norm, char* uplo, char* diag, int* n, int* k, float* ab, int* ldab, float* work)
{
	...
	*output = lapack_slantb( normC, uploC, diagC, *n, *k, ab, *ldab, work);
}
