...
void fstbcon_(char* norm, char* uplo, char* diag, int* n, int* kd, float* ab, int* ldab, float* rcond, float* work, int* iwork, int* info)
{
	...
	lapack_stbcon(normC, uploC, diagC, *n, *kd, ab, *ldab, rcond, work, iwork, info);
}
