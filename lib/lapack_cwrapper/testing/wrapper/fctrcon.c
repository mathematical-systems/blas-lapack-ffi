...
void fctrcon_(char* norm, char* uplo, char* diag, int* n, void* a, int* lda, float* rcond, void* work, float* rwork, int* info)
{
	...
	lapack_ctrcon(normC, uploC, diagC, *n, a, *lda, rcond, work, rwork, info);
}
