...
void fslatbs_(char* uplo, char* trans, char* diag, char* normin, int* n, int* kd, float* ab, int* ldab, float* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_slatbs(uploC, transC, diagC, norminC, *n, *kd, ab, *ldab, x, scale, cnorm, info);
}
