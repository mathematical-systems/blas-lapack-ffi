...
void fctrsen_(char* job, char* compq, long int* select, int* n, void* t, int* ldt, void* q, int* ldq, void* w, int* m, float* s, float* sep, void* work, int* lwork, int* info)
{
	...
	lapack_ctrsen(jobC, compqC, select, *n, t, *ldt, q, *ldq, w, m, s, sep, work, *lwork, info);
}
