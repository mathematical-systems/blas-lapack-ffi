...
void fcgeevx_(char* balanc, char* jobvl, char* jobvr, char* sense, int* n, void* a, int* lda, void* w, void* vl, int* ldvl, void* vr, int* ldvr, int* ilo, int* ihi, float* scale, float* abnrm, float* rconde, float* rcondv, void* work, int* lwork, float* rwork, int* info)
{
	...
	lapack_cgeevx(balancC, jobvlC, jobvrC, senseC, *n, a, *lda, w, vl, *ldvl, vr, *ldvr, ilo, ihi, scale, abnrm, rconde, rcondv, work, *lwork, rwork, info);
}
