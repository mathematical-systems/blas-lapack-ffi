...
void fctbcon_(char* norm, char* uplo, char* diag, int* n, int* kd, void* ab, int* ldab, float* rcond, void* work, float* rwork, int* info)
{
	...
	lapack_ctbcon(normC, uploC, diagC, *n, *kd, ab, *ldab, rcond, work, rwork, info);
}
