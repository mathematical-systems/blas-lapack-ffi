...
void fztbcon_(char* norm, char* uplo, char* diag, int* n, int* kd, void* ab, int* ldab, double* rcond, void* work, double* rwork, int* info)
{
	...
	lapack_ztbcon(normC, uploC, diagC, *n, *kd, ab, *ldab, rcond, work, rwork, info);
}
