...
void fztrsna_(char* job, char* howmny, long int* select, int* n, void* t, int* ldt, void* vl, int* ldvl, void* vr, int* ldvr, double* s, double* sep, int* mm, int* m, void* work, int* ldwork, double* rwork, int* info)
{
	...
	lapack_ztrsna(jobC, howmnyC, select, *n, t, *ldt, vl, *ldvl, vr, *ldvr, s, sep, *mm, m, work, *ldwork, rwork, info);
}
