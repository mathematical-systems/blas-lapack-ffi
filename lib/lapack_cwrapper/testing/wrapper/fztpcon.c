...
void fztpcon_(char* norm, char* uplo, char* diag, int* n, void* ap, double* rcond, void* work, double* rwork, int* info)
{
	...
	lapack_ztpcon(normC, uploC, diagC, *n, ap, rcond, work, rwork, info);
}
