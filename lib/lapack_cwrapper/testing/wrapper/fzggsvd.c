...
void fzggsvd_(char* jobu, char* jobv, char* jobq, int* m, int* n, int* p, int* k, int* l, void* a, int* lda, void* b, int* ldb, double* alpha, double* beta, void* u, int* ldu, void* v, int* ldv, void* q, int* ldq, void* work, double* rwork, int* iwork, int* info)
{
	...
	lapack_zggsvd(jobuC, jobvC, jobqC, *m, *n, *p, k, l, a, *lda, b, *ldb, alpha, beta, u, *ldu, v, *ldv, q, *ldq, work, rwork, iwork, info);
}
