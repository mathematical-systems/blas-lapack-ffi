...
void fslatps_(char* uplo, char* trans, char* diag, char* normin, int* n, float* ap, float* x, float* scale, float* cnorm, int* info)
{
	...
	lapack_slatps(uploC, transC, diagC, norminC, *n, ap, x, scale, cnorm, info);
}
