...
void fsggbak_(char* job, char* side, int* n, int* ilo, int* ihi, float* lscale, float* rscale, int* m, float* v, int* ldv, int* info)
{
	...
	lapack_sggbak(jobC, sideC, *n, *ilo, *ihi, lscale, rscale, *m, v, *ldv, info);
}
