...
void fzggbak_(char* job, char* side, int* n, int* ilo, int* ihi, double* lscale, double* rscale, int* m, void* v, int* ldv, int* info)
{
	...
	lapack_zggbak(jobC, sideC, *n, *ilo, *ihi, lscale, rscale, *m, v, *ldv, info);
}
