...
void fdtrcon_(char* norm, char* uplo, char* diag, int* n, double* a, int* lda, double* rcond, double* work, int* iwork, int* info)
{
	...
	lapack_dtrcon(normC, uploC, diagC, *n, a, *lda, rcond, work, iwork, info);
}
