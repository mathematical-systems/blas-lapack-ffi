...
void fzlantb_(double* output, char* norm, char* uplo, char* diag, int* n, int* k, void* ab, int* ldab, double* work)
{
	...
	*output = lapack_zlantb( normC, uploC, diagC, *n, *k, ab, *ldab, work);
}
