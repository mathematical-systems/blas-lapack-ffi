...
void fdtpcon_(char* norm, char* uplo, char* diag, int* n, double* ap, double* rcond, double* work, int* iwork, int* info)
{
	...
	lapack_dtpcon(normC, uploC, diagC, *n, ap, rcond, work, iwork, info);
}
