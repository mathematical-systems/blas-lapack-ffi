...
void fzlatrs_(char* uplo, char* trans, char* diag, char* normin, int* n, void* a, int* lda, void* x, double* scale, double* cnorm, int* info)
{
	...
	lapack_zlatrs(uploC, transC, diagC, norminC, *n, a, *lda, x, scale, cnorm, info);
}
