...
void fcgges_(char* jobvsl, char* jobvsr, char* sort, const long int (*selctg) (void*,void*), int* n, void* a, int* lda, void* b, int* ldb, int* sdim, void* alpha, void* beta, void* vsl, int* ldvsl, void* vsr, int* ldvsr, void* work, int* lwork, float* rwork, long int* bwork, int* info)
{
	...
	lapack_cgges(jobvslC, jobvsrC, sortC, selctg, *n, a, *lda, b, *ldb, sdim, alpha, beta, vsl, *ldvsl, vsr, *ldvsr, work, *lwork, rwork, bwork, info);
}
