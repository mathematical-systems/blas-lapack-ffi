 ...
 * lapack_ctrevc.c
 *
 *This program is a C interface to ctrevc.
 *
...
;
	...
	f77_ctrevc(&F77_side, &F77_howmny, F77_select, &F77_n, t, &F77_ldt, vl, &F77_ldvl, vr, &F77_ldvr, &F77_mm, F77_m, work, rwork, F77_info);
