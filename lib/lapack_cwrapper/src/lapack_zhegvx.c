 ...
 * lapack_zhegvx.c
 *
 *This program is a C interface to zhegvx.
 *
...
{
#ifdef F77_INT
	F77_INT F77_itype=itype, F77_n=n, F77_lda=lda, F77_ldb=ldb, F77_il=il, F77_iu=iu, F77_ldz=ldz, F77_lwork=lwork;
	int i_local;
	F77_INT F77_m[1];
	...
	f77_zhegvx(&F77_itype, &F77_jobz, &F77_range, &F77_uplo, &F77_n, a, &F77_lda, b, &F77_ldb, &vl, &vu, &F77_il, &F77_iu, &abstol, F77_m, w, z, &F77_ldz, work, &F77_lwork, rwork, F77_iwork, F77_ifail, F77_info);
