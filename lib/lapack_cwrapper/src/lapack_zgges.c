 ...
 * lapack_zgges.c
 *
 *This program is a C interface to zgges.
 *
...
;
	...
	f77_zgges(&F77_jobvsl, &F77_jobvsr, &F77_sort, selctg, &F77_n, a, &F77_lda, b, &F77_ldb, F77_sdim, alpha, beta, vsl, &F77_ldvsl, vsr, &F77_ldvsr, work, &F77_lwork, rwork, F77_bwork, F77_info);
