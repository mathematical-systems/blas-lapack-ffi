 ...
 * lapack_sgees.c
 *
 *This program is a C interface to sgees.
 *
...
;
	...
	f77_sgees(&F77_jobvs, &F77_sort, select, &F77_n, a, &F77_lda, F77_sdim, wr, wi, vs, &F77_ldvs, work, &F77_lwork, F77_bwork, F77_info);
