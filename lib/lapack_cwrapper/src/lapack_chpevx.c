 ...
 * lapack_chpevx.c
 *
 *This program is a C interface to chpevx.
 *
...
{
#ifdef F77_INT
	F77_INT F77_n=n, F77_il=il, F77_iu=iu, F77_ldz=ldz;
	int i_local;
	F77_INT F77_m[1];
	...
	f77_chpevx(&F77_jobz, &F77_range, &F77_uplo, &F77_n, ap, &vl, &vu, &F77_il, &F77_iu, &abstol, F77_m, w, z, &F77_ldz, work, rwork, F77_iwork, F77_ifail, F77_info);
