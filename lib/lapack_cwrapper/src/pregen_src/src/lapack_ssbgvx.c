 ...
 * lapack_ssbgvx.c
 *
 *This program is a C interface to ssbgvx.
 *
...
f77_ssbgvx(&F77_jobz, &F77_range, &F77_uplo, &F77_n, &F77_ka, &F77_kb, ab, &F77_ldab, bb, &F77_ldbb, q, &F77_ldq, &vl, &vu, &F77_il, &F77_iu, &abstol, F77_m, w, z, &F77_ldz, work, F77_iwork, F77_ifail, F77_info);
