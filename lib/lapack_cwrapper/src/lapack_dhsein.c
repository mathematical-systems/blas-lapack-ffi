 ...
 * lapack_dhsein.c
 *
 *This program is a C interface to dhsein.
 *
...
;
	...
	f77_dhsein(&F77_side, &F77_eigsrc, &F77_initv, F77_select, &F77_n, h, &F77_ldh, wr, wi, vl, &F77_ldvl, vr, &F77_ldvr, &F77_mm, F77_m, work, F77_ifaill, F77_ifailr, F77_info);
