 ...
 * lapack_cunmrz.c
 *
 *This program is a C interface to cunmrz.
 *
...
{
#ifdef F77_INT
	F77_INT F77_m=m, F77_n=n, F77_k=k, F77_l=l, F77_lda=lda, F77_ldc=ldc, F77_lwork=lwork;
	int i_local;
	F77_INT F77_info[1];
#else
	#define F77_m m
	...
	f77_cunmrz(&F77_side, &F77_trans, &F77_m, &F77_n, &F77_k, &F77_l, a, &F77_lda, tau, c, &F77_ldc, work, &F77_lwork, F77_info);
