 ...
 * lapack_ctgevc.c
 *
 *This program is a C interface to ctgevc.
 *
...
;
	...
	f77_ctgevc(&F77_side, &F77_howmny, F77_select, &F77_n, s, &F77_lds, p, &F77_ldp, vl, &F77_ldvl, vr, &F77_ldvr, &F77_mm, F77_m, work, rwork, F77_info);
