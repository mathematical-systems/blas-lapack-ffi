 ...
 * lapack_sgges.c
 *
 *This program is a C interface to sgges.
 *
...
;
	...
	f77_sgges(&F77_jobvsl, &F77_jobvsr, &F77_sort, selctg, &F77_n, a, &F77_lda, b, &F77_ldb, F77_sdim, alphar, alphai, beta, vsl, &F77_ldvsl, vsr, &F77_ldvsr, work, &F77_lwork, F77_bwork, F77_info);
