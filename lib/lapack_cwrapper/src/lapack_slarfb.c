 ...
 * lapack_slarfb.c
 *
 *This program is a C interface to slarfb.
 *
...
{
#ifdef F77_INT
	F77_INT F77_m=m, F77_n=n, F77_k=k, F77_ldv=ldv, F77_ldt=ldt, F77_ldc=ldc, F77_ldwork=ldwork;
#else
	#define F77_m m
	#define F77_n n
	#define F77_k k
	...
	f77_slarfb(&F77_side, &F77_trans, &F77_direct, &F77_storev, &F77_m, &F77_n, &F77_k, v, &F77_ldv, t, &F77_ldt, c, &F77_ldc, work, &F77_ldwork);
