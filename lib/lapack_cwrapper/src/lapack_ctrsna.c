 ...
 * lapack_ctrsna.c
 *
 *This program is a C interface to ctrsna.
 *
...
;
	...
	f77_ctrsna(&F77_job, &F77_howmny, F77_select, &F77_n, t, &F77_ldt, vl, &F77_ldvl, vr, &F77_ldvr, s, sep, &F77_mm, F77_m, work, &F77_ldwork, rwork, F77_info);
